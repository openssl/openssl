...
#define sk_${nametype}_pop_free(sk, freefunc) OPENSSL_sk_pop_free_thunk(ossl_check_${nametype}_sk_type(sk), sk_${nametype}_freefunc_thunk, ossl_check_${nametype}_freefunc_type(freefunc))
