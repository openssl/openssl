...
#define sk_${nametype}_new(cmp) ((STACK_OF(${nametype}) *)OPENSSL_sk_set_thunks(OPENSSL_sk_new(ossl_check_${nametype}_compfunc_type(cmp)),sk_${nametype}_compfunc_thunk, sk_${nametype}_pop_free_thunk, sk_${nametype}_deep_copy_thunk))
#define sk_${nametype}_new_null() ((STACK_OF(${nametype}) *)OPENSSL_sk_set_thunks(OPENSSL_sk_new_null(), sk_${nametype}_compfunc_thunk, sk_${nametype}_pop_free_thunk, sk_${nametype}_deep_copy_thunk))
#define sk_${nametype}_new_reserve(cmp, n) ((STACK_OF(${nametype}) *)OPENSSL_sk_set_thunks(OPENSSL_sk_new_reserve(ossl_check_${nametype}_compfunc_type(cmp), (n)), sk_${nametype}_compfunc_thunk, sk_${nametype}_pop_free_thunk, sk_${nametype}_deep_copy_thunk))
...
#define sk_${nametype}_set_cmp_func(sk, cmp) ((sk_${nametype}_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_${nametype}_sk_type(sk), sk_${nametype}_compfunc_thunk, ossl_check_${nametype}_compfunc_type(cmp)))
END_MACROS
