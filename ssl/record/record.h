...
__owur int ssl3_write_bytes(SSL *s, int type, const void *buf, size_t len,
                            size_t *written);
__owur int ssl3_writev_bytes(SSL *s, int type, const struct iovec *iov,
...
__owur int dtls1_writev_bytes(SSL_CONNECTION *s, int type, const struct iovec *iov,
                              size_t len, size_t *written);
int do_dtls1_write(SSL_CONNECTION *s, int type, const unsigned char *buf,
                   size_t len, size_t *written);
int do_dtls1_writev(SSL_CONNECTION *s, int type, const struct iovec *iov,
                    size_t len, size_t *written);
