				 ...
				 unsigned char *mac_key, size_t mac_secret_size)
{
	...
	case NID_aes_128_gcm:
		...
		memcpy(crypto_info->gcm128.iv, eiv,
	...
	case NID_aes_256_gcm:
		...
		memcpy(crypto_info->gcm256.iv, eiv,
	...
	case NID_aes_128_ccm:
		...
		memcpy(crypto_info->ccm128.iv, eiv,
				 ...
				 COMP_METHOD *comp)
{
	...
	if (!ktls_configure_crypto(rl->libctx, rl->version, ciph, md,
				   rl->sequence, &crypto_info,
	...
	void *rlarg, OSSL_RECORD_LAYER **retrl)
{
	...
	ret = tls_int_new_record_layer(libctx, propq, vers, role, direction,
				       level, ciph, taglen, md, comp, prev,
				       transport, next, settings, options, fns,
				       cbarg, retrl);
