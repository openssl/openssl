...
static const ERR_STRING_DATA SSL_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_ADD_KEY_SHARE, 0),
     "add_key_share"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_CT_MOVE_SCTS, 0),
     "ct_move_scts"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_CT_STRICT, 0),
     "ct_strict"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_D2I_SSL_SESSION, 0),
     "d2i_SSL_SESSION"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_DANE_CTX_ENABLE, 0),
     "dane_ctx_enable"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_DANE_MTYPE_SET, 0),
     "dane_mtype_set"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_DANE_TLSA_ADD, 0),
     "dane_tlsa_add"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_DERIVE_SECRET_KEY_AND_IV, 0),
     "derive_secret_key_and_iv"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_DO_DTLS1_WRITE, 0),
     "do_dtls1_write"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_DO_SSL3_WRITE, 0),
     "do_ssl3_write"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_DTLS1_READ_BYTES, 0),
     "dtls1_read_bytes"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_DTLS1_READ_FAILED, 0),
     "dtls1_read_failed"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_DTLSV1_LISTEN, 0),
     "DTLSv1_listen"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_FINAL_EC_PT_FORMATS, 0),
     "final_ec_pt_formats"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_FINAL_EMS, 0),
     "final_ems"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_FINAL_KEY_SHARE, 0),
     "final_key_share"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_FINAL_RENEGOTIATE, 0),
     "final_renegotiate"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_FINAL_SIG_ALGS, 0),
     "final_sig_algs"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_NSS_KEYLOG_INT, 0),
     "nss_keylog_int"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_OPENSSL_INIT_SSL, 0),
     "OPENSSL_init_ssl"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_PARSE_CA_NAMES, 0),
     "parse_ca_names"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_PROCESS_KEY_SHARE_EXT, 0),
     "process_key_share_ext"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_READ_STATE_MACHINE, 0),
     "read_state_machine"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL3_CTRL, 0),
     "ssl3_ctrl"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL3_CTX_CTRL, 0),
     "ssl3_ctx_ctrl"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL3_GET_RECORD, 0),
     "ssl3_get_record"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL3_READ_BYTES, 0),
     "ssl3_read_bytes"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL3_READ_N, 0),
     "ssl3_read_n"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL3_WRITE_BYTES, 0),
     "ssl3_write_bytes"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL3_WRITE_PENDING, 0),
     "ssl3_write_pending"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_ADD_CERT_CHAIN, 0),
     "ssl_add_cert_chain"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_BAD_METHOD, 0),
     "ssl_bad_method"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CERT_DUP, 0),
     "ssl_cert_dup"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CERT_NEW, 0),
     "ssl_cert_new"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_DANE_DUP, 0),
     "ssl_dane_dup"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_DANE_ENABLE, 0),
     "SSL_dane_enable"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_DO_CONFIG, 0),
     "ssl_do_config"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_DO_HANDSHAKE, 0),
     "SSL_do_handshake"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_DUP_CA_LIST, 0),
     "SSL_dup_CA_list"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_ENABLE_CT, 0),
     "SSL_enable_ct"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_KEY_UPDATE, 0),
     "SSL_key_update"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_MODULE_INIT, 0),
     "ssl_module_init"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_NEW, 0),
     "SSL_new"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_PEEK, 0),
     "SSL_peek"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_PEEK_EX, 0),
     "SSL_peek_ex"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_PEEK_INTERNAL, 0),
     "ssl_peek_internal"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_READ, 0),
     "SSL_read"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_READ_EARLY_DATA, 0),
     "SSL_read_early_data"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_READ_EX, 0),
     "SSL_read_ex"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_READ_INTERNAL, 0),
     "ssl_read_internal"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_RENEGOTIATE, 0),
     "SSL_renegotiate"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SESSION_DUP, 0),
     "ssl_session_dup"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SESSION_NEW, 0),
     "SSL_SESSION_new"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_ALPN_PROTOS, 0),
     "SSL_set_alpn_protos"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_CERT, 0),
     "ssl_set_cert"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_CIPHER_LIST, 0),
     "SSL_set_cipher_list"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_CT_VALIDATION_CALLBACK, 0),
     "SSL_set_ct_validation_callback"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_FD, 0),
     "SSL_set_fd"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_PKEY, 0),
     "ssl_set_pkey"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_RFD, 0),
     "SSL_set_rfd"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_SESSION, 0),
     "SSL_set_session"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_SESSION_ID_CONTEXT, 0),
     "SSL_set_session_id_context"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_SESSION_TICKET_EXT, 0),
     "SSL_set_session_ticket_ext"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_WFD, 0),
     "SSL_set_wfd"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SHUTDOWN, 0),
     "SSL_shutdown"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SRP_CTX_INIT, 0),
     "SSL_SRP_CTX_init"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_USE_PRIVATEKEY, 0),
     "SSL_use_PrivateKey"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_VALIDATE_CT, 0),
     "ssl_validate_ct"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_VERIFY_CERT_CHAIN, 0),
     "ssl_verify_cert_chain"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_WRITE, 0),
     "SSL_write"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_WRITE_EX, 0),
     "SSL_write_ex"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_WRITE_INTERNAL, 0),
     "ssl_write_internal"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_STATE_MACHINE, 0),
     "state_machine"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS12_CHECK_PEER_SIGALG, 0),
     "tls12_check_peer_sigalg"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS12_COPY_SIGALGS, 0),
     "tls12_copy_sigalgs"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS1_ENC, 0),
     "tls1_enc"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS1_EXPORT_KEYING_MATERIAL, 0),
     "tls1_export_keying_material"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS1_GET_CURVELIST, 0),
     "tls1_get_curvelist"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS1_PRF, 0),
     "tls1_PRF"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CHOOSE_SIGALG, 0),
     "tls_choose_sigalg"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_CTOS_PSK, 0),
     "tls_parse_ctos_psk"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_STOC_PSK, 0),
     "tls_parse_stoc_psk"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_SKE_SRP, 0),
     "tls_process_ske_srp"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PSK_DO_BINDER, 0),
     "tls_psk_do_binder"},
...
static const ERR_STRING_DATA SSL_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_BAD_CIPHER),
    "bad cipher"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_BAD_DATA),
    "bad data"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_BAD_DATA_RETURNED_BY_CALLBACK),
    "bad data returned by callback"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_BAD_DECOMPRESSION),
    "bad decompression"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_BAD_DH_VALUE),
    "bad dh value"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_BAD_DIGEST_LENGTH),
    "bad digest length"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_BAD_ECC_CERT),
    "bad ecc cert"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_BAD_ECPOINT),
    "bad ecpoint"},
    ...
    "bad hello request"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_BAD_KEY_SHARE),
    "bad key share"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_BAD_KEY_UPDATE),
    "bad key update"},
    ...
    "bad psk identity"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_BAD_RECORD_TYPE),
    "bad record type"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_BAD_RSA_ENCRYPT),
    "bad rsa encrypt"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_BAD_SIGNATURE),
    "bad signature"},
    ...
    "bad ssl filetype"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_BAD_VALUE),
    "bad value"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_BAD_WRITE_RETRY),
    "bad write retry"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_BIO_NOT_SET),
    "bio not set"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_BLOCK_CIPHER_PAD_IS_WRONG),
    "block cipher pad is wrong"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_BN_LIB),
    "bn lib"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_COOKIE_MISMATCH),
    "cookie mismatch"},
    ...
    "https proxy request"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_HTTP_REQUEST),
    "http request"},
    ...
    "inconsistent extms"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_INVALID_COMMAND),
    "invalid command"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_LENGTH_MISMATCH),
    "length mismatch"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_LENGTH_TOO_LONG),
    "length too long"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_LENGTH_TOO_SHORT),
    "length too short"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_LIBRARY_BUG),
    "library bug"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_NO_CIPHER_MATCH),
    "no cipher match"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_NO_VALID_SCTS),
    "no valid scts"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_NO_VERIFY_COOKIE_CALLBACK),
    "no verify cookie callback"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_NULL_SSL_CTX),
    "null ssl ctx"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_PARSE_TLSEXT),
    "parse tlsext"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_PATH_TOO_LONG),
    "path too long"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_STILL_IN_INIT),
    "still in init"},
    ...
    "unexpected record"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_UNINITIALIZED),
    "uninitialized"},
    ...
    "unknown cmd name"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_UNKNOWN_COMMAND),
    "unknown command"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_UNKNOWN_DIGEST),
    "unknown digest"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_WRONG_CURVE),
    "wrong curve"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_X509_LIB),
    "x509 lib"},
