...
#define USE_RECORD_SIZE_LIMIT(s) \
    (IS_RECORD_SIZE_LIMIT_VALID(s->ext.record_size_limit) && IS_RECORD_SIZE_LIMIT_VALID(s->ext.peer_record_size_limit))
...
__owur size_t ssl_get_max_send_fragment(const SSL_CONNECTION *sc, uint8_t type);
