...
/*
 * Same as above, but also provides position where group was found
 * Returns 1 if group is found, returns 0 if group was not found
 */
int check_in_list_pos(SSL_CONNECTION *s, uint16_t group_id, const uint16_t *groups,
