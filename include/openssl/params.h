...
# define OSSL_PARAM_uint64(key, addr) \
    OSSL_PARAM((key), OSSL_PARAM_UNSIGNED_INTEGER, (addr), sizeof(uint64_t), \
               NULL)
# define OSSL_PARAM_intmax(key, addr) \
    OSSL_PARAM((key), OSSL_PARAM_INTEGER, (addr), sizeof(intmax_t), NULL)
# define OSSL_PARAM_uintmax(key, addr) \
    OSSL_PARAM((key), OSSL_PARAM_UNSIGNED_INTEGER, (addr), sizeof(uintmax_t), \
               NULL)
...
int OSSL_PARAM_get_intmax(const OSSL_PARAM *p, const char *key, intmax_t *val);
int OSSL_PARAM_get_uintmax(const OSSL_PARAM *p, const char *key,
                           uintmax_t *val);
...
int OSSL_PARAM_set_intmax(const OSSL_PARAM *p, const char *key, intmax_t val);
int OSSL_PARAM_set_uintmax(const OSSL_PARAM *p, const char *key, uintmax_t val);
