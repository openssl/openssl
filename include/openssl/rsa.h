...
# define EVP_PKEY_CTRL_TLS_CLIENT_VERSION (EVP_PKEY_ALG_CTRL + 15)
# define EVP_PKEY_CTRL_GET_TLS_CLIENT_VERSION (EVP_PKEY_ALG_CTRL + 16)

# define EVP_PKEY_CTRL_TLS_NEGOTIATED_VERSION (EVP_PKEY_ALG_CTRL + 17)
# define EVP_PKEY_CTRL_GET_TLS_NEGOTIATED_VERSION (EVP_PKEY_ALG_CTRL + 18)
