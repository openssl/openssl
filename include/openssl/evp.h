...
# define EVP_PKEY_OP_PARAMFROMID         (1<<5)
# define EVP_PKEY_OP_KEYFROMID           (1<<6)
# define EVP_PKEY_OP_SIGN                (1<<7)
# define EVP_PKEY_OP_VERIFY              (1<<8)
# define EVP_PKEY_OP_VERIFYRECOVER       (1<<9)
# define EVP_PKEY_OP_SIGNCTX             (1<<10)
# define EVP_PKEY_OP_VERIFYCTX           (1<<11)
# define EVP_PKEY_OP_ENCRYPT             (1<<12)
# define EVP_PKEY_OP_DECRYPT             (1<<13)
# define EVP_PKEY_OP_DERIVE              (1<<14)
