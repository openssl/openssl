...
# define OSSL_KEYMGMT_FLAG_PRIVATE_KEY              0x01
# define OSSL_KEYMGMT_FLAG_PUBLIC_KEY               0x02
# define OSSL_KEYMGMT_FLAG_DOMAIN_PARAMETERS        0x04
# define OSSL_KEYMGMT_FLAG_OTHER_PARAMETERS         0x80

/* Key data subset selection - combinations */
# define OSSL_KEYMGMT_SELECT_PARAMETERS         \
    ( OSSL_KEYMGMT_FLAG_DOMAIN_PARAMETERS | OSSL_KEYMGMT_FLAG_OTHER_PARAMETERS)
# define OSSL_KEYMGMT_SELECT_KEY                \
    ( OSSL_KEYMGMT_FLAG_PRIVATE_KEY | OSSL_KEYMGMT_FLAG_PUBLIC_KEY )
