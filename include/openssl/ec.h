 ...
 */
OSSL_DEPRECATEDIN_3_0 const EC_METHOD *
 ...
 */
OSSL_DEPRECATEDIN_3_0 int
EC_POINT_set_affine_coordinates_GF2m(const EC_GROUP *group, EC_POINT *p,
				     const BIGNUM *x, const BIGNUM *y,
				     BN_CTX *ctx);
 ...
 */
OSSL_DEPRECATEDIN_3_0 int
EC_POINT_get_affine_coordinates_GF2m(const EC_GROUP *group, const EC_POINT *p,
				     BIGNUM *x, BIGNUM *y, BN_CTX *ctx);
...
OSSL_DEPRECATEDIN_3_0 BIGNUM *EC_POINT_point2bn(const EC_GROUP *,
						...
						point_conversion_form_t form,
						BIGNUM *, BN_CTX *);
OSSL_DEPRECATEDIN_3_0 EC_POINT *
...
OSSL_DEPRECATEDIN_3_0 int
EC_KEY_decoded_from_explicit_params(const EC_KEY *key);
 ...
 *  \return EC_KEY object or NULL if an error occurred.
 */
OSSL_DEPRECATEDIN_3_0 EC_KEY *
EC_KEY_new_by_curve_name_ex(OSSL_LIB_CTX *ctx, const char *propq, int nid);
...
OSSL_DEPRECATEDIN_3_0 void EC_KEY_set_enc_flags(EC_KEY *eckey,
						unsigned int flags);
OSSL_DEPRECATEDIN_3_0 point_conversion_form_t
...
OSSL_DEPRECATEDIN_3_0 int ECDH_compute_key(
 ...
 *  \return pointer to a ECDSA_SIG structure or NULL if an error occurred
 */
OSSL_DEPRECATEDIN_3_0 ECDSA_SIG *
ECDSA_do_sign_ex(const unsigned char *dgst, int dgstlen, const BIGNUM *kinv,
...
OSSL_DEPRECATEDIN_3_0 EC_KEY_METHOD *
...
EC_KEY_METHOD_set_init(EC_KEY_METHOD *meth, int (*init)(EC_KEY *key),
