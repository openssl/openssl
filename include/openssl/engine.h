 ...
 *                                       void (*f) (void));
 */
ENGINE_FUNC(int, ENGINE_ctrl, (ENGINE * e, int cmd, long i, void *p, void (*f)(void)), (e, cmd, i, p, f), 0)
#endif
 ...
 *                                           int cmd_optional);
 */
ENGINE_FUNC(int, ENGINE_ctrl_cmd, (ENGINE * e, const char *cmd_name, long i, void *p, void (*f)(void), int cmd_optional), (e, cmd_name, i, p, f), 0)
#endif
...
#else
ENGINE_FUNC(int, ENGINE_get_ex_new_index, (long l, void *p, CRYPTO_EX_new *newf, CRYPTO_EX_dup *dupf, CRYPTO_EX_free *freef),
