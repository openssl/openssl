...
#ifndef OPENtls_CRYPTOERR_H
# define OPENtls_CRYPTOERR_H
# pragma once
...
#  define CRYPTO_F_OPENtls_ATEXIT                          0
#  define CRYPTO_F_OPENtls_BUF2HEXSTR                      0
#  define CRYPTO_F_OPENtls_BUF2HEXSTR_EX                   0
#  define CRYPTO_F_OPENtls_FOPEN                           0
#  define CRYPTO_F_OPENtls_HEXSTR2BUF                      0
#  define CRYPTO_F_OPENtls_HEXSTR2BUF_EX                   0
#  define CRYPTO_F_OPENtls_INIT_CRYPTO                     0
#  define CRYPTO_F_OPENtls_LH_NEW                          0
#  define CRYPTO_F_OPENtls_SK_DEEP_COPY                    0
#  define CRYPTO_F_OPENtls_SK_DUP                          0
#  define CRYPTO_F_Otls_PARAM_BLD_PUSH_BN                  0
#  define CRYPTO_F_Otls_PARAM_BLD_PUSH_OCTET_PTR           0
#  define CRYPTO_F_Otls_PARAM_BLD_PUSH_OCTET_STRING        0
#  define CRYPTO_F_Otls_PARAM_BLD_PUSH_UTF8_PTR            0
#  define CRYPTO_F_Otls_PARAM_BLD_PUSH_UTF8_STRING         0
#  define CRYPTO_F_Otls_PARAM_BLD_TO_PARAM                 0
#  define CRYPTO_F_Otls_PARAM_BLD_TO_PARAM_EX              0
#  define CRYPTO_F_Otls_PARAM_TYPE_TO_PARAM                0
#  define CRYPTO_F_Otls_PROVIDER_ACTIVATE                  0
#  define CRYPTO_F_Otls_PROVIDER_ADD_BUILTIN               0
#  define CRYPTO_F_Otls_PROVIDER_ADD_PARAMETER             0
#  define CRYPTO_F_Otls_PROVIDER_NEW                       0
#  define CRYPTO_F_Otls_PROVIDER_SET_MODULE_PATH           0
...
# define CRYPTO_R_INVALID_Otls_PARAM_TYPE                 110
