...
#undef OPENSSL_NO_DEPRECATED_5_0
...
#if OPENSSL_API_LEVEL >= 50000
#ifndef OPENSSL_NO_DEPRECATED
#define OSSL_DEPRECATEDIN_5_0 OSSL_DEPRECATED(5.0)
#define OSSL_DEPRECATEDIN_5_0_FOR(msg) OSSL_DEPRECATED_FOR(5.0, msg)
#else
#define OPENSSL_NO_DEPRECATED_5_0
#endif
#else
#define OSSL_DEPRECATEDIN_5_0
#define OSSL_DEPRECATEDIN_5_0_FOR(msg)
#endif
