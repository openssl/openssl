...
#define AES_GCM_DEC_BYTES 512
#if __iset__ >= 7
void e2kv7_aes_ctr32_encrypt_blocks(const unsigned char *in, unsigned char *out,
    size_t len, const void *key,
    const unsigned char ivec[16]);
#define HWAES_ctr32_encrypt_blocks e2kv7_aes_ctr32_encrypt_blocks
#define AES_GCM_ASM(gctx) (gctx->ctr == e2kv7_aes_ctr32_encrypt_blocks)
