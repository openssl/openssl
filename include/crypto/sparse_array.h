...
#define DEFINE_SPARSE_ARRAY_OF_INTERNAL(type, ctype)                                                         \
    ...
    ossl_sa_##type##_num(SPARSE_ARRAY_OF(type) * sa)                                                         \
    {                                                                                                        \
        return ossl_sa_num((OPENSSL_SA *)sa);                                                                \
    }                                                                                                        \
    static ossl_unused ossl_inline void                                                                      \
    ossl_sa_##type##_doall(SPARSE_ARRAY_OF(type) * sa,                                                       \
    ...
    static ossl_unused ossl_inline void                                                                      \
    ossl_sa_##type##_doall_arg(SPARSE_ARRAY_OF(type) * sa,                                                   \
    ...
    static ossl_unused ossl_inline ctype *ossl_sa_##type##_get(SPARSE_ARRAY_OF(type) * sa, ossl_uintmax_t n) \
    {                                                                                                        \
