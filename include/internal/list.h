...
#define OSSL_LIST_FOREACH_REV_DELSAFE(p, pn, name, l)   \
	OSSL_LIST_FOREACH_REV_DELSAFE_FROM(p, pn, name, \
					   ossl_list_##name##_tail(l))
...
#define DEFINE_LIST_OF_IMPL(name, type)                                       \
	...
	{                                                                     \
		...
		if (e->ossl_list_##name.prev != NULL)                         \
			e->ossl_list_##name.prev->ossl_list_##name.next =     \
				elem;                                         \
	...
	{                                                                     \
		...
		if (e->ossl_list_##name.next != NULL)                         \
			e->ossl_list_##name.next->ossl_list_##name.prev =     \
				elem;                                         \
