...
#ifndef Otls_INTERNAL_DSO_H
# define Otls_INTERNAL_DSO_H
 ...
 * form that the caller will need to free with OPENtls_free() when done.
 */
 ...
 * OPENtls_free() when done. Here, merging means that bits and pieces are
 ...
 * value will need to be OPENtls_free()'d.
 */
