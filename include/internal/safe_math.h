...
#define OSSL_SAFE_MATH_ADDS(type_name, type, min, max)            \
	static ossl_inline ossl_unused type safe_add_##type_name( \
		type a, type b, int *err)                         \
	{                                                         \
		type r;                                           \
                                                                  \
...
#define OSSL_SAFE_MATH_SUBS(type_name, type, min, max)            \
	static ossl_inline ossl_unused type safe_sub_##type_name( \
		type a, type b, int *err)                         \
	{                                                         \
		type r;                                           \
                                                                  \
...
#define OSSL_SAFE_MATH_MULS(type_name, type, min, max)            \
	static ossl_inline ossl_unused type safe_mul_##type_name( \
		type a, type b, int *err)                         \
	{                                                         \
		type r;                                           \
                                                                  \
...
#define OSSL_SAFE_MATH_DIVS(type_name, type, min, max)            \
	static ossl_inline ossl_unused type safe_div_##type_name( \
		type a, type b, int *err)                         \
	{                                                         \
		if (b == 0) {                                     \
			*err |= 1;                                \
...
#define OSSL_SAFE_MATH_MODS(type_name, type, min, max)            \
	static ossl_inline ossl_unused type safe_mod_##type_name( \
		type a, type b, int *err)                         \
	{                                                         \
		if (b == 0) {                                     \
			*err |= 1;                                \
