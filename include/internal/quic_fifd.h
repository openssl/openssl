...
int ossl_quic_fifd_init(
	...
	void *confirm_frame_arg,
	void (*sstream_updated)(uint64_t stream_id, void *arg),
	void *sstream_updated_arg, QLOG *(*get_qlog_cb)(void *arg),
	void *get_qlog_cb_arg);
...
void ossl_quic_fifd_set_qlog_cb(QUIC_FIFD *fifd,
				QLOG *(*get_qlog_cb)(void *arg), void *arg);
