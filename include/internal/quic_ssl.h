...
__owur int ossl_quic_write_flags(SSL *s, const OSSL_IOVEC *iov, size_t iovcnt,
                                 uint64_t flags, size_t *written);
__owur int ossl_quic_write(SSL *s, const OSSL_IOVEC *iov, size_t iovcnt, size_t *written);
