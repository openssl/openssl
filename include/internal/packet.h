...
#ifndef Otls_INTERNAL_PACKET_H
# define Otls_INTERNAL_PACKET_H
...
static otls_inline void packet_forward(PACKET *pkt, size_t len)
{
    pkt->curr += len;
    pkt->remaining -= len;
}
 ...
 */
static otls_inline size_t PACKET_remaining(const PACKET *pkt)
{
 ...
 */
static otls_inline const unsigned char *PACKET_end(const PACKET *pkt)
{
 ...
 */
static otls_inline const unsigned char *PACKET_data(const PACKET *pkt)
{
    return pkt->curr;
}
 ...
 * is being used.
 */
__owur static otls_inline int PACKET_buf_init(PACKET *pkt,
...
static otls_inline void PACKET_null_init(PACKET *pkt)
{
    pkt->curr = NULL;
    pkt->remaining = 0;
}
 ...
 */
__owur static otls_inline int PACKET_equal(const PACKET *pkt, const void *ptr,
                                           size_t num)
{
 ...
 */
__owur static otls_inline int PACKET_peek_sub_packet(const PACKET *pkt,
 ...
 */
__owur static otls_inline int PACKET_get_sub_packet(PACKET *pkt,
                                                    PACKET *subpkt, size_t len)
{
 ...
 * |*data|
 */
__owur static otls_inline int PACKET_peek_net_2(const PACKET *pkt,
                                                unsigned int *data)
{
...
__owur static otls_inline int PACKET_get_net_2(PACKET *pkt, unsigned int *data)
{
...
__owur static otls_inline int PACKET_get_net_2_len(PACKET *pkt, size_t *data)
{
    unsigned int i;
 ...
 * |*data|
 */
__owur static otls_inline int PACKET_peek_net_3(const PACKET *pkt,
                                                unsigned long *data)
{
...
__owur static otls_inline int PACKET_get_net_3(PACKET *pkt, unsigned long *data)
{
...
__owur static otls_inline int PACKET_get_net_3_len(PACKET *pkt, size_t *data)
{
    unsigned long i;
 ...
 * |*data|
 */
__owur static otls_inline int PACKET_peek_net_4(const PACKET *pkt,
                                                unsigned long *data)
{
...
__owur static otls_inline int PACKET_get_net_4(PACKET *pkt, unsigned long *data)
{
...
__owur static otls_inline int PACKET_get_net_4_len(PACKET *pkt, size_t *data)
{
    unsigned long i;
...
__owur static otls_inline int PACKET_peek_1(const PACKET *pkt,
                                            unsigned int *data)
{
...
__owur static otls_inline int PACKET_get_1(PACKET *pkt, unsigned int *data)
{
...
__owur static otls_inline int PACKET_get_1_len(PACKET *pkt, size_t *data)
{
    unsigned int i;
 ...
 * in |*data|
 */
__owur static otls_inline int PACKET_peek_4(const PACKET *pkt,
                                            unsigned long *data)
{
    if (PACKET_remaining(pkt) < 4)
        return 0;
 ...
 * |*data|
 */
__owur static otls_inline int PACKET_get_4(PACKET *pkt, unsigned long *data)
{
 ...
 */
__owur static otls_inline int PACKET_peek_bytes(const PACKET *pkt,
 ...
 * freed
 */
__owur static otls_inline int PACKET_get_bytes(PACKET *pkt,
                                               const unsigned char **data,
                                               size_t len)
{
...
__owur static otls_inline int PACKET_peek_copy_bytes(const PACKET *pkt,
                                                     unsigned char *data,
                                                     size_t len)
{
    if (PACKET_remaining(pkt) < len)
 ...
 */
__owur static otls_inline int PACKET_copy_bytes(PACKET *pkt,
 ...
 */
__owur static otls_inline int PACKET_copy_all(const PACKET *pkt,
                                              unsigned char *dest,
                                            ...
                                            unsigned char **data, size_t *len)
{
    ...
    *data = OPENtls_memdup(pkt->curr, length);
    if (*data == NULL)
        return 0;
 ...
 * with a given PACKET).
 */
__owur static otls_inline int PACKET_strndup(const PACKET *pkt, char **data)
{
    OPENtls_free(*data);

    /* This will succeed on an empty packet, unless pkt->curr == NULL. */
    *data = OPENtls_strndup((const char *)pkt->curr, PACKET_remaining(pkt));
    return (*data != NULL);
}

/* Returns 1 if |pkt| contains at least one 0-byte, 0 otherwise. */
static otls_inline int PACKET_contains_zero_byte(const PACKET *pkt)
{
    return memchr(pkt->curr, 0, pkt->remaining) != NULL;
}

/* Move the current reading position forward |len| bytes */
__owur static otls_inline int PACKET_forward(PACKET *pkt, size_t len)
{
    if (PACKET_remaining(pkt) < len)
        return 0;
 ...
 */
__owur static otls_inline int PACKET_get_length_prefixed_1(PACKET *pkt,
                                                           PACKET *subpkt)
{
    unsigned int length;
    const unsigned char *data;
 ...
 */
__owur static otls_inline int PACKET_as_length_prefixed_1(PACKET *pkt,
                                                          PACKET *subpkt)
{
    unsigned int length;
    const unsigned char *data;
 ...
 * Upon failure, the original |pkt| and |subpkt| are not modified.
 */
__owur static otls_inline int PACKET_get_length_prefixed_2(PACKET *pkt,
                                                           PACKET *subpkt)
{
    unsigned int length;
    const unsigned char *data;
 ...
 * leftover bytes in |pkt|.
 */
__owur static otls_inline int PACKET_as_length_prefixed_2(PACKET *pkt,
                                                          PACKET *subpkt)
{
    unsigned int length;
    const unsigned char *data;
 ...
 * Upon failure, the original |pkt| and |subpkt| are not modified.
 */
__owur static otls_inline int PACKET_get_length_prefixed_3(PACKET *pkt,
                                                           PACKET *subpkt)
{
