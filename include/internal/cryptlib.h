...
const char *ossl_lib_ctx_safe_getenv(const OSSL_LIB_CTX *libctx, const char *env, const char *file, int line);
char *ossl_lib_ctx_safe_getenv_default(const char *env, const char *file, int line);
#define CRYPTO_safe_getenv(lib, env)                                      \
    (lib ? ossl_lib_ctx_safe_getenv(lib, env, OPENSSL_FILE, OPENSSL_LINE) \
         : ossl_lib_ctx_safe_getenv_default(env, OPENSSL_FILE, OPENSSL_LINE))
