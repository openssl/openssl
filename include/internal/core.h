...
typedef struct ossl_method_construct_method_st {
    /* Create store */
    void *(*alloc_tmp_store)(OSSL_CTX *ctx);
    /* Remove a store */
    void (*dealloc_tmp_store)(void *store);
    /* Get an already existing method from a store */
    void *(*get)(OSSL_CTX *libctx, void *store, void *data);
    /* Store a method in a store */
    int (*put)(OSSL_CTX *libctx, void *store, void *method,
...
void *ossl_method_construct(OSSL_CTX *ctx, int operation_id,
                            int force_cache,
                            OSSL_METHOD_CONSTRUCT_METHOD *mcm, void *mcm_data);

void ossl_algorithm_do_all(OSSL_CTX *libctx, int operation_id,
