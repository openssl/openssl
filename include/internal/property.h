...
/* Initialisation */
int ossl_property_parse_init(OSSL_CTX *ctx);

/* Property definition parser */
OSSL_PROPERTY_LIST *ossl_parse_property(OSSL_CTX *ctx, const char *defn);
/* Property query parser */
OSSL_PROPERTY_LIST *ossl_parse_query(OSSL_CTX *ctx, const char *s);
/* Property checker of query vs definition */
int ossl_property_match_count(const OSSL_PROPERTY_LIST *query,
                              const OSSL_PROPERTY_LIST *defn);
int ossl_property_is_enabled(OSSL_CTX *ctx,  const char *property_name,
...
OSSL_METHOD_STORE *ossl_method_store_new(OSSL_CTX *ctx);
...
OSSL_PROPERTY_LIST **ossl_ctx_global_properties(OSSL_CTX *ctx);
