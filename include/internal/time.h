...
static ossl_unused ossl_inline OSSL_TIME ossl_time_subtract(OSSL_TIME a,
							    OSSL_TIME b)
{
	OSSL_TIME r;
	int err = 0;
...
/* Returns |a - b|. */
static ossl_unused ossl_inline OSSL_TIME ossl_time_abs_difference(OSSL_TIME a,
								  OSSL_TIME b)
{
	return a.t > b.t ? ossl_time_subtract(a, b) : ossl_time_subtract(b, a);
}

static ossl_unused ossl_inline OSSL_TIME ossl_time_multiply(OSSL_TIME a,
							    uint64_t b)
{
	OSSL_TIME r;
	int err = 0;
...
static ossl_unused ossl_inline OSSL_TIME ossl_time_divide(OSSL_TIME a,
							  uint64_t b)
{
	OSSL_TIME r;
	int err = 0;
...
static ossl_unused ossl_inline OSSL_TIME ossl_time_muldiv(OSSL_TIME a,
							  uint64_t b,
							  uint64_t c)
{
	OSSL_TIME r;
