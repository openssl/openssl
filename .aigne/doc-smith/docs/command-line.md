...
openssl-cms-tool: {
  label: "openssl cms (Command-Line Tool)"
  shape: rectangle
  ...
  operations: {
    ...
    resign: "-resign"
    digest-create: "-digest_create"
    encrypteddata-encrypt: "-EncryptedData_encrypt"
  }
}

openssl-cms-library: {
  label: "OpenSSL CMS Library (Core API)"
  shape: rectangle

  api-functions: {
    label: "Core API Functions"
    shape: rectangle
    grid-columns: 3

    CMS-sign: "CMS_sign()"
    CMS-verify: "CMS_verify()"
    CMS-encrypt: "CMS_encrypt()"
    CMS-decrypt: "CMS_decrypt()"
    CMS-compress: "CMS_compress()"
    CMS-uncompress: "CMS_uncompress()"
    CMS-digest-create: "CMS_digest_create()"
    CMS-EncryptedData-encrypt: "CMS_EncryptedData_encrypt()"
  }
}

cms-content-types: {
  label: "CMS Content Types"
  shape: rectangle
  grid-columns: 3
...
openssl-cms-tool.operations.sign -> openssl-cms-library.api-functions.CMS-sign
openssl-cms-tool.operations.verify -> openssl-cms-library.api-functions.CMS-verify
openssl-cms-tool.operations.encrypt -> openssl-cms-library.api-functions.CMS-encrypt
openssl-cms-tool.operations.decrypt -> openssl-cms-library.api-functions.CMS-decrypt
openssl-cms-tool.operations.compress -> openssl-cms-library.api-functions.CMS-compress
openssl-cms-tool.operations.uncompress -> openssl-cms-library.api-functions.CMS-uncompress
openssl-cms-tool.operations.resign -> openssl-cms-library.api-functions.CMS-sign: "with CMS_REUSE_DIGEST"
openssl-cms-tool.operations.digest-create -> openssl-cms-library.api-functions.CMS-digest-create
openssl-cms-tool.operations.encrypteddata-encrypt -> openssl-cms-library.api-functions.CMS-EncryptedData-encrypt

openssl-cms-tool.operations.sign -> cms-content-types.SignedData: "Creates/Verifies"
openssl-cms-tool.operations.verify -> cms-content-types.SignedData
openssl-cms-tool.operations.resign -> cms-content-types.SignedData

openssl-cms-tool.operations.encrypt -> cms-content-types.EnvelopedData: "Creates/Processes"
openssl-cms-tool.operations.decrypt -> cms-content-types.EnvelopedData

openssl-cms-tool.operations.compress -> cms-content-types.CompressedData: "Creates/Processes"
openssl-cms-tool.operations.uncompress -> cms-content-types.CompressedData

openssl-cms-tool.operations.digest-create -> cms-content-types.DigestedData: "Creates"

openssl-cms-tool.operations.encrypteddata-encrypt -> cms-content-types.EncryptedData: "Creates"
