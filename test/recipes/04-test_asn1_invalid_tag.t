...
#
# Test 10: asn1parse should accept valid certificate
#
ok(run(app(['openssl', 'asn1parse',
            '-in', $valid_cert_pem,
            '-inform', 'PEM',
...
#
# Test 11: openssl x509 -text should accept valid certificate
#
ok(run(app(['openssl', 'x509',
            '-in', $valid_cert_pem,
            '-text',
...
#
# Test 12: openssl x509 -subject should work with valid certificate
#
{
...
#
# Test 14: openssl x509 -dates should work with valid certificate
#
{
...
#
# Test 16: Test conversion attempt from PEM to DER should fail
#
{
