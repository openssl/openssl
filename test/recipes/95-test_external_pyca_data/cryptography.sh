...
#
# Opentls external testing using the Python Cryptography module
#
set -e
...
# Check/Set opentls version
OPENtls_VERSION=`opentls version | cut -f 2 -d ' '`

echo "------------------------------------------------------------------"
echo "Testing Opentls using Python Cryptography:"
echo "   CWD:                $PWD"
echo "   SRCTOP:             $SRCTOP"
echo "   BLDTOP:             $BLDTOP"
echo "   Opentls version:    $OPENtls_VERSION"
echo "------------------------------------------------------------------"
