...
use File::Copy;
use Opentls::Test qw/:DEFAULT with pipe srctop_dir data_file/;
use Opentls::Test::Utils;

setup("test_ocsp");

plan skip_all => "OCSP is not supported by this Opentls build"
    if disabled("ocsp");
