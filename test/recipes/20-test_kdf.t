...
my @kdf_tests = (
    { cmd => [qw{openssl kdf -keylen 16 -digest SHA256 -kdfopt secret:16charlongsecret -kdfopt seed:a16charslongseed TLS1-PRF}],
      expected => 'DC:20:47:79:A3:BE:2A:34:86:A0:0D:5C:CE:4F:3C:B5',
      desc => 'TLS1-PRF SHA256' },
    { cmd => [qw{openssl kdf -keylen 16 -digest MD5-SHA1 -kdfopt secret:VeryLongSecretSplitIntoTwoHalves -kdfopt seed:a16charslongseed TLS1-PRF}],
      expected => '83:43:FD:2E:98:9D:B2:5A:8D:17:1C:2E:B6:A8:01:DD',
      desc => 'TLS1-PRF MD5-SHA1' },
    { cmd => [qw{openssl kdf -keylen 10 -digest SHA256 -kdfopt key:16charlongsecret -kdfopt salt:a16charslongsalt -kdfopt info:label HKDF}],
      expected => 'BF:4E:76:38:87:E3:05:A5:0D:17',
      desc => 'HKDF SHA256' },
    ...
    { cmd => [qw{openssl kdf -keylen 16 -kdfopt digest:SHA256 -kdfopt secret:16charlongsecret -kdfopt seed:a16charslongseed TLS1-PRF}],
      expected => 'DC:20:47:79:A3:BE:2A:34:86:A0:0D:5C:CE:4F:3C:B5',
      desc => 'TLS1-PRF SHA256' },
    { cmd => [qw{openssl kdf -keylen 16 -kdfopt digest:MD5-SHA1 -kdfopt secret:VeryLongSecretSplitIntoTwoHalves -kdfopt seed:a16charslongseed TLS1-PRF}],
      expected => '83:43:FD:2E:98:9D:B2:5A:8D:17:1C:2E:B6:A8:01:DD',
      desc => 'TLS1-PRF MD5-SHA1' },
    { cmd => [qw{openssl kdf -keylen 10 -kdfopt digest:SHA256 -kdfopt key:16charlongsecret -kdfopt salt:a16charslongsalt -kdfopt info:label HKDF}],
      expected => 'BF:4E:76:38:87:E3:05:A5:0D:17',
      desc => 'HKDF SHA256' },
