...
static int test_mod_exp(int round)
{
	...
	if (!TEST_true(BN_mod(a, a, m, ctx)) ||
	    ...
	    !TEST_true(BN_mod_exp_mont_consttime(r_mont_const, a, b, m, ctx,
						 NULL)))
		goto err;
...
static int test_mod_exp_x2(int idx)
{
	...
	if (!TEST_ptr(r_mont_const_x2_1 = BN_new()) ||
	    ...
	    !TEST_ptr(r_simple2 = BN_new()) || !TEST_ptr(a1 = BN_new()) ||
	    !TEST_ptr(b1 = BN_new()) || !TEST_ptr(m1 = BN_new()) ||
	    !TEST_ptr(a2 = BN_new()) || !TEST_ptr(b2 = BN_new()) ||
	    !TEST_ptr(m2 = BN_new()))
		goto err;
