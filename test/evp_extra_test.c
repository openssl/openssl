...
static const unsigned char kExampleX25519KeyPKCS8_v2[] = {
    0x30, 0x51, 0x02, 0x01, 0x01, 0x30, 0x05, 0x06, 0x03, 0x2b, 0x65, 0x6e,
    0x04, 0x22, 0x04, 0x20,
...
static const unsigned char kExampleX25519KeyPKCS8_v2_badpub[] = {
    0x30, 0x50, 0x02, 0x01, 0x01, 0x30, 0x05, 0x06, 0x03, 0x2b, 0x65, 0x6e,
    0x04, 0x22, 0x04, 0x20,
    0x77, 0x07, 0x6d, 0x0a, 0x73, 0x18, 0xa5, 0x7d, 0x3c, 0x16, 0xc1, 0x72,
    0x51, 0xb2, 0x66, 0x45, 0xdf, 0x4c, 0x2f, 0x87, 0xeb, 0xc0, 0x99, 0x2a,
    0xb1, 0x77, 0xfb, 0xa5, 0x1d, 0xb9, 0x2c, 0x2a,
...
static const unsigned char kExampleX448KeyPKCS8_v2[] = {
    0x30, 0x81, 0x81, 0x02, 0x01, 0x01, 0x30, 0x05, 0x06, 0x03, 0x2b, 0x65,
    0x6f, 0x04, 0x3a, 0x04, 0x38,
...
static const unsigned char kExampleX448KeyPKCS8_v2_badpub[] = {
    0x30, 0x81, 0x80, 0x02, 0x01, 0x01, 0x30, 0x05, 0x06, 0x03, 0x2b, 0x65,
    0x6f, 0x04, 0x3a, 0x04, 0x38,
    0x9a, 0x8f, 0x49, 0x25, 0xd1, 0x51, 0x9f, 0x57, 0x75, 0xcf, 0x46, 0xb0,
    0x4b, 0x58, 0x00, 0xd4, 0xee, 0x9e, 0xe8, 0xba, 0xe8, 0xbc, 0x55, 0x65,
    0xd4, 0x98, 0xc2, 0x8d, 0xd9, 0xc9, 0xba, 0xf5, 0x74, 0xa9, 0x41, 0x97,
    ...
    0xfa, 0xa7, 0x3d, 0x2c, 0x22, 0xc5, 0xd9, 0xbb, 0xc8, 0x36, 0x64, 0x72,
    0x41, 0xd9, 0x53, 0xd4, 0x0c, 0x5b, 0x12, 0xda, 0x88, 0x12, 0x0d, 0x53,
    0x17, 0x7f, 0x80, 0xe5, 0x32, 0xc4, 0x1f
};
...
static const unsigned char kExampleED448KeyPKCS8_v2[] = {
    0x30, 0x81, 0x83, 0x02, 0x01, 0x01, 0x30, 0x05, 0x06, 0x03, 0x2b, 0x65,
    0x71, 0x04, 0x3b, 0x04, 0x39,
...
static const unsigned char kExampleED448KeyPKCS8_v2_badpub[] = {
    0x30, 0x81, 0x82, 0x02, 0x01, 0x01, 0x30, 0x05, 0x06, 0x03, 0x2b, 0x65,
    0x71, 0x04, 0x3b, 0x04, 0x39,
    0x6c, 0x82, 0xa5, 0x62, 0xcb, 0x80, 0x8d, 0x10, 0xd6, 0x32, 0xbe, 0x89,
    0xc8, 0x51, 0x3e, 0xbf, 0x6c, 0x92, 0x9f, 0x34, 0xdd, 0xfa, 0x8c, 0x9f,
    0x63, 0xc9, 0x96, 0x0e, 0xf6, 0xe3, 0x48, 0xa3, 0x52, 0x8c, 0x8a, 0x3f,
...
static const ECX_PKCS8_V2_KAT ecx_pkcs8_v2_kats[] = {
    { kExampleX25519KeyPKCS8_v2, sizeof(kExampleX25519KeyPKCS8_v2),
        kExampleX25519KeyPKCS8_v2_badpub, sizeof(kExampleX25519KeyPKCS8_v2_badpub),
        51, 32 },
    { kExampleX448KeyPKCS8_v2, sizeof(kExampleX448KeyPKCS8_v2),
        kExampleX448KeyPKCS8_v2_badpub, sizeof(kExampleX448KeyPKCS8_v2_badpub),
        76, 56 },
    { kExampleED25519KeyPKCS8_v2, sizeof(kExampleED25519KeyPKCS8_v2),
        kExampleED25519KeyPKCS8_v2_badpub, sizeof(kExampleED25519KeyPKCS8_v2_badpub),
        51, 32 },
    { kExampleED448KeyPKCS8_v2, sizeof(kExampleED448KeyPKCS8_v2),
        kExampleED448KeyPKCS8_v2_badpub, sizeof(kExampleED448KeyPKCS8_v2_badpub),
        77, 57 },
};
#endif
#endif
...
#endif
#ifndef OPENSSL_NO_ECX
    { kExampleX25519KeyPKCS8_v2, sizeof(kExampleX25519KeyPKCS8_v2), "X25519",
        EVP_PKEY_X25519 },
    { kExampleX448KeyPKCS8_v2, sizeof(kExampleX448KeyPKCS8_v2), "X448",
        EVP_PKEY_X448 },
    { kExampleED25519KeyPKCS8_v2, sizeof(kExampleED25519KeyPKCS8_v2), "ED25519",
        EVP_PKEY_ED25519 },
    { kExampleED448KeyPKCS8_v2, sizeof(kExampleED448KeyPKCS8_v2), "ED448",
        EVP_PKEY_ED448 },
#endif
};
...
#ifndef OPENSSL_NO_ECX
static int test_ECX_PKCS8_v2_uses_pubkey(int i)
{
    const ECX_PKCS8_V2_KAT *kat = &ecx_pkcs8_v2_kats[i];
    int ret = 0;
    const unsigned char *p = kat->good;
    PKCS8_PRIV_KEY_INFO *p8inf = NULL;
    EVP_PKEY *pkey = NULL;
    ...
    if (!TEST_mem_eq(pub, publen, kat->good + kat->pub_offset, kat->pub_len))
        goto done;
...
static int test_ECX_PKCS8_v2_bad_pubkey_length(int i)
{
    const ECX_PKCS8_V2_KAT *kat = &ecx_pkcs8_v2_kats[i];
    int ret = 0;
    const unsigned char *p = kat->bad;
    PKCS8_PRIV_KEY_INFO *p8inf = NULL;
    EVP_PKEY *pkey = NULL;
...
#endif
#ifndef OPENSSL_NO_ECX
    ADD_ALL_TESTS(test_ECX_PKCS8_v2_uses_pubkey, OSSL_NELEM(ecx_pkcs8_v2_kats));
    ADD_ALL_TESTS(test_ECX_PKCS8_v2_bad_pubkey_length, OSSL_NELEM(ecx_pkcs8_v2_kats));
#endif
#ifndef OPENSSL_NO_EC
