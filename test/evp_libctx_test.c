...
static int test_dsa_param_keygen(int tstid)
{
	...
	if (!TEST_ptr(pkey_parm = EVP_PKEY_new()) ||
	    !TEST_ptr(dsa = DSA_new()) || !TEST_ptr(p = BN_dup(bn[pind])) ||
...
static int dhx_cert_load(void)
{
	...
	static const unsigned char dhx_cert[] = {
		,
		...
		,
...
static int test_cipher_reinit(int test_id)
{
	...
	unsigned char iv[48] = {
		...
		0x05, 0x04, 0x03, 0x02, 0x01, 0x00, 0x0f, 0x0e, 0x0d, 0x0c,
		0x0b, 0x0a, 0x09, 0x08, 0x07, 0x06, 0x05, 0x04, 0x03, 0x02,
		0x01, 0x00, 0x0f, 0x0e, 0x0d, 0x0c, 0x0b, 0x0a, 0x09, 0x08,
	...
	if (!TEST_true(EVP_EncryptInit_ex(ctx, cipher, NULL, key, iv)) ||
	    !TEST_true(
		    EVP_EncryptUpdate(ctx, out1, &out1_len, in, sizeof(in))) ||
	    !TEST_true(EVP_EncryptInit_ex(ctx, NULL, NULL, key, iv)) ||
	    !TEST_int_eq(EVP_EncryptUpdate(ctx, out2, &out2_len, in,
					   sizeof(in)),
			 ccm ? 0 : 1) ||
	    (!no_null_key &&
	     (!TEST_true(EVP_EncryptInit_ex(ctx, NULL, NULL, NULL, iv)) ||
	      !TEST_int_eq(EVP_EncryptUpdate(ctx, out3, &out3_len, in,
					     sizeof(in)),
			   ccm || siv ? 0 : 1))))
		goto err;
...
static int test_cipher_reinit_partialupdate(int test_id)
{
	...
	if (EVP_CIPHER_get_mode(cipher) != EVP_CIPH_SIV_MODE) {
		if (!TEST_true(EVP_EncryptInit_ex(ctx, NULL, NULL, NULL, iv)) ||
		    !TEST_true(EVP_EncryptUpdate(ctx, out3, &out3_len, in,
						 in_len)))
			goto err;
...
static int rsa_keygen(int bits, EVP_PKEY **pub, EVP_PKEY **priv)
{
	...
	if (!TEST_ptr(*priv = EVP_PKEY_Q_keygen(libctx, NULL, "RSA",
						(size_t)bits)) ||
	    !TEST_ptr(ectx = OSSL_ENCODER_CTX_new_for_pkey(
			      *priv, EVP_PKEY_PUBLIC_KEY, "DER",
			      "type-specific", NULL)) ||
...
static int kem_rsa_gen_recover(void)
{
	...
	ret = TEST_true(rsa_keygen(bits, &pub, &priv)) &&
	      ...
	      && TEST_int_eq(EVP_PKEY_encapsulate(dctx, NULL, NULL, NULL, NULL),
			     0) &&
	      ...
	      && TEST_int_eq(EVP_PKEY_decapsulate(rctx, NULL, NULL, ct, ctlen),
			     0) &&
	      TEST_int_eq(EVP_PKEY_decapsulate(rctx, NULL, &unwraplen, ct,
					       ctlen),
			  1) &&
	...
	if (fips_provider_version_match(libctx, ">=3.4.0")) {
		...
		if (!TEST_int_eq(EVP_PKEY_encapsulate(dctx, ct, &ctlen, secret,
			...
			ret = 0;
		unwraplen = 1;
		if (!TEST_int_eq(EVP_PKEY_decapsulate(rctx, unwrap, &unwraplen,
						      ct, ctlen),
				 0))
			ret = 0;
	}
...
static int test_cipher_tdes_randkey(void)
{
	...
	ret = TEST_ptr(aes_cipher =
			       EVP_CIPHER_fetch(libctx, "AES-256-CBC", NULL)) &&
	      TEST_int_eq(EVP_CIPHER_get_flags(aes_cipher) & EVP_CIPH_RAND_KEY,
			  0) &&
	      TEST_ptr(tdes_cipher = EVP_CIPHER_fetch(libctx, "DES-EDE3-CBC",
						      NULL)) &&
...
static int kem_rsa_params(void)
{
	...
	ret = TEST_true(rsa_keygen(2048, &pub, &priv)) &&
	      TEST_ptr(pubctx =
			       EVP_PKEY_CTX_new_from_pkey(libctx, pub, NULL)) &&
	      ...
	      TEST_int_eq(EVP_PKEY_encapsulate(NULL, NULL, NULL, NULL, NULL),
			  0) &&
	      TEST_int_eq(EVP_PKEY_decapsulate_init(NULL, NULL), 0) &&
	      TEST_int_eq(EVP_PKEY_decapsulate(NULL, NULL, NULL, NULL, 0), 0)
	      /* Test Invalid operation */
	      &&
	      TEST_int_eq(EVP_PKEY_encapsulate(pubctx, NULL, NULL, NULL, NULL),
			  -1) &&
		...
		TEST_int_eq(EVP_PKEY_encapsulate(pubctx, ct, &ctlen, secret,
	      ...
	      TEST_int_eq(EVP_PKEY_encapsulate(pubctx, ct, &ctlen, secret,
			  ...
			  1) &&
	      TEST_int_eq(
		      EVP_PKEY_encapsulate(pubctx, NULL, &ctlen, NULL, NULL), 1)
	      /* Test outlen is optional */
	      && TEST_int_eq(EVP_PKEY_encapsulate(pubctx, NULL, NULL, NULL,
						  &secretlen),
			     1) &&
	      TEST_int_eq(EVP_PKEY_encapsulate(pubctx, ct, NULL, secret,
					       &secretlen),
			  1)
	      ...
	      &&
	      TEST_int_eq(EVP_PKEY_encapsulate(pubctx, ct, &ctlen, NULL, NULL),
			  0)
	      /* Test that lengths are optional if ct is not NULL */
	      &&
	      TEST_int_eq(EVP_PKEY_encapsulate(pubctx, ct, NULL, secret, NULL),
			  1)
	      ...
	      TEST_int_eq(EVP_PKEY_decapsulate(privctx, secret, NULL, ct,
					       sizeof(ct)),
			  1) &&
	      TEST_int_eq(EVP_PKEY_decapsulate(privctx, NULL, &secretlen, ct,
					       sizeof(ct)),
			  1) &&
	      TEST_size_t_eq(secretlen, 256)
	      /* Fail if passed NULL arguments */
	      && TEST_int_eq(EVP_PKEY_decapsulate(privctx, NULL, NULL, ct,
						  sizeof(ct)),
			     0) &&
	      TEST_int_eq(EVP_PKEY_decapsulate(privctx, secret, &secretlen,
					       NULL, 0),
			  0) &&
	      TEST_int_eq(EVP_PKEY_decapsulate(privctx, secret, &secretlen,
					       NULL, sizeof(ct)),
			  0) &&
	      TEST_int_eq(EVP_PKEY_decapsulate(privctx, secret, &secretlen, ct,
					       0),
			  0);
...
int setup_tests(void)
{
	...
	if (!test_get_libctx(&libctx, &nullprov, config_file, &libprov,
			     prov_name))
		return 0;
