...
int x9_62_tests(BIO *out)
{
    ...
    if (!x9_62_test_internal(out, NID_X9_62_prime192v1,
                             "2623408054273552906779552387643127239018058248758228813849",
                             "2619329836866905250023694652185422560794228085299834354165"))
        goto x962_err;
    if (!x9_62_test_internal(out, NID_X9_62_prime239v1,
                             "2098872907510861932805240651169151107856253308326501643947"
                             "20353063315114",
                             "1356167636197638639731007906369732964551243664952530407273"
                             "8898350833296"))
        goto x962_err;
# ifndef OPENSSL_NO_EC2M
    if (!x9_62_test_internal(out, NID_X9_62_c2tnb191v1,
                             "297436582746530103366031521061286506515578579563991061444",
                             "336508930853776581856356700600247639839044186310758256646"))
        goto x962_err;
    if (!x9_62_test_internal(out, NID_X9_62_c2tnb239v1,
                             "1986784861082223091334636027972839930417869529675286716521"
                             "34815776837726",
                             "7936158242204724759938225445579576835473367574101946316396"
                             "9699045911994"))
        goto x962_err;
# endif
    ret = 1;
