...
static void *fake_keymgmt_new(void *provctx)
{
...
static void fake_keymgmt_free(void *keydata)
{
    OPENSSL_free(keydata);
}

static int fake_keymgmt_import(void *keydata, int selection,
                               const OSSL_PARAM *p)
{
    PROV_CIPHER_FAKE_CTX *ctx = (PROV_CIPHER_FAKE_CTX *)keydata;

    return ctx_from_key_params(ctx, p);
}

static int fake_keymgmt_export(void *keydata, int selection,
...
static int fake_keymgmt_has(const void *key, int selection)
{
    return 1;
}

static const OSSL_PARAM fake_import_key_types[] = {
    OSSL_PARAM_utf8_string(FAKE_CIPHER_PARAM_KEY_NAME, NULL, 0),
    OSSL_PARAM_END
};

static const OSSL_PARAM *fake_keymgmt_imptypes(int selection)
{
    return fake_import_key_types;
}

static const OSSL_PARAM fake_export_key_types[] = {
    OSSL_PARAM_utf8_string(FAKE_CIPHER_PARAM_KEY_NAME, NULL, 0),
    OSSL_PARAM_int(FAKE_CIPHER_PARAM_RAW_KEY, NULL),
    OSSL_PARAM_END
};

static const OSSL_PARAM *fake_keymgmt_exptypes(int selection)
{
    return fake_export_key_types;
}

static const OSSL_DISPATCH fake_keymgmt_funcs[] = {
    { OSSL_FUNC_KEYMGMT_NEW, (void (*)(void))fake_keymgmt_new },
    { OSSL_FUNC_KEYMGMT_FREE, (void (*)(void))fake_keymgmt_free },
    { OSSL_FUNC_KEYMGMT_HAS,  (void (*)(void))fake_keymgmt_has },
    { OSSL_FUNC_KEYMGMT_IMPORT, (void (*)(void))fake_keymgmt_import },
    { OSSL_FUNC_KEYMGMT_IMPORT_TYPES, (void (*)(void))fake_keymgmt_imptypes },
    { OSSL_FUNC_KEYMGMT_EXPORT, (void (*)(void))fake_keymgmt_export },
    { OSSL_FUNC_KEYMGMT_EXPORT_TYPES, (void (*)(void))fake_keymgmt_exptypes },
    OSSL_DISPATCH_END
};

static const OSSL_ALGORITHM fake_keymgmt_algs[] = {
    { "fake_cipher", FAKE_CIPHER_FETCH_PROPS, fake_keymgmt_funcs, "Fake Cipher Key Management" },
    { NULL, NULL, NULL, NULL }
};
