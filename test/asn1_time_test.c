...
static struct testdata tbl_testdata[] = {
    { "0",                 V_ASN1_GENERALIZEDTIME, V_ASN1_GENERALIZEDTIME, 0,           0,  0, 0, 4 }, /* Bad time */
    { "19700101000000Z",   V_ASN1_UTCTIME,         V_ASN1_UTCTIME,         0,           0,  0, 0, 4 },
    { "A00101000000Z",     V_ASN1_UTCTIME,         V_ASN1_UTCTIME,         0,           0,  0, 0, 4 },
    { "19A00101000000Z",   V_ASN1_GENERALIZEDTIME, V_ASN1_GENERALIZEDTIME, 0,           0,  0, 0, 4 },
    { "700101000000X",     V_ASN1_UTCTIME,         V_ASN1_UTCTIME,         0,           0,  0, 0, 4 },
    { "19700101000000X",   V_ASN1_GENERALIZEDTIME, V_ASN1_GENERALIZEDTIME, 0,           0,  0, 0, 4 },
    { "19700101000000Z",   V_ASN1_GENERALIZEDTIME, V_ASN1_UTCTIME,         1,           0, -1, 1, 4 }, /* Epoch begins */
    { "700101000000Z",     V_ASN1_UTCTIME,         V_ASN1_UTCTIME,         1,           0, -1, 1, 4 }, /* ditto */
    { "20380119031407Z",   V_ASN1_GENERALIZEDTIME, V_ASN1_UTCTIME,         1,  0x7FFFFFFF,  1, 1, 4 }, /* Max 32bit time_t */
    { "20380119031408Z",   V_ASN1_GENERALIZEDTIME, V_ASN1_UTCTIME,         1,  0x80000000,  1, 1, 8 }, /* +1 to above */
    { "19011213204552Z",   V_ASN1_GENERALIZEDTIME, V_ASN1_GENERALIZEDTIME, 1, -2147483648, -1, 0, 4 }, /* Min 32bit time_t */
    { "19011213204551Z",   V_ASN1_GENERALIZEDTIME, V_ASN1_GENERALIZEDTIME, 1, -2147483649, -1, 0, 8 }, /* -1 to above */
    { "20371231235959Z",   V_ASN1_GENERALIZEDTIME, V_ASN1_UTCTIME,         1,  2145916799,  1, 1, 4 }, /* Just before 2038 */
    { "20371231235959Z",   V_ASN1_UTCTIME,         V_ASN1_UTCTIME,         0,           0,  0, 1, 4 }, /* Bad UTC time */
    { "371231235959Z",     V_ASN1_UTCTIME,         V_ASN1_UTCTIME,         1,  2145916799,  1, 1, 4 },
    { "19701006121456Z",   V_ASN1_GENERALIZEDTIME, V_ASN1_UTCTIME,         1,    24063296, -1, 1, 4 },
    { "701006121456Z",     V_ASN1_UTCTIME,         V_ASN1_UTCTIME,         1,    24063296, -1, 1, 4 },
    { "19691006121456Z",   V_ASN1_GENERALIZEDTIME, V_ASN1_UTCTIME,         1,    -7472704, -1, 1, 4 },
    { "691006121456Z",     V_ASN1_UTCTIME,         V_ASN1_UTCTIME,         1,    -7472704, -1, 1, 4 },
    { "19991231000000Z",   V_ASN1_GENERALIZEDTIME, V_ASN1_UTCTIME,         1,   946598400,  0, 1, 4 }, /* Match baseline */
    { "199912310000Z",     V_ASN1_GENERALIZEDTIME, V_ASN1_UTCTIME,         1,   946598400,  0, 1, 4 }, /* In various flavors */
    { "991231000000Z",     V_ASN1_UTCTIME,         V_ASN1_UTCTIME,         1,   946598400,  0, 1, 4 },
    { "9912310000Z",       V_ASN1_UTCTIME,         V_ASN1_UTCTIME,         1,   946598400,  0, 1, 4 },
    { "9912310000+0000",   V_ASN1_UTCTIME,         V_ASN1_UTCTIME,         1,   946598400,  0, 1, 4 },
    { "199912310000+0000", V_ASN1_GENERALIZEDTIME, V_ASN1_UTCTIME,         1,   946598400,  0, 1, 4 },
    { "9912310000-0000",   V_ASN1_UTCTIME,         V_ASN1_UTCTIME,         1,   946598400,  0, 1, 4 },
    { "199912310000-0000", V_ASN1_GENERALIZEDTIME, V_ASN1_UTCTIME,         1,   946598400,  0, 1, 4 },
    { "199912310100+0100", V_ASN1_GENERALIZEDTIME, V_ASN1_UTCTIME,         1,   946598400,  0, 1, 4 },
    { "199912302300-0100", V_ASN1_GENERALIZEDTIME, V_ASN1_UTCTIME,         1,   946598400,  0, 1, 4 },
    { "9912310100+0100",   V_ASN1_UTCTIME,         V_ASN1_UTCTIME,         1,   946598400,  0, 1, 4 },
    { "9912302300-0100",   V_ASN1_UTCTIME,         V_ASN1_UTCTIME,         1,   946598400,  0, 1, 4 },
    { "20500101120000Z",   V_ASN1_GENERALIZEDTIME, V_ASN1_GENERALIZEDTIME, 1,  2524651200,  1, 0, 8 },
    { "19000101120000Z",   V_ASN1_GENERALIZEDTIME, V_ASN1_GENERALIZEDTIME, 1, -2208945600, -1, 0, 8 },
};
...
static int test_table(int idx)
{
    ...
    if ((ptime = ASN1_TIME_set(NULL, td->t)) == NULL) {
        ...
        if (ASN1_TIME_cmp_time_t(ptime, td->t) != 0) {
            fprintf(stderr, "ERROR: ASN1_TIME_set(%ld) compare failed (%s->%s)\n",
                    (long)td->t, td->data, ptime->data);
            error = 1;
        }
        if (ptime->type != td->expected_type) {
            fprintf(stderr, "ERROR: ASN1_TIME_set(%ld) unexpected type\n", (long)td->t);
            error = 1;
        }
        fprintf(stderr, "ASN1_TIME_set() = %*s\n", ptime->length, ptime->data);
        ASN1_TIME_free(ptime);
    }

    if ((ptime = ASN1_TIME_new()) == NULL) {
        fprintf(stderr, "ASN1_TIME_new() failed\n");
        error = 1;
    } else {
        if (ASN1_TIME_set_string_gmt(ptime, td->data) != td->check_result) {
            fprintf(stderr, "ERROR: ASN1_TIME_set_string_gmt(%s) failed\n", td->data);
            error = 1;
        }
        if (ptime->type != td->expected_type) {
            fprintf(stderr, "ERROR: ASN1_TIME_set_string_gmt(%s) unexpected type\n", td->data);
            error = 1;
        }
        day = sec = 0;
        if (ASN1_TIME_diff(&day, &sec, ptime, &atime) == 0 || day != 0 || sec != 0) {
            fprintf(stderr, "ERROR: ASN1_TIME_diff(day=%d, sec=%d, %s) after ASN1_TIME_set_string_gmt() failed\n", day, sec, td->data);
            error = 1;
        }
        if (ASN1_TIME_cmp_time_t(ptime, gtime_t) != td->cmp_result) {
            fprintf(stderr, "ERROR: ASN1_TIME_cmp_time_t(%s) after ASN1_TIME_set_string_gnt() to baseline bad comparison\n", td->data);
            error = 1;
        }
        fprintf(stderr, "ASN1_TIME_set_string_gmt() = %*s\n", ptime->length, ptime->data);
        ASN1_TIME_free(ptime);
    }
    ...
    if ((ptime = ASN1_TIME_new()) == NULL) {
        ...
        if (ASN1_TIME_set_string(ptime, td->data) != td->check_result) {
            fprintf(stderr, "ERROR: ASN1_TIME_set_string(%s) failed\n", td->data);
            error = 1;
        }
        day = sec = 0;
        if (ASN1_TIME_diff(&day, &sec, ptime, &atime) == 0 || day != 0 || sec != 0) {
            fprintf(stderr, "ERROR: ASN1_TIME_diff(day=%d, sec=%d, %s) after ASN1_TIME_set_string() failed\n", day, sec, td->data);
            error = 1;
        }
        if (ASN1_TIME_cmp_time_t(ptime, gtime_t) != td->cmp_result) {
            fprintf(stderr, "ERROR: ASN1_TIME_cmp_time_t(%s) after ASN1_TIME_set_string() to baseline bad comparison\n", td->data);
            error = 1;
        }
        fprintf(stderr, "ASN1_TIME_set_string() = %*s\n", ptime->length, ptime->data);
        ASN1_TIME_free(ptime);
    }
