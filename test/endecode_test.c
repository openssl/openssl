                              ...
                              dumper *dump_cb, int flags)
{
    ...
    if ((flags & FLAG_FAIL_IF_FIPS) != 0 && is_fips && !is_fips_3_0_2) {
...
int setup_tests(void)
{
    ...
    /* FIPS(3.0.2): provider imports explicit params but they won't work #17998 */
    is_fips_3_0_2 = provider_version_le(testctx, "fips", 3, 0, 2);
    if (is_fips_3_0_2 < 0)
        return 0;
