...
static const unsigned char entire_encoded_inner[] = {
    ...
    0x00, 0x31, /* extensions len */
    0xfd, 0x00, 0x00, 0x09, 0x08, /* outer exts */
    0x00, 0x0a, 0x00, 0x0d, 0x00, 0x2d, 0x00, 0x33, /* sup_grps, sig_alg, psk_kex, key_share */
    0x00, 0x2b, 0x00, 0x03, 0x02, 0x03, 0x04, /* supported versions */
    0x00, 0x00, 0x00, 0x14, /* server name */
    0x00, 0x12, 0x00, 0x00, 0x0f, 0x66, 0x6f, 0x6f,
    0x2e, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65,
    0x2e, 0x63, 0x6f, 0x6d,
    0xfe, 0x0d, 0x00, 0x01, 0x01, /* ech inner */
...
static const unsigned char borked_outer7[] = {
    0xfd, 0x00, 0x00, 0x04, 0x08,
    0x00, 0x0a, 0x00, 0xFF, 0xFF, 0x00, 0x01, 0x00
};

/* outer with bad inner length (odd number of octets)  */
static const unsigned char borked_outer8[] = {
    0xfd, 0x00, 0x00, 0x09, 0x09,
    0x00, 0x0a, 0x00, 0x0d, 0x00, 0x2d, 0x00, 0x33
};

/* outer with HUGE length (0xFF09) */
static const unsigned char borked_outer9[] = {
    0xfd, 0x00, 0xFF, 0x09, 0x08,
    0x00, 0x0a, 0x00, 0x0d, 0x00, 0x2d, 0x00, 0x33
};
...
static const unsigned char borked_outer10[] = {
    ...
    0x0F, 0x00, 0x05, 0x23, 0x00, 0x16, 0x00, 0x17
};

/* refer to key-share 0x00 0x33 (51) twice within outers */
static const unsigned char borked_outer11[] = {
    0xfd, 0x00, 0x00, 0x09, 0x08,
    0x00, 0x0a, 0x00, 0x33, 0x00, 0x2d, 0x00, 0x33
};

/* refer to psk kex mode 0x00 0x2D (45) twice within outers */
static const unsigned char borked_outer12[] = {
    0xfd, 0x00, 0x00, 0x09, 0x08,
    0x00, 0x2d, 0x00, 0x0d, 0x00, 0x2d, 0x00, 0x33
};
...
static const unsigned char too_many_outers[] = {
    ...
    0x96, 0xc9, 0x00, 0x00, 0x06, 0x13, 0x02, 0x13,
    0x03, 0x13, 0x01, 0x01, 0x00,
    0x00, 0x51, /* extslen, incl. our added outers */
    0xfd, 0x00, /* outers */
    0x00, 0x2b, /* len of outers */
    0x2a, /* above minus one (42) 21 outers */
    0x00, 0x0a, /* the 4 'normal' outers */
    0x00, 0x2d,
    0x00, 0x33,
    0x00, 0x0b, /* point encoding, not actually in outer */
    /* 16 more outers, set 'em all to ALPN (16, 0x10) */
    0x00, 0x10, 0x00, 0x10, 0x00, 0x10, 0x00, 0x10,
    0x00, 0x10, 0x00, 0x10, 0x00, 0x10, 0x00, 0x10,
    0x00, 0x10, 0x00, 0x10, 0x00, 0x10, 0x00, 0x10,
    0x00, 0x10, 0x00, 0x10, 0x00, 0x10, 0x00, 0x10,
    /* and now the inner SNI, inner ECH, supported versions */
    0x00, 0x00, 0x00, 0x14, 0x00, 0x12, 0x00, 0x00,
    0x0f, 0x66, 0x6f, 0x6f, 0x2e, 0x65, 0x78, 0x61,
    0x6d, 0x70, 0x6c, 0x65, 0x2e, 0x63, 0x6f, 0x6d,
    0xfe, 0x0d, 0x00, 0x01, 0x01, 0x00, 0x2b, 0x00,
    0x03, 0x02, 0x03, 0x04
};
...
static const unsigned char tlsv12_like_inner[] = {
    ...
    0x00, 0x2a, /* extslen */
    0xfd, 0x00, /* outers */
    0x00, 0x09, /* len of outers */
    0x08, /* above minus one (8) 4 outers */
 ...
 * without an inner supported versions ext, (take
 * out the extension and add some padding zeros,
 * adjusting lengths) and hence meaning TLSv1.2
 */
static const unsigned char no_supported_vers_ext[] = {
    0x03, 0x03, 0x7b, 0xe8, 0xc1, 0x18, 0xd7, 0xd1,
    0x9c, 0x39, 0xa4, 0xfa, 0xce, 0x75, 0x72, 0x40,
    0xcf, 0x37, 0xbb, 0x4c, 0xcd, 0xa7, 0x62, 0xda,
    0x04, 0xd2, 0xdb, 0xe2, 0x89, 0x33, 0x36, 0x15,
...
static TEST_ECHINNER test_inners[] = {
    ...
    /*
     * 6. unsupported extension instead of outers - since the compressed
     * extensions are missing this results in a missing extension error
     */
    { encoded_inner_pre, sizeof(encoded_inner_pre),
     ...
     */
    { NULL, 0,
        no_supported_vers_ext, sizeof(no_supported_vers_ext),
        NULL, 0,
        0, /* expected result */
