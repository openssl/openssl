...
static const unsigned char tlsv12_inner[] = {
    0x03,
    0x03, /* version, then client-random */
    0x23,
    0xc3,
    0xa0,
    0x49,
    ...
    0x00,
    0x02, /* ciphersuite len, just one */
    0xc0,
    0x2c, /* a TLSv1.2 ciphersuite */
    0x01,
    0x00, /* no compression */
    0x00,
    0x32, /* extslen */
    ...
    0x00,
    0x0b, /* the 'normal' outers, minus supported_versions */
    0x00,
    0x0a,
    0x00,
    0x23,
...
static unsigned char too_short_kdf[] = {
    ...
    0x0d,
    0x00,
    0x02, /* ext type & length */
    0x00,
    0x00,
    0x01,
    0x00,
    0x01, /* cipher suite KDF, AEAD */
};
