...
static int test_evp_md_ctx_serialize(int tstid)
{
    ...
    params[0] = OSSL_PARAM_construct_octet_string(OSSL_DIGEST_SERIALIZATION,
                                                  NULL, 0);
    params[1] = OSSL_PARAM_construct_end();
    if (!TEST_true(EVP_MD_CTX_get_params(mdctx1, params)))
        goto end;

    buflen = params[0].return_size;
    ...
    if (!TEST_true(EVP_DigestInit_ex2(mdctx2, md, params)))
        goto end;
