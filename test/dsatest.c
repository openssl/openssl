...
static int dsa_test(void)
{
	...
	if (!TEST_ptr(dsa = DSA_new()) ||
	    !TEST_true(DSA_generate_parameters_ex(dsa, 512, seed, 20, &counter,
						  &h, cb)))
		goto end;
...
static int dsa_keygen_test(void)
{
	...
	static const unsigned char expected_p[] = {
		
	};
	...
	static const unsigned char expected_g[] = {
		
	};
	int expected_c = 1316;
	int expected_h = 2;
	...
	if (!TEST_true(EVP_PKEY_get_bn_param(key, OSSL_PKEY_PARAM_FFC_P,
	    ...
	    !TEST_false(EVP_PKEY_get_utf8_string_param(
		    key, OSSL_PKEY_PARAM_GROUP_NAME, group_out,
...
static int test_dsa_default_paramgen_validate(int i)
{
	...
	ret = TEST_ptr(gen_ctx =
			       EVP_PKEY_CTX_new_from_name(NULL, "DSA", NULL)) &&
	      ...
	      TEST_ptr(check_ctx = EVP_PKEY_CTX_new_from_pkey(NULL, params,
							      NULL)) &&
...
static int test_dsa_sig_infinite_loop(void)
{
	...
	static unsigned char out_priv[] = { 0x17, 0x00, 0xb2, 0x8d, 0xcb,
					    0x24, 0xc9, 0x98, 0xd0, 0x7f,
					    0x1f, 0x83, 0x1a, 0xa1, 0xc4,
					    0xa4, 0xf8, 0x0f, 0x7f, 0x12 };
	static unsigned char out_pub[] = {
		0x04, 0x72, 0xee, 0x8d, 0xaa, 0x4d, 0x89, 0x60, 0x0e, 0xb2,
		0xd4, 0x38, 0x84, 0xa2, 0x2a, 0x60, 0x5f, 0x67, 0xd7, 0x9e,
		0x24, 0xdd, 0xe8, 0x50, 0xf2, 0x23, 0x71, 0x55, 0x53, 0x94,
		0x0d, 0x6b, 0x2e, 0xcd, 0x30, 0xda, 0x6f, 0x1e, 0x2c, 0xcf,
		0x59, 0xbe, 0x05, 0x6c, 0x07, 0x0e, 0xc6, 0x38, 0x05, 0xcb,
		0x0c, 0x44, 0x0a, 0x08, 0x13, 0xb6, 0x0f, 0x14, 0xde, 0x4a,
		0xf6, 0xed, 0x4e, 0xc3
	};
	...
	if (!TEST_true(DSA_sign(0, msg, sizeof(msg), NULL, &signature_len0,
				dsa)) ||
