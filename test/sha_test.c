...
static int test_static_sha224(void)
{
	...
	return test_static_sha_common("abc", SHA224_DIGEST_LENGTH, output,
				      &SHA224);
}
...
static int test_static_sha256(void)
{
	...
	return test_static_sha_common("abc", SHA256_DIGEST_LENGTH, output,
				      &SHA256);
}
...
static int test_static_sha384(void)
{
	...
	return test_static_sha_common("abc", SHA384_DIGEST_LENGTH, output,
				      &SHA384);
}
...
static int test_static_sha512(void)
{
	...
	return test_static_sha_common("abc", SHA512_DIGEST_LENGTH, output,
				      &SHA512);
}
