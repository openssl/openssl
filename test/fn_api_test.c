...
static int test_add(int i)
{
    ...
    if (!TEST_ptr(num1 = OSSL_FN_new_limbs(n1_limbs))
        ...
        || !TEST_mem_eq(u, ossl_fn_get_limbs(res) * OSSL_FN_BYTES,
...
static const struct {
    bool neg;
    OSSL_FN_ULONG num[3];
} expected_sub_num_num[4][4] = {
    {
        /* num[0] - num[0] */ {false, {OSSL_FN_ULONG64_C(0x00000000, 0x00000000)}},
        /* num[0] - num[1] */ {false, {OSSL_FN_ULONG64_C(0x7ffffffe, 0x80000001)}},
        /* num[0] - num[2] */ {false, {OSSL_FN_ULONG64_C(0x7edcba98, 0x76543212)}},
        /* num[0] - num[3] */ {true,  {OSSL_FN_ULONG64_C(0x7edcba98, 0x7654320f)}},
    }, {
        /* num[1] - num[0] */ {true,  {OSSL_FN_ULONG64_C(0x7ffffffe, 0x80000001)}},
        /* num[1] - num[1] */ {false, {OSSL_FN_ULONG64_C(0x00000000, 0x00000000)}},
        /* num[1] - num[2] */ {true,  {OSSL_FN_ULONG64_C(0x01234566, 0x09abcdef)}},
        /* num[1] - num[3] */ {true,  {OSSL_FN_ULONG64_C(0xfedcba96, 0xf6543210)}},
    }, {
        /* num[2] - num[0] */ {true,  {OSSL_FN_ULONG64_C(0x7edcba98, 0x76543212)}},
        /* num[2] - num[1] */ {false, {OSSL_FN_ULONG64_C(0x01234566, 0x09abcdef)}},
        /* num[2] - num[2] */ {false, {OSSL_FN_ULONG64_C(0x00000000, 0x00000000)}},
        /* num[2] - num[3] */ {true,  {OSSL_FN_ULONG64_C(0xfdb97530, 0xeca86421)}},
    }, {
        /* num[3] - num[0] */ {false, {OSSL_FN_ULONG64_C(0x7edcba98, 0x7654320f)}},
        /* num[3] - num[1] */ {false, {OSSL_FN_ULONG64_C(0xfedcba96, 0xf6543210)}},
        /* num[3] - num[2] */ {false, {OSSL_FN_ULONG64_C(0xfdb97530, 0xeca86421)}},
        /* num[3] - num[3] */ {false, {OSSL_FN_ULONG64_C(0x00000000, 0x00000000)}},
    },
};
...
static int test_sub(int i)
{
    ...
    const OSSL_FN_ULONG *n2 = num[i2];
    size_t n2_limbs = sizeof(num[i2]) / OSSL_FN_BYTES;
    const OSSL_FN_ULONG *ex = expected_sub_num_num[i1][i2].num;
    size_t ex_limbs = sizeof(expected_sub_num_num[i1][i2].num) / OSSL_FN_BYTES;
    bool ex_neg = expected_sub_num_num[i1][i2].neg;
    int ret = 1;
    OSSL_FN *num1, *num2, *res;
    const OSSL_FN_ULONG *u = NULL;
    ...
    if (!TEST_ptr(num1 = OSSL_FN_new_limbs(n1_limbs))
        ...
        || !TEST_mem_eq(u, ossl_fn_get_limbs(res) * OSSL_FN_BYTES,
                        ex, ex_limbs * OSSL_FN_BYTES)
        || !(ex_neg
             ? TEST_true(ossl_fn_is_negative(res))
             : TEST_false(ossl_fn_is_negative(res))))
        ret = 0;
    OSSL_FN_free(num1);
    OSSL_FN_free(num2);
    OSSL_FN_free(res);
