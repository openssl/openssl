...
static const uint8_t out_u3[3][56] = {
	{ 0x3f, 0x48, 0x2c, 0x8a, 0x9f, 0x19, 0xb0, 0x1e, 0x6c, 0x46,
	...
	{ 0xaa, 0x3b, 0x47, 0x49, 0xd5, 0x5b, 0x9d, 0xaf, 0x1e, 0x5b,
	...
	{ 0x07, 0x7f, 0x45, 0x36, 0x81, 0xca, 0xca, 0x36, 0x93, 0x19,
	  0x84, 0x20, 0xbb, 0xe5, 0x15, 0xca, 0xe0, 0x00, 0x24, 0x72,
	  0x51, 0x9b, 0x3e, 0x67, 0x66, 0x1a, 0x7e, 0x89, 0xca, 0xb9,
	  0x46, 0x95, 0xc8, 0xf4, 0xbc, 0xd6, 0x6e, 0x61, 0xb9, 0xb9,
	  0xc9, 0x46, 0xda, 0x8d, 0x52, 0x4d, 0xe3, 0xd6, 0x9b, 0xd9,
	  0xd9, 0xd6, 0x6b, 0x99, 0x7e, 0x37 }
};
...
static int test_ed448(void)
{
	...
	if (!TEST_ptr(hashctx) ||
	    ...
	    !TEST_true(ossl_ed448_sign(NULL, outsig,
				       ...
				       64, phpubkey2, phprivkey2, phcontext2,
...
static int test_x448(void)
{
	...
	for (i = 1; i <= max; i++) {
		...
		if (i == 1 || i == 1000 || i == 1000000) {
			j++;
			if (!TEST_int_eq(memcmp(out, out_u3[j], sizeof(out)),
					 0)) {
