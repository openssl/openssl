...
EVP_PKEY *get_dh512(OSSL_LIB_CTX *libctx)
{
	...
	return get_dh_from_pg(libctx, "DH", dh512_p, sizeof(dh512_p), dh512_g,
			      sizeof(dh512_g), NULL, 0);
}
...
EVP_PKEY *get_dhx512(OSSL_LIB_CTX *libctx)
{
	...
	static unsigned char dhx512_q[] = {
		0x00, 0xdd, 0xf6, 0x35, 0xad, 0xfa, 0x70,
		0xc7, 0xe7, 0xa8, 0xf0, 0xe3, 0xda, 0x79,
		0x34, 0x3f, 0x5b, 0xcf, 0x73, 0x82, 0x91,
	};

	return get_dh_from_pg(libctx, "X9.42 DH", dhx512_p, sizeof(dhx512_p),
			      dhx512_g, sizeof(dhx512_g), dhx512_q,
			      sizeof(dhx512_q));
}
