...
#define OPT_TEST_ENUM                                        \
	OPT_TEST_HELP = 500, OPT_TEST_LIST, OPT_TEST_SINGLE, \
	OPT_TEST_ITERATION, OPT_TEST_INDENT, OPT_TEST_SEED
