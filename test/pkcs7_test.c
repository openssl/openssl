...
static int pkcs7_verify_test(void)
{
	...
	ret = TEST_ptr(msg_bio = BIO_new_mem_buf(signed_data,
						 (int)strlen(signed_data))) &&
	      TEST_ptr(x509_bio =
	      ...
	      TEST_int_eq(ERR_peek_error(), 0) &&
	      TEST_true(PKCS7_verify(p7, NULL, store, msg_bio, NULL,
				     PKCS7_TEXT)) &&
	      TEST_int_eq(ERR_peek_error(), 0);
end:
...
static int pkcs7_inner_content_verify_test(void)
{
	...
	const unsigned char sig_der[] = {
		,
		...
		
	};

	if (!TEST_ptr(bio = BIO_new_mem_buf(sig_der, sizeof sig_der)))
		goto end;

	ret = TEST_ptr(x509_bio = BIO_new_mem_buf(smroot_der,
						  sizeof smroot_der)) &&
	      TEST_ptr(cert = d2i_X509_bio(x509_bio, NULL)) &&
	      TEST_int_eq(ERR_peek_error(), 0) &&
	      TEST_ptr(store = X509_STORE_new()) &&
	      ...
	      TEST_true(X509_VERIFY_PARAM_set_purpose(
		      param, X509_PURPOSE_CODE_SIGN)) &&
