...
{
    /*
     * Ideally we'd like to store this in the OSSL_CTX so that we can have
                         ...
                         void **provctx)
{
    ...
    ourglobals.libctx = OSSL_CTX_new();
 ...
 err:
    ...
    OSSL_CTX_free(ourglobals.libctx);
    return 0;
}
