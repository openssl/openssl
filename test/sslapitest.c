...
static int int_test_ssl_get_shared_ciphers(int tst, int clnt)
{
    ...
    int testresult = 0;
    char buf[1024];
    OSSL_CTX *tmplibctx = OSSL_CTX_new();
...
static int test_sigalgs_available(int idx)
{
    ...
    SSL *clientssl = NULL, *serverssl = NULL;
    int testresult = 0;
    OSSL_CTX *tmpctx = OSSL_CTX_new();
    OSSL_CTX *clientctx = libctx, *serverctx = libctx;
...
int setup_tests(void)
{
    ...
    if (!TEST_true(OSSL_CTX_load_config(libctx, configfile)))
        return 0;
