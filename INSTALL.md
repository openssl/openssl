...
the openssl build system for x86_64 only, but can be extended to other architectures.
...
3) Clean the openssl build with make clean (note the profile subdirectory, where the profiling
   data is stored).
