...
#define IMPLEMENT_PEM_provided_write_body_pass()                               \
	...
	if (enc != NULL) {                                                     \
		...
		if (OSSL_ENCODER_CTX_set_cipher(                               \
			    ctx, EVP_CIPHER_get0_name(enc), NULL)) {           \
			ret = 1;                                               \
			if (kstr != NULL &&                                    \
...
legacy:                                                                     \
	return PEM_ASN1_##writename((i2d_of_void *)i2d_##asn1, str, out, x, \
...
#define IMPLEMENT_PEM_provided_write_fp(name, TYPE, type, str, asn1)           \
	IMPLEMENT_PEM_provided_write_to(name, TYPE, type, str, asn1, FILE, fp, \
					write)
#define IMPLEMENT_PEM_provided_write_cb_fp(name, TYPE, type, str, asn1)       \
	IMPLEMENT_PEM_provided_write_cb_to(name, TYPE, type, str, asn1, FILE, \
					   fp, write)
...
#define IMPLEMENT_PEM_provided_write_cb_bio(name, TYPE, type, str, asn1)     \
	IMPLEMENT_PEM_provided_write_cb_to(name, TYPE, type, str, asn1, BIO, \
					   bio, write_bio)
