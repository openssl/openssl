 ...
 */
static inline ossl_unused void vector_init(VECTOR *v, POLY *polys, size_t num_polys)
{
    v->poly = polys;
    v->num_poly = num_polys;
}

static inline ossl_unused int vector_alloc(VECTOR *v, size_t num_polys)
{
...
static inline ossl_unused int vector_secure_alloc(VECTOR *v, size_t num_polys)
{
...
static inline ossl_unused void vector_free(VECTOR *v)
{
    OPENSSL_free(v->poly);
    v->poly = NULL;
    v->num_poly = 0;
...
static inline ossl_unused void vector_secure_free(VECTOR *v, size_t rank)
{
...
static inline ossl_unused void vector_zero(VECTOR *va)
{
    if (va->poly != NULL)
...
static inline ossl_unused size_t
