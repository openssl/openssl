...
static const ERR_STRING_DATA CRYPTO_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_CRYPTO, CRYPTO_F_GET_FIXED, 0), "get_fixed"},
    ...
    {ERR_PACK(ERR_LIB_CRYPTO, CRYPTO_F_OSSL_PARAM_GET_BIGNUM, 0),
     "OSSL_PARAM_get_bignum"},
    {ERR_PACK(ERR_LIB_CRYPTO, CRYPTO_F_OSSL_PARAM_GET_BUFFER, 0),
     "OSSL_PARAM_get_buffer"},
    {ERR_PACK(ERR_LIB_CRYPTO, CRYPTO_F_OSSL_PARAM_RETRIEVE_BIGNUM, 0),
     "OSSL_PARAM_retrieve_bignum"},
    {ERR_PACK(ERR_LIB_CRYPTO, CRYPTO_F_OSSL_PARAM_RETURN_BIGNUM, 0),
     "OSSL_PARAM_return_bignum"},
    {ERR_PACK(ERR_LIB_CRYPTO, CRYPTO_F_OSSL_PARAM_RETURN_BUFFER, 0),
     "OSSL_PARAM_return_buffer"},
    {ERR_PACK(ERR_LIB_CRYPTO, CRYPTO_F_OSSL_PARAM_SET_BIGNUM, 0),
     "OSSL_PARAM_set_bignum"},
    {ERR_PACK(ERR_LIB_CRYPTO, CRYPTO_F_OSSL_PARAM_SET_BUFFER, 0),
     "OSSL_PARAM_set_buffer"},
    ...
    {ERR_PACK(ERR_LIB_CRYPTO, CRYPTO_F_PKEY_SIPHASH_INIT, 0),
     "pkey_siphash_init"},
    {ERR_PACK(ERR_LIB_CRYPTO, CRYPTO_F_RESERVE_FIXED, 0), "reserve_fixed"},
    {ERR_PACK(ERR_LIB_CRYPTO, CRYPTO_F_RESERVE_PTRSIZE, 0), "reserve_ptrsize"},
    {ERR_PACK(ERR_LIB_CRYPTO, CRYPTO_F_RETURN_FIXED, 0), "return_fixed"},
    {ERR_PACK(ERR_LIB_CRYPTO, CRYPTO_F_SET_FIXED, 0), "set_fixed"},
...
static const ERR_STRING_DATA CRYPTO_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_CRYPTO, 0, CRYPTO_R_TYPE_MISMATCH), "type mismatch"},
    {0, NULL}
};
