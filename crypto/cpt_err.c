...
static const ERR_STRING_DATA CRYPTO_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_CRYPTO, CRYPTO_F_OSSL_PARAM_LOCATE, 0),
     "OSSL_PARAM_locate"},
...
static const ERR_STRING_DATA CRYPTO_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_CRYPTO, 0, CRYPTO_R_PARAM_NOT_FOUND),
    "parameter not found"},
    {ERR_PACK(ERR_LIB_CRYPTO, 0, CRYPTO_R_TYPE_MISMATCH),
