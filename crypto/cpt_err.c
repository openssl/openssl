...
static const ERR_STRING_DATA CRYPTO_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_CRYPTO, CRYPTO_F_OSSL_PARAM_GET_DOUBLE, 0),
     "OSSL_PARAM_get_double"},
    {ERR_PACK(ERR_LIB_CRYPTO, CRYPTO_F_OSSL_PARAM_GET_INT_COMMON, 0),
     "OSSL_PARAM_get_int_common"},
    {ERR_PACK(ERR_LIB_CRYPTO, CRYPTO_F_OSSL_PARAM_GET_POINTER, 0),
     "OSSL_PARAM_get_pointer"},
    {ERR_PACK(ERR_LIB_CRYPTO, CRYPTO_F_OSSL_PARAM_SET_BIGNUM, 0),
     "OSSL_PARAM_set_bignum"},
    {ERR_PACK(ERR_LIB_CRYPTO, CRYPTO_F_OSSL_PARAM_SET_DOUBLE, 0),
     "OSSL_PARAM_set_double"},
    {ERR_PACK(ERR_LIB_CRYPTO, CRYPTO_F_OSSL_PARAM_SET_INT_COMMON, 0),
     "OSSL_PARAM_set_int_common"},
    {ERR_PACK(ERR_LIB_CRYPTO, CRYPTO_F_OSSL_PARAM_SET_POINTER, 0),
     "OSSL_PARAM_set_pointer"},
