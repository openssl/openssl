...
void *ossl_decoder_store_new(OSSL_LIB_CTX *);
void *ossl_loader_store_new(OSSL_LIB_CTX *);
void *ossl_encoder_store_new(OSSL_LIB_CTX *);
...
void ossl_decoder_store_free(void *);
void ossl_loader_store_free(void *);
void ossl_encoder_store_free(void *);
