...
static const ERR_STRING_DATA SSL_str_reasons[] = {
	...
	{ ERR_PACK(ERR_LIB_SSL, 0, SSL_R_BAD_DECOMPRESSION),
	  "bad decompression" },
	{ ERR_PACK(ERR_LIB_SSL, 0, SSL_R_BAD_DH_VALUE), "bad dh value" },
	{ ERR_PACK(ERR_LIB_SSL, 0, SSL_R_BAD_DIGEST_LENGTH),
	  "bad digest length" },
	...
	{ ERR_PACK(ERR_LIB_SSL, 0, SSL_R_BAD_HANDSHAKE_STATE),
	  "bad handshake state" },
	{ ERR_PACK(ERR_LIB_SSL, 0, SSL_R_BAD_HELLO_REQUEST),
	  "bad hello request" },
	...
	{ ERR_PACK(ERR_LIB_SSL, 0, SSL_R_BAD_PSK_IDENTITY),
	  "bad psk identity" },
	...
	{ ERR_PACK(ERR_LIB_SSL, 0, SSL_R_BAD_SRP_A_LENGTH),
	  "bad srp a length" },
	...
	{ ERR_PACK(ERR_LIB_SSL, 0, SSL_R_BAD_SSL_FILETYPE),
	  "bad ssl filetype" },
	...
	{ ERR_PACK(ERR_LIB_SSL, 0, SSL_R_CA_KEY_TOO_SMALL),
	  "ca key too small" },
	...
	{ ERR_PACK(ERR_LIB_SSL, 0, SSL_R_DANE_NOT_ENABLED),
	  "dane not enabled" },
	...
	{ ERR_PACK(ERR_LIB_SSL, 0, SSL_R_DECRYPTION_FAILED),
	  "decryption failed" },
	{ ERR_PACK(ERR_LIB_SSL, 0, SSL_R_DECRYPTION_FAILED_OR_BAD_RECORD_MAC),
	  "decryption failed or bad record mac" },
	{ ERR_PACK(ERR_LIB_SSL, 0, SSL_R_DH_KEY_TOO_SMALL),
	  "dh key too small" },
	...
	{ ERR_PACK(ERR_LIB_SSL, 0, SSL_R_EE_KEY_TOO_SMALL),
	  "ee key too small" },
	...
	{ ERR_PACK(ERR_LIB_SSL, 0, SSL_R_LENGTH_TOO_SHORT),
	  "length too short" },
	...
	{ ERR_PACK(ERR_LIB_SSL, 0, SSL_R_PEM_NAME_TOO_SHORT),
	  "pem name too short" },
	{ ERR_PACK(ERR_LIB_SSL, 0, SSL_R_PIPELINE_FAILURE),
	  "pipeline failure" },
	...
	{ ERR_PACK(ERR_LIB_SSL, 0, SSL_R_PSK_NO_CLIENT_CB),
	  "psk no client cb" },
	{ ERR_PACK(ERR_LIB_SSL, 0, SSL_R_PSK_NO_SERVER_CB),
	  "psk no server cb" },
	...
	{ ERR_PACK(ERR_LIB_SSL, 0, SSL_R_SRP_A_CALC),
	...
	{ ERR_PACK(ERR_LIB_SSL, 0, SSL_R_SSL_NEGATIVE_LENGTH),
	  "ssl negative length" },
	{ ERR_PACK(ERR_LIB_SSL, 0, SSL_R_SSL_SECTION_EMPTY),
	  "ssl section empty" },
	...
	{ ERR_PACK(ERR_LIB_SSL, 0, SSL_R_STREAM_RECV_ONLY),
	  "stream recv only" },
	{ ERR_PACK(ERR_LIB_SSL, 0, SSL_R_STREAM_RESET), "stream reset" },
	{ ERR_PACK(ERR_LIB_SSL, 0, SSL_R_STREAM_SEND_ONLY),
	  "stream send only" },
	...
	{ ERR_PACK(ERR_LIB_SSL, 0, SSL_R_UNKNOWN_CIPHER_TYPE),
	  "unknown cipher type" },
	{ ERR_PACK(ERR_LIB_SSL, 0, SSL_R_UNKNOWN_CMD_NAME),
	  "unknown cmd name" },
	...
	{ ERR_PACK(ERR_LIB_SSL, 0, SSL_R_UNKNOWN_PKEY_TYPE),
	  "unknown pkey type" },
	{ ERR_PACK(ERR_LIB_SSL, 0, SSL_R_UNKNOWN_PROTOCOL),
	  "unknown protocol" },
	...
	{ ERR_PACK(ERR_LIB_SSL, 0, SSL_R_VERSION_TOO_HIGH),
	  "version too high" },
	...
	{ ERR_PACK(ERR_LIB_SSL, 0, SSL_R_WRONG_SSL_VERSION),
	  "wrong ssl version" },
