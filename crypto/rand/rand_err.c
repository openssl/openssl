...
static const ERR_STRING_DATA RAND_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_RAND, RAND_F_DRBG_CRNG_CHECK, 0), "drbg_crng_check"},
    ...
    {ERR_PACK(ERR_LIB_RAND, RAND_F_RAND_DRBG_SET_CRNG_TEST_BLOCK_SIZE, 0),
     "RAND_DRBG_set_crng_test_block_size"},
...
static const ERR_STRING_DATA RAND_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_RAND, 0, RAND_R_DRBG_HAS_PARENT), "drbg has parent"},
    ...
    {ERR_PACK(ERR_LIB_RAND, 0, RAND_R_ERROR_CRNG_TEST_FAIL),
    "error crng test fail"},
