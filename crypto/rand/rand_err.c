...
static const ERR_STRING_DATA RAND_str_reasons[] = {
	...
	{ ERR_PACK(ERR_LIB_RAND, 0, RAND_R_CANNOT_OPEN_FILE),
	  "Cannot open file" },
	...
	{ ERR_PACK(ERR_LIB_RAND, 0, RAND_R_FWRITE_ERROR),
	  "Error writing file" },
	...
	{ ERR_PACK(ERR_LIB_RAND, 0, RAND_R_NOT_A_REGULAR_FILE),
	  "Not a regular file" },
	{ ERR_PACK(ERR_LIB_RAND, 0, RAND_R_NOT_INSTANTIATED),
	  "not instantiated" },
	...
	{ ERR_PACK(ERR_LIB_RAND, 0, RAND_R_PRNG_NOT_SEEDED),
	  "PRNG not seeded" },
	...
	{ ERR_PACK(ERR_LIB_RAND, 0, RAND_R_SELFTEST_FAILURE),
	  "selftest failure" },
