...
static const ERR_STRING_DATA RAND_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_RAND, RAND_F_DRBG_CHECK, 0), "drbg_check"},
    {ERR_PACK(ERR_LIB_RAND, RAND_F_DRBG_GET_ENTROPY, 0), "drbg_get_entropy"},
    {ERR_PACK(ERR_LIB_RAND, RAND_F_DRBG_RESEED, 0), "drbg_reseed"},
...
static const ERR_STRING_DATA RAND_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_RAND, 0, RAND_R_DRBG_STUCK), "drbg stuck"},
    {ERR_PACK(ERR_LIB_RAND, 0, RAND_R_ENTROPY_SOURCE_STUCK),
