...
static const ERR_STRING_DATA RAND_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_RAND, 0, RAND_R_PRIMARY_LOCKING_NOT_ENABLED),
    "primary locking not enabled"},
    {ERR_PACK(ERR_LIB_RAND, 0, RAND_R_PRIMARY_STRENGTH_TOO_WEAK),
    "primary strength too weak"},
