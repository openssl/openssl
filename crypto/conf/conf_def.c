...
static void _CONF_free_data(CONF *conf)
{
...
static CONF_VALUE *_CONF_new_section(CONF *conf, const char *section)
{
...
static int _CONF_new_data(CONF *conf)
{
    if (conf == NULL) {
        return 0;
    }
...
static int _CONF_add_string(CONF *conf, CONF_VALUE *section, CONF_VALUE *value)
{
    CONF_VALUE *v = NULL;
