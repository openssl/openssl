...
static const ERR_STRING_DATA RSA_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_RSA, RSA_F_RSA_OSSL_PRIVATE_DECRYPT_EX, 0),
    ...
    {ERR_PACK(ERR_LIB_RSA, RSA_F_RSA_PRIVATE_DECRYPT_EX, 0),
     "RSA_private_decrypt_ex"},
...
static const ERR_STRING_DATA RSA_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_RSA, 0, RSA_R_UNSUPPORTED_BY_METHOD),
    "unsupported by method"},
