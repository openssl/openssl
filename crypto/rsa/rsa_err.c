...
static const ERR_STRING_DATA RSA_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_RSA, RSA_F_RSA_PADDING_ADD_PKCS1_OAEP_MGF1_EX, 0),
     "rsa_padding_add_pkcs1_oaep_mgf1_ex"},
    ...
    {ERR_PACK(ERR_LIB_RSA, RSA_F_RSA_PADDING_ADD_PKCS1_PSS_MGF1_EX, 0),
     "rsa_padding_add_pkcs1_pss_mgf1_ex"},
    ...
    {ERR_PACK(ERR_LIB_RSA, RSA_F_RSA_PADDING_ADD_PKCS1_TYPE_2_EX, 0),
     "RSA_padding_add_PKCS1_type_2_ex"},
    {ERR_PACK(ERR_LIB_RSA, RSA_F_RSA_PADDING_ADD_SSLV23, 0),
     "RSA_padding_add_SSLv23"},
    {ERR_PACK(ERR_LIB_RSA, RSA_F_RSA_PADDING_ADD_SSLV23_EX, 0),
     "rsa_padding_add_sslv23_ex"},
