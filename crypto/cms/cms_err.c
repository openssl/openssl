...
static const ERR_STRING_DATA CMS_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_CMS, 0, CMS_R_CLASSICAL_SIGNATURE_MISSING),
     "classical signature missing"},
    ...
    {ERR_PACK(ERR_LIB_CMS, 0, CMS_R_UNKNOWN_SIGNATURE_ALGORITHM),
