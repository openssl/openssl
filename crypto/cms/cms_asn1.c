...
ASN1_SEQUENCE(
	...
	ASN1_CHOICE(CMS_CertificateChoices) = {
		...
		ASN1_IMP(CMS_CertificateChoices, d.extendedCertificate,
			 ASN1_SEQUENCE, 0),
		ASN1_IMP(CMS_CertificateChoices, d.v1AttrCert, ASN1_SEQUENCE,
			 1),
		ASN1_IMP(CMS_CertificateChoices, d.v2AttrCert, ASN1_SEQUENCE,
			 2),
...
ASN1_SEQUENCE(
	CMS_KEKIdentifier) = { ASN1_SIMPLE(CMS_KEKIdentifier, keyIdentifier,
					   ASN1_OCTET_STRING),
			       ASN1_OPT(CMS_KEKIdentifier, date,
...
ASN1_NDEF_SEQUENCE(
	CMS_AuthenticatedData) = { ASN1_EMBED(CMS_AuthenticatedData, version,
					      INT32),
...
ASN1_ADB(CMS_ContentInfo) = {
	ADB_ENTRY(NID_pkcs7_data, ASN1_NDEF_EXP(CMS_ContentInfo, d.data,
						ASN1_OCTET_STRING_NDEF, 0)),
	ADB_ENTRY(NID_pkcs7_signed, ASN1_NDEF_EXP(CMS_ContentInfo, d.signedData,
						  CMS_SignedData, 0)),
...
ASN1_CHOICE(
	CMS_ReceiptsFrom) = { ASN1_IMP_EMBED(CMS_ReceiptsFrom, d.allOrFirstTier,
					     INT32, 0),
