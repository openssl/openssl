...
{
	if (ossl_x509at_add1_attr_by_OBJ(&si->signedAttrs, obj, type, bytes,
					 len))
		return 1;
	return 0;
}
...
{
	if (ossl_x509at_add1_attr_by_NID(&si->signedAttrs, nid, type, bytes,
					 len))
		return 1;
	return 0;
}
...
int CMS_signed_add1_attr_by_txt(CMS_SignerInfo *si, const char *attrname,
				int type, const void *bytes, int len)
{
	if (ossl_x509at_add1_attr_by_txt(&si->signedAttrs, attrname, type,
					 bytes, len))
		return 1;
	return 0;
}
...
int CMS_unsigned_add1_attr_by_OBJ(CMS_SignerInfo *si, const ASN1_OBJECT *obj,
				  int type, const void *bytes, int len)
{
	if (ossl_x509at_add1_attr_by_OBJ(&si->unsignedAttrs, obj, type, bytes,
					 len))
		return 1;
	return 0;
}
...
int CMS_unsigned_add1_attr_by_NID(CMS_SignerInfo *si, int nid, int type,
				  const void *bytes, int len)
{
	if (ossl_x509at_add1_attr_by_NID(&si->unsignedAttrs, nid, type, bytes,
					 len))
		return 1;
	return 0;
}
...
int CMS_unsigned_add1_attr_by_txt(CMS_SignerInfo *si, const char *attrname,
				  int type, const void *bytes, int len)
{
	if (ossl_x509at_add1_attr_by_txt(&si->unsignedAttrs, attrname, type,
					 bytes, len))
		return 1;
	return 0;
}
