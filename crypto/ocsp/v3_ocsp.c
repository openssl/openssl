...
const X509V3_EXT_METHOD ossl_v3_ocsp_crlid = { NID_id_pkix_OCSP_CrlID,
					       0,
...
const X509V3_EXT_METHOD ossl_v3_ocsp_acutoff = { NID_id_pkix_OCSP_archiveCutoff,
						 0,
						 ASN1_ITEM_ref(
...
const X509V3_EXT_METHOD ossl_v3_crl_invdate = { NID_invalidity_date,
						0,
						ASN1_ITEM_ref(
							ASN1_GENERALIZEDTIME),
						0,
...
const X509V3_EXT_METHOD ossl_v3_crl_hold = { NID_hold_instruction_code,
					     0,
...
const X509V3_EXT_METHOD ossl_v3_ocsp_nonce = { NID_id_pkix_OCSP_Nonce,
					       0,
					       NULL,
					       ocsp_nonce_new,
					       ocsp_nonce_free,
...
const X509V3_EXT_METHOD ossl_v3_ocsp_nocheck = { NID_id_pkix_OCSP_noCheck,
						 0,
