...
ASN1_SEQUENCE(OSSL_CMP_REVREPCONTENT) = {
    ...
    ASN1_EXP_SEQUENCE_OF_OPT(OSSL_CMP_REVREPCONTENT, crls, X509, 1)
...
ASN1_ITEM_TEMPLATE(OSSL_CMP_REVREPCONTENTOSSL_CMP_POLLREPCONTENT) =
    ASN1_EX_TEMPLATE_TYPE(ASN1_TFLG_SEQUENCE_OF, 0,
                          OSSL_CMP_REVREPCONTENTOSSL_CMP_POLLREPCONTENT,
                          OSSL_CMP_POLLREP)
ASN1_ITEM_TEMPLATE_END(OSSL_CMP_REVREPCONTENTOSSL_CMP_POLLREPCONTENT)
...
ASN1_CHOICE(OSSL_CMP_PKIBODY) = {
    ...
    ASN1_EXP(OSSL_CMP_PKIBODY, value.pollRep,
                        OSSL_CMP_REVREPCONTENTOSSL_CMP_POLLREPCONTENT, 26),
} ASN1_CHOICE_END(OSSL_CMP_PKIBODY)
IMPLEMENT_ASN1_FUNCTIONS(OSSL_CMP_PKIBODY)

ASN1_SEQUENCE(OSSL_CMP_HDR) = {
    ASN1_SIMPLE(OSSL_CMP_HDR, pvno, ASN1_INTEGER),
    ASN1_SIMPLE(OSSL_CMP_HDR, sender, GENERAL_NAME),
    ASN1_SIMPLE(OSSL_CMP_HDR, recipient, GENERAL_NAME),
    ASN1_EXP_OPT(OSSL_CMP_HDR, messageTime, ASN1_GENERALIZEDTIME, 0),
    ASN1_EXP_OPT(OSSL_CMP_HDR, protectionAlg, X509_ALGOR, 1),
    ASN1_EXP_OPT(OSSL_CMP_HDR, senderKID, ASN1_OCTET_STRING, 2),
    ASN1_EXP_OPT(OSSL_CMP_HDR, recipKID, ASN1_OCTET_STRING, 3),
    ASN1_EXP_OPT(OSSL_CMP_HDR, transactionID, ASN1_OCTET_STRING, 4),
    ASN1_EXP_OPT(OSSL_CMP_HDR, senderNonce, ASN1_OCTET_STRING, 5),
    ASN1_EXP_OPT(OSSL_CMP_HDR, recipNonce, ASN1_OCTET_STRING, 6),
    /*
     * OSSL_CMP_PKIFREETEXT is effectively a sequence of ASN1_UTF8STRING
     * so it is used directly
     */
    ASN1_EXP_SEQUENCE_OF_OPT(OSSL_CMP_HDR, freeText, ASN1_UTF8STRING, 7),
    ASN1_EXP_SEQUENCE_OF_OPT(OSSL_CMP_HDR, generalInfo,
                             OSSL_CMP_ITAV, 8)
} ASN1_SEQUENCE_END(OSSL_CMP_HDR)
IMPLEMENT_ASN1_FUNCTIONS(OSSL_CMP_HDR)

ASN1_SEQUENCE(CMP_PROTECTEDPART) = {
    ASN1_SIMPLE(OSSL_CMP_MSG, header, OSSL_CMP_HDR),
