...
{
	ERR_STATE *state = CRYPTO_THREAD_get_local_ex(
		CRYPTO_THREAD_LOCAL_ERR_KEY, CRYPTO_THREAD_NO_CONTEXT);
...
ERR_STATE *ossl_err_get_state_int(void)
{
	...
	if (state == NULL) {
		...
		if (!ossl_init_thread_start(NULL, NULL,
