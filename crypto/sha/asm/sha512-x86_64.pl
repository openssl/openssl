...
.Lsha512ext_block_loop:
	...
	vsha512msg2 %ymm6,%ymm3                # W[16..19] = ymm3 + W[9..12] + S1(W[14..17])
	vsha512rnds2 %xmm0,%ymm11,%ymm12
	vperm2i128 \$0x1,%ymm0,%ymm0,%ymm0
	vsha512rnds2 %xmm0,%ymm12,%ymm11
...
$code.=<<___;
	...
	vsha512msg2 %ymm3,%ymm4                # ymm4 += S1(W[14..17])
	vsha512rnds2 %xmm0,%ymm11,%ymm12
	vperm2i128 \$0x1,%ymm0,%ymm0,%ymm0
	vsha512rnds2 %xmm0,%ymm12,%ymm11
...
$code.=<<___;
	...
	vsha512msg2 %ymm4,%ymm5                # ymm5 += S1(W[18..21])
	vsha512rnds2 %xmm0,%ymm11,%ymm12
	vperm2i128 \$0x1,%ymm0,%ymm0,%ymm0
	vsha512rnds2 %xmm0,%ymm12,%ymm11
...
$code.=<<___;
	...
	vsha512msg2 %ymm5,%ymm6                # ymm6 += S1(W[22..25])
	vsha512rnds2 %xmm0,%ymm11,%ymm12
	vperm2i128 \$0x1,%ymm0,%ymm0,%ymm0
	vsha512rnds2 %xmm0,%ymm12,%ymm11
...
$code.=<<___;
	...
	vsha512msg2 %ymm3,%ymm4                # ymm4 += S1(W[62..65])
	vsha512rnds2 %xmm0,%ymm11,%ymm12
	vperm2i128 \$0x1,%ymm0,%ymm0,%ymm0
	vsha512rnds2 %xmm0,%ymm12,%ymm11
	...
	vsha512msg2 %ymm4,%ymm5                # ymm5 += S1(W[66..69])
	vsha512rnds2 %xmm0,%ymm11,%ymm12
	vperm2i128 \$0x1,%ymm0,%ymm0,%ymm0
	vsha512rnds2 %xmm0,%ymm12,%ymm11
	...
	vsha512msg2 %ymm5,%ymm6                # ymm6 += S1(W[70..73])
	vsha512rnds2 %xmm0,%ymm11,%ymm12
	vperm2i128 \$0x1,%ymm0,%ymm0,%ymm0
	vsha512rnds2 %xmm0,%ymm12,%ymm11
