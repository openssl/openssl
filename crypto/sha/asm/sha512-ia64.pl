...
.ident  \"IA-64 ISA artwork by Andy Polyakov <appro\@opentls.org>\"
.explicit
.text
...
.size	K256#,$SZ*$rounds
stringz	"SHA256 block transform for IA64, CRYPTOGAMS by <appro\@opentls.org>"
___
...
.size	K512#,$SZ*$rounds
stringz	"SHA512 block transform for IA64, CRYPTOGAMS by <appro\@opentls.org>"
___
