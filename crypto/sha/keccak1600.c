...
static const unsigned char rhotates[5][5] = { { 0, 1, 62, 28, 27 },
					      { 36, 44, 6, 55, 20 },
					      { 3, 10, 43, 25, 39 },
					      { 41, 45, 15, 21, 8 },
					      { 18, 2, 61, 56, 14 } };
...
void SHA3_sponge(const unsigned char *inp, size_t len, unsigned char *out,
		 size_t d, size_t r)
{
	uint64_t A[5][5];
...
int main(void)
{
	...
	static const unsigned char result[512] = {
		
	};
