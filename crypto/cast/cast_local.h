...
#define E_CAST(n, key, L, R, OP1, OP2, OP3)                                 \
	{                                                                   \
		...
		u = w >> C_0;                                               \
		t = (t OP2 *                                                \
		     (CAST_LONG *)((unsigned char *)CAST_S_table1 + v)) &   \
		    0xffffffffL;                                            \
		v = w >> C_1;                                               \
		u &= C_M;                                                   \
		v &= C_M;                                                   \
		t = (t OP3 * (CAST_LONG *)((unsigned char *)CAST_S_table2 + \
					   u) &                             \
		     0xffffffffL);                                          \
		t = (t OP1 * (CAST_LONG *)((unsigned char *)CAST_S_table3 + \
					   v) &                             \
		     0xffffffffL);                                          \
		L ^= (t & 0xffffffff);                                      \
	}
...
#define E_CAST(n, key, L, R, OP1, OP2, OP3)                             \
	{                                                               \
		...
		L ^= (((((a OP2 b) & 0xffffffffL) OP3 c) & 0xffffffffL) \
			      OP1 d) &                                  \
		     0xffffffffL;                                       \
	}
#endif
