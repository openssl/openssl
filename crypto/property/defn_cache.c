...
static void *property_defns_new(OSSL_CTX *ctx) {
    return lh_PROPERTY_DEFN_ELEM_new(&property_defn_hash, &property_defn_cmp);
}

static const OSSL_CTX_METHOD property_defns_method = {
    property_defns_new,
    property_defns_free,
};
...
OSSL_PROPERTY_LIST *ossl_prop_defn_get(OSSL_CTX *ctx, const char *prop)
{
    ...
    property_defns = ossl_ctx_get_data(ctx, OSSL_CTX_PROPERTY_DEFN_INDEX,
