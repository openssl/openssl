...
static void *ossl_ctx_global_properties_new(OSSL_CTX *ctx)
{
    return OPENSSL_zalloc(sizeof(OSSL_PROPERTY_LIST **));
}


static const OSSL_CTX_METHOD ossl_ctx_global_properties_method = {
    ossl_ctx_global_properties_new,
    ossl_ctx_global_properties_free,
};

OSSL_PROPERTY_LIST **ossl_ctx_global_properties(OSSL_CTX *libctx)
{
    return ossl_ctx_get_data(libctx, OSSL_CTX_GLOBAL_PROPERTIES,
...
/*
 * The OSSL_CTX param here allows access to underlying property data needed
 * for computation
 */
