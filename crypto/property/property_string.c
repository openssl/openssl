...
static void *property_string_data_new(OSSL_CTX *ctx) {
...
static const OSSL_CTX_METHOD property_string_data_method = {
                                     ...
                                     int create)
{
    PROPERTY_STRING_DATA *propdata
        = ossl_ctx_get_data(ctx, OSSL_CTX_PROPERTY_STRING_INDEX,
