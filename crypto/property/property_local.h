...
OSSL_PROPERTY_IDX ossl_property_name(OSSL_CTX *ctx, const char *s,
                                     int create);
OSSL_PROPERTY_IDX ossl_property_value(OSSL_CTX *ctx, const char *s,
                                      int create);
...
OSSL_PROPERTY_LIST *ossl_prop_defn_get(OSSL_CTX *ctx, const char *prop);
int ossl_prop_defn_set(OSSL_CTX *ctx, const char *prop,
