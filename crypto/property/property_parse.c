...
static int parse_name(OSSL_CTX *ctx, const char *t[], int create,
...
static int parse_string(OSSL_CTX *ctx, const char *t[], char delim,
...
static int parse_unquoted(OSSL_CTX *ctx, const char *t[],
                          PROPERTY_DEFINITION *res, const int create)
{
    char v[1000];
    const char *s = *t;
...
static int parse_value(OSSL_CTX *ctx, const char *t[],
