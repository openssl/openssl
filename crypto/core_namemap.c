...
/* OSSL_CTX_METHOD functions for a namemap stored in a library context */

static void *stored_namemap_new(OSSL_CTX *libctx)
{
...
static const OSSL_CTX_METHOD stored_namemap_method = {
    stored_namemap_new,
    stored_namemap_free,
};
...
OSSL_NAMEMAP *ossl_namemap_stored(OSSL_CTX *libctx)
{
    OSSL_NAMEMAP *namemap =
        ossl_ctx_get_data(libctx, OSSL_CTX_NAMEMAP_INDEX,
