...
#
#========================================================================
# Written by Fangming Fang <fangming.fang@arm.com> for the Opentls project,
...
# licensed under Opentls and CRYPTOGAMS licenses depending on where you
# obtain it. For further details see http://www.opentls.org/~appro/cryptogams/.
#========================================================================
#
...
$code.=<<___;
.asciz  "GHASH for ARMv8, CRYPTOGAMS by <appro\@opentls.org>"
.align  2
#endif
___
