...
ASN1_ITEM_TEMPLATE(COMPONENT_IDENTIFIER_V2) =
    ASN1_EX_TEMPLATE_TYPE(ASN1_TFLG_SEQUENCE_OF, 0, Traits, PCV2_TRAIT)
ASN1_ITEM_TEMPLATE_END(COMPONENT_IDENTIFIER_V2)

ASN1_ITEM_TEMPLATE(PLATFORM_COMPONENTS) =
    ASN1_EX_TEMPLATE_TYPE(ASN1_TFLG_SEQUENCE_OF, 0, PlatformComponents, COMPONENT_IDENTIFIER_V2)
ASN1_ITEM_TEMPLATE_END(PLATFORM_COMPONENTS)

IMPLEMENT_ASN1_FUNCTIONS(COMPONENT_IDENTIFIER_V2)
IMPLEMENT_ASN1_FUNCTIONS(PLATFORM_COMPONENTS)

ASN1_SEQUENCE(PLATFORM_CONFIG_V3) = {
    ASN1_IMP_SEQUENCE_OF_OPT(PLATFORM_CONFIG_V3, platformComponents, COMPONENT_IDENTIFIER_V2, 0),
    ASN1_IMP_SEQUENCE_OF_OPT(PLATFORM_CONFIG_V3, platformProperties, PLATFORM_PROPERTY, 1),
} ASN1_SEQUENCE_END(PLATFORM_CONFIG_V3)
