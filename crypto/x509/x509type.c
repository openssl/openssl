...
///// OQS_TEMPLATE_FRAGMENT_LIST_SIG_SWITCH_CASES_START
    ...
    case EVP_PKEY_RSA3072_SPHINCSSHA2128FSIMPLE:
    case EVP_PKEY_SPHINCSSHA2128SSIMPLE:
    case EVP_PKEY_P256_SPHINCSSHA2128SSIMPLE:
    case EVP_PKEY_RSA3072_SPHINCSSHA2128SSIMPLE:
    case EVP_PKEY_SPHINCSSHA2192FSIMPLE:
    case EVP_PKEY_P384_SPHINCSSHA2192FSIMPLE:
    case EVP_PKEY_SPHINCSSHAKE128FSIMPLE:
    case EVP_PKEY_P256_SPHINCSSHAKE128FSIMPLE:
    case EVP_PKEY_RSA3072_SPHINCSSHAKE128FSIMPLE:
