...
void BN_consttime_swap(BN_ULONG condition, BIGNUM *a, BIGNUM *b, int nwords)
{
    ...
    bn_set_negative_internal(a, bn_is_negative_internal(a) ^ t);
    bn_set_negative_internal(b, bn_is_negative_internal(b) ^ t);
...
void BN_with_flags(BIGNUM *dest, const BIGNUM *b, int flags)
{
    ...
    dest->top = b->top;
    dest->dmax = b->dmax;
    bn_set_negative_internal(dest, bn_is_negative_internal(b));
