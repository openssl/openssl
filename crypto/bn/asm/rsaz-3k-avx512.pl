...
.type   ossl_rsaz_amm52x30_x1_ifma256,\@function,5,endbranch
.align 32
...
.cfi_sp_offset  %xmm6, `0*16`
    vmovdqa64   %xmm7, `1*16`(%rsp)
.cfi_sp_offset  %xmm7, `1*16`
    vmovdqa64   %xmm8, `2*16`(%rsp)
.cfi_sp_offset  %xmm8, `2*16`
    vmovdqa64   %xmm9, `3*16`(%rsp)
.cfi_sp_offset  %xmm9, `3*16`
    vmovdqa64   %xmm10,`4*16`(%rsp)
.cfi_sp_offset  %xmm10,`4*16`
    vmovdqa64   %xmm11,`5*16`(%rsp)
.cfi_sp_offset  %xmm11,`5*16`
    vmovdqa64   %xmm12,`6*16`(%rsp)
.cfi_sp_offset  %xmm12,`6*16`
    vmovdqa64   %xmm13,`7*16`(%rsp)
.cfi_sp_offset  %xmm13,`7*16`
    vmovdqa64   %xmm14,`8*16`(%rsp)
.cfi_sp_offset  %xmm14,`8*16`
    vmovdqa64   %xmm15,`9*16`(%rsp)
.cfi_sp_offset  %xmm15,`9*16`
___
$code.=<<___;
.cfi_endprolog
...
.type   ossl_rsaz_amm52x30_x2_ifma256,\@function,5,endbranch
.align 32
...
.type   ossl_extract_multiplier_2x30_win5,\@abi-omnipotent,,endbranch
