...
# TODO: Find out the versions of NASM and Clang that supports VEX-encoded AVX-IFMA instructions
...
$code.=<<___;
    ...
    {vex} vpmadd52luq `$_data_offset+64*0`($a), $Bi, $_R0
    {vex} vpmadd52luq `$_data_offset+64*0+32`($a), $Bi, $_R0h
    ...
    {vex} vpmadd52luq `$_data_offset+64*0`($m), $Yi, $_R0
    {vex} vpmadd52luq `$_data_offset+64*0+32`($m), $Yi, $_R0h
    ...
    {vex} vpmadd52huq `$_data_offset+64*0`($a), $Bi, $_R0
    {vex} vpmadd52huq `$_data_offset+64*0+32`($a), $Bi, $_R0h
    ...
    {vex} vpmadd52huq `$_data_offset+64*0`($m), $Yi, $_R0
    {vex} vpmadd52huq `$_data_offset+64*0+32`($m), $Yi, $_R0h
