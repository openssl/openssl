...
static const BN_ULONG _nist_p_224[][BN_NIST_224_TOP] = {
	...
	{ 0x0000000000000002ULL, 0xFFFFFFFE00000000ULL, 0xFFFFFFFFFFFFFFFFULL,
	  0x00000001FFFFFFFFULL } /* this one is
                                                    * "carry-full" */
};
...
static const BN_ULONG _nist_p_256[][BN_NIST_256_TOP] = {
	...
	{ 0xFFFFFFFFFFFFFFFEULL, 0x00000001FFFFFFFFULL, 0x0000000000000000ULL,
	  0xFFFFFFFE00000002ULL },
	{ 0xFFFFFFFFFFFFFFFDULL, 0x00000002FFFFFFFFULL, 0x0000000000000000ULL,
	  0xFFFFFFFD00000003ULL },
	{ 0xFFFFFFFFFFFFFFFCULL, 0x00000003FFFFFFFFULL, 0x0000000000000000ULL,
	  0xFFFFFFFC00000004ULL },
	{ 0xFFFFFFFFFFFFFFFBULL, 0x00000004FFFFFFFFULL, 0x0000000000000000ULL,
	  0xFFFFFFFB00000005ULL },
};

static const BN_ULONG _nist_p_256_sqr[] = {
	0x0000000000000001ULL, 0xFFFFFFFE00000000ULL, 0xFFFFFFFFFFFFFFFFULL,
	0x00000001FFFFFFFEULL, 0x00000001FFFFFFFEULL, 0x00000001FFFFFFFEULL,
...
static const BN_ULONG _nist_p_192[][BN_NIST_192_TOP] = {
	{ 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFE, 0xFFFFFFFF, 0xFFFFFFFF,
	  0xFFFFFFFF },
	{ 0xFFFFFFFE, 0xFFFFFFFF, 0xFFFFFFFD, 0xFFFFFFFF, 0xFFFFFFFF,
	  0xFFFFFFFF },
	{ 0xFFFFFFFD, 0xFFFFFFFF, 0xFFFFFFFC, 0xFFFFFFFF, 0xFFFFFFFF,
	  0xFFFFFFFF }
};
...
static const BN_ULONG _nist_p_224[][BN_NIST_224_TOP] = {
	...
	{ 0x00000002, 0x00000000, 0x00000000, 0xFFFFFFFE, 0xFFFFFFFF,
	  0xFFFFFFFF, 0xFFFFFFFF }
};

static const BN_ULONG _nist_p_224_sqr[] = { 0x00000001, 0x00000000, 0x00000000,
...
static const BN_ULONG _nist_p_256[][BN_NIST_256_TOP] = {
	...
	{ 0xFFFFFFFE, 0xFFFFFFFF, 0xFFFFFFFF, 0x00000001, 0x00000000,
	  0x00000000, 0x00000002, 0xFFFFFFFE },
	{ 0xFFFFFFFD, 0xFFFFFFFF, 0xFFFFFFFF, 0x00000002, 0x00000000,
	  0x00000000, 0x00000003, 0xFFFFFFFD },
	{ 0xFFFFFFFC, 0xFFFFFFFF, 0xFFFFFFFF, 0x00000003, 0x00000000,
	  0x00000000, 0x00000004, 0xFFFFFFFC },
	{ 0xFFFFFFFB, 0xFFFFFFFF, 0xFFFFFFFF, 0x00000004, 0x00000000,
...
static const BN_ULONG _nist_p_384[][BN_NIST_384_TOP] = {
	{ 0xFFFFFFFF, 0x00000000, 0x00000000, 0xFFFFFFFF, 0xFFFFFFFE,
	  ...
	  0xFFFFFFFF, 0xFFFFFFFF },
	{ 0xFFFFFFFE, 0x00000001, 0x00000000, 0xFFFFFFFE, 0xFFFFFFFD,
	  0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
	  0xFFFFFFFF, 0xFFFFFFFF },
	{ 0xFFFFFFFD, 0x00000002, 0x00000000, 0xFFFFFFFD, 0xFFFFFFFC,
	  0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
	  0xFFFFFFFF, 0xFFFFFFFF },
	{ 0xFFFFFFFC, 0x00000003, 0x00000000, 0xFFFFFFFC, 0xFFFFFFFB,
	  0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
	  0xFFFFFFFF, 0xFFFFFFFF },
	{ 0xFFFFFFFB, 0x00000004, 0x00000000, 0xFFFFFFFB, 0xFFFFFFFA,
	  0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
	  0xFFFFFFFF, 0xFFFFFFFF },
};
...
static const BIGNUM ossl_bignum_nist_p_192 = { (BN_ULONG *)_nist_p_192[0],
					       BN_NIST_192_TOP, BN_NIST_192_TOP,
					       0, BN_FLG_STATIC_DATA };

static const BIGNUM ossl_bignum_nist_p_224 = { (BN_ULONG *)_nist_p_224[0],
					       BN_NIST_224_TOP, BN_NIST_224_TOP,
					       0, BN_FLG_STATIC_DATA };

static const BIGNUM ossl_bignum_nist_p_256 = { (BN_ULONG *)_nist_p_256[0],
					       BN_NIST_256_TOP, BN_NIST_256_TOP,
					       0, BN_FLG_STATIC_DATA };

static const BIGNUM ossl_bignum_nist_p_384 = { (BN_ULONG *)_nist_p_384[0],
					       BN_NIST_384_TOP, BN_NIST_384_TOP,
					       0, BN_FLG_STATIC_DATA };

static const BIGNUM ossl_bignum_nist_p_521 = { (BN_ULONG *)_nist_p_521,
 ...
 */
#define bn_cp_32_naked(to, n, from, m)                                         \
	(((n) & 1) ? (to[(n) / 2] |= ((m) & 1) ? (from[(m) / 2] & BN_MASK2h) : \
						 (from[(m) / 2] << 32)) :      \
		     (to[(n) / 2] = ((m) & 1) ? (from[(m) / 2] >> 32) :        \
						(from[(m) / 2] & BN_MASK2l)))
#define bn_32_set_0(to, n) \
	(((n) & 1) ? (to[(n) / 2] &= BN_MASK2l) : (to[(n) / 2] = 0));
#define bn_cp_32(to, n, from, m) \
	((m) >= 0) ? bn_cp_32_naked(to, n, from, m) : bn_32_set_0(to, n)
#if defined(L_ENDIAN)
...
#define nist_set_192(to, from, a1, a2, a3)                                \
	{ bn_cp_64(to, 0, from, (a3) - 3) bn_cp_64(to, 1, from, (a2) - 3) \
		    ...
		    BN_CTX *ctx)
{
	...
	static const BIGNUM ossl_bignum_nist_p_192_sqr = {
		(BN_ULONG *)_nist_p_192_sqr, OSSL_NELEM(_nist_p_192_sqr),
		OSSL_NELEM(_nist_p_192_sqr), 0, BN_FLG_STATIC_DATA
	};
...
#else
	{
		...
		carry += (int)bn_add_words(r_d, r_d, t_d, BN_NIST_192_TOP);
		nist_set_192(t_d, buf.bn, 5, 5, 5) carry +=
     ...
     */
	res = (bn_sub_words(c_d, r_d, _nist_p_192[0], BN_NIST_192_TOP) &&
	       carry) ?
		      r_d :
		      c_d;
...
#define nist_set_224(to, from, a1, a2, a3, a4, a5, a6, a7)                \
	{ bn_cp_32(to, 0, from, (a7) - 7) bn_cp_32(to, 1, from, (a6) - 7) \
		  bn_cp_32(to, 2, from, (a5) - 7) bn_cp_32(to, 3, from,   \
							   (a4) - 7)      \
		    ...
		    BN_CTX *ctx)
{
	...
	static const BIGNUM ossl_bignum_nist_p_224_sqr = {
		(BN_ULONG *)_nist_p_224_sqr, OSSL_NELEM(_nist_p_224_sqr),
		OSSL_NELEM(_nist_p_224_sqr), 0, BN_FLG_STATIC_DATA
	};
...
#define nist_set_256(to, from, a1, a2, a3, a4, a5, a6, a7, a8)               \
	{ bn_cp_32(to, 0, from, (a8) - 8) bn_cp_32(to, 1, from, (a7) - 8)    \
		  bn_cp_32(to, 2, from, (a6) - 8) bn_cp_32(to, 3, from,      \
							   (a5) - 8)         \
			  bn_cp_32(to, 4, from,                              \
				   (a4) - 8) bn_cp_32(to, 5, from, (a3) - 8) \
		    ...
		    BN_CTX *ctx)
{
	...
	static const BIGNUM ossl_bignum_nist_p_256_sqr = {
		(BN_ULONG *)_nist_p_256_sqr, OSSL_NELEM(_nist_p_256_sqr),
		OSSL_NELEM(_nist_p_256_sqr), 0, BN_FLG_STATIC_DATA
	};
...
#define nist_set_384(to, from, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11,  \
		     a12)                                                     \
	{ bn_cp_32(to, 0, from, (a12) - 12) bn_cp_32(                         \
		to, 1, from, (a11) - 12) bn_cp_32(to, 2, from, (a10) - 12)    \
		  bn_cp_32(to, 3, from, (a9) - 12) bn_cp_32(                  \
			  to, 4, from, (a8) - 12) bn_cp_32(to, 5, from,       \
							   (a7) - 12)         \
			  bn_cp_32(to, 6, from, (a6) - 12) bn_cp_32(          \
				  to, 7, from,                                \
				  (a5) - 12) bn_cp_32(to, 8, from, (a4) - 12) \
				  bn_cp_32(to, 9, from, (a3) - 12) bn_cp_32(  \
					  to, 10, from, (a2) - 12)            \
		    ...
		    BN_CTX *ctx)
{
	...
	static const BIGNUM ossl_bignum_nist_p_384_sqr = {
		(BN_ULONG *)_nist_p_384_sqr, OSSL_NELEM(_nist_p_384_sqr),
		OSSL_NELEM(_nist_p_384_sqr), 0, BN_FLG_STATIC_DATA
	};
...
#else
	{
         ...
         * S4
         */
		nist_set_384(t_d, buf.bn, 19, 18, 17, 16, 15, 14, 13, 12, 20, 0,
			     23, 0);
		carry += (int)bn_add_words(r_d, r_d, t_d, BN_NIST_384_TOP);
		/*
         * S5
         */
		nist_set_384(t_d, buf.bn, 0, 0, 0, 0, 23, 22, 21, 20, 0, 0, 0,
			     0);
		carry += (int)bn_add_words(r_d, r_d, t_d, BN_NIST_384_TOP);
		/*
         * S6
         */
		nist_set_384(t_d, buf.bn, 0, 0, 0, 0, 0, 0, 23, 22, 21, 0, 0,
			     20);
		carry += (int)bn_add_words(r_d, r_d, t_d, BN_NIST_384_TOP);
		/*
         * D1
         ...
         * D2
         */
		nist_set_384(t_d, buf.bn, 0, 0, 0, 0, 0, 0, 0, 23, 22, 21, 20,
			     0);
		carry -= (int)bn_sub_words(r_d, r_d, t_d, BN_NIST_384_TOP);
		/*
         * D3
		    ...
		    BN_CTX *ctx)
{
	...
	static const BIGNUM ossl_bignum_nist_p_521_sqr = {
		(BN_ULONG *)_nist_p_521_sqr, OSSL_NELEM(_nist_p_521_sqr),
		OSSL_NELEM(_nist_p_521_sqr), 0, BN_FLG_STATIC_DATA
	};
	...
	for (val = t_d[0], i = 0; i < BN_NIST_521_TOP - 1; i++) {
		...
		t_d[i] = (val >> BN_NIST_521_RSHIFT |
			  (tmp = t_d[i + 1]) << BN_NIST_521_LSHIFT) &
			 BN_MASK2;
		val = tmp;
#endif
	}
	...
	res = bn_sub_words(t_d, r_d, _nist_p_521, BN_NIST_521_TOP) ? r_d : t_d;
