		      ...
		      int utype, char *free_cont, const ASN1_ITEM *it)
{
	...
	if ((it->size & INTxx_FLAG_SIGNED) == INTxx_FLAG_SIGNED && !neg &&
	    utmp > INT64_MAX) {
...
static ASN1_PRIMITIVE_FUNCS uint32_pf = { NULL,		0,
					  uint32_new,	uint32_free,
					  uint32_clear, uint32_c2i,
					  uint32_i2c,	uint32_print };

static ASN1_PRIMITIVE_FUNCS uint64_pf = { NULL,		0,
					  uint64_new,	uint64_free,
					  uint64_clear, uint64_c2i,
					  uint64_i2c,	uint64_print };

ASN1_ITEM_start(INT32) ASN1_ITYPE_PRIMITIVE, V_ASN1_INTEGER, NULL, 0,
	&uint32_pf, INTxx_FLAG_SIGNED,
	...
	V_ASN1_INTEGER, NULL, 0,
	&uint32_pf, INTxx_FLAG_ZERO_DEFAULT | INTxx_FLAG_SIGNED,
	...
	V_ASN1_INTEGER, NULL, 0,
	&uint64_pf, INTxx_FLAG_ZERO_DEFAULT | INTxx_FLAG_SIGNED,
