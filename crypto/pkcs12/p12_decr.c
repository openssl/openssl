...
{
	return PKCS12_pbe_crypt_ex(algor, pass, passlen, in, inlen, data,
				   datalen, en_de, NULL, NULL);
}
...
ASN1_OCTET_STRING *
PKCS12_item_i2d_encrypt_ex(X509_ALGOR *algor, const ASN1_ITEM *it,
...
ASN1_OCTET_STRING *PKCS12_item_i2d_encrypt(X509_ALGOR *algor,
					   ...
					   void *obj, int zbuf)
{
	return PKCS12_item_i2d_encrypt_ex(algor, it, pass, passlen, obj, zbuf,
					  NULL, NULL);
}
