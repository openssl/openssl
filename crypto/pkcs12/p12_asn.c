...
ASN1_ADB_TEMPLATE(bag_default) = ASN1_EXP(PKCS12_BAGS, value.other, ASN1_ANY,
					  0);
...
ASN1_ADB_TEMPLATE(safebag_default) = ASN1_EXP(PKCS12_SAFEBAG, value.other,
					      ASN1_ANY, 0);
...
ASN1_ADB(PKCS12_SAFEBAG) = {
	...
	ADB_ENTRY(NID_safeContentsBag,
		  ASN1_EXP_SEQUENCE_OF(PKCS12_SAFEBAG, value.safes,
				       PKCS12_SAFEBAG, 0)),
