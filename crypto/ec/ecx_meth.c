                      ...
                      OPENSSL_CTX *libctx, const char *propq)
{
    ...
    key = ecx_key_new(KEYNID2TYPE(id), 1, libctx, propq);
    if (key == NULL) {
                                  ...
                                  size_t tbslen)
{
    ...
    if (ED448_sign(sig, tbs, tbslen, edkey->pubkey, edkey->privkey,
                   NULL, 0, edkey->libctx, edkey->propq) == 0)
        return 0;
    *siglen = ED448_SIGSIZE;
    return 1;
}
