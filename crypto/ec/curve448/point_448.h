...
* out (out): a/2.
*/
void ossl_curve448_scalar_halve(curve448_scalar_t out,
 ...
 */
__owur c448_bool_t ossl_curve448_point_eq(const curve448_point_t a,
					  const curve448_point_t b);
 ...
 * a (in): A point.
 */
void ossl_curve448_point_double(curve448_point_t two_a,
 ...
 * small subgroup.
 */
__owur c448_error_t ossl_x448_int(uint8_t out[X448_PUBLIC_BYTES],
