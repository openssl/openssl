...
static const ERR_STRING_DATA EC_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_KEY_PUBLIC_RANGE_CHECK, 0),
...
static const ERR_STRING_DATA EC_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_EC, 0, EC_R_INVALID_STRENGTH), "invalid strength"},
    ...
    {ERR_PACK(ERR_LIB_EC, 0, EC_R_NOT_APPROVED), "not approved"},
