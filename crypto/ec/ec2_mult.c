                                             ...
                                             BN_CTX *ctx)
{
    ...
    if (bn_wexpand(x1, bn_get_top(group->field)) == NULL
        || bn_wexpand(z1, bn_get_top(group->field)) == NULL
        || bn_wexpand(x2, bn_get_top(group->field)) == NULL
        || bn_wexpand(z2, bn_get_top(group->field)) == NULL)
        goto err;
