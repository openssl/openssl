...
/*
 * Copy dst -> src and align it to the left using lshift.
...
{
    const OSSL_FN_ULONG *s = src->d, sl = src->dsize;
    OSSL_FN_ULONG *d = dst->d, dl = dst->dsize;
...
/*
 * Copy dst -> src and align it to the right using rshift.
