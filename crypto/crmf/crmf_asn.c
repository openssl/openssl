...
ASN1_SEQUENCE(OSSL_CRMF_PRIVATEKEYINFO) = {
    ...
    ASN1_SIMPLE(OSSL_CRMF_PRIVATEKEYINFO, AlgorithmIdentifier, X509_ALGOR),
...
ASN1_CHOICE(OSSL_CRMF_ENCKEYWITHID_IDENTIFIER) = {
    ASN1_IMP(OSSL_CRMF_ENCKEYWITHID_IDENTIFIER, value.string, ASN1_UTF8STRING, 0),
    ASN1_IMP(OSSL_CRMF_ENCKEYWITHID_IDENTIFIER, value.generalName, GENERAL_NAME, 1)
...
ASN1_SEQUENCE(OSSL_CRMF_ENCKEYWITHID) = {
    ...
    ASN1_IMP_OPT(OSSL_CRMF_ENCKEYWITHID, identifier,
                 OSSL_CRMF_ENCKEYWITHID_IDENTIFIER,0)
...
ASN1_CHOICE(OSSL_CRMF_ENCRYPTEDKEY) = {
     ...
     */
    ASN1_IMP(OSSL_CRMF_ENCRYPTEDKEY, value.envelopedData, ASN1_NULL, 1)
...
ASN1_SEQUENCE(OSSL_CRMF_PKIPUBLICATIONINFO) = {
    ...
    ASN1_SEQUENCE_OF_OPT(OSSL_CRMF_PKIPUBLICATIONINFO, pubinfos, GENERAL_NAME)
...
ASN1_CHOICE(OSSL_CRMF_POPO) = {
    ...
    ASN1_IMP(OSSL_CRMF_POPO, value.keyAgreement, OSSL_CRMF_POPOPRIVKEY, 3)
