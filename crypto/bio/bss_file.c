...
static const BIO_METHOD methods_filep = {
	BIO_TYPE_FILE, "FILE pointer", bwrite_conv, file_write, bread_conv,
	file_read,     file_puts,      file_gets,   file_ctrl,	file_new,
	file_free,     NULL, /* file_callback_ctrl */
};
...
static int file_read(BIO *b, char *out, int outl)
{
	...
	if (b->init && (out != NULL)) {
		...
		if (ret == 0 && (b->flags & BIO_FLAGS_UPLINK_INTERNAL ?
