 ...
 */
int BIO_vprintf_msvc(BIO *bio, const char *format, va_list args)
{
    va_list cp_args;
    int ret;
...
int BIO_snprintf_msvc(char *buf, size_t n, const char *format, ...)
{
    va_list args;
    int ret;
...
int BIO_vsnprintf_msvc(char *buf, size_t n, const char *format, va_list args)
{
    return _vsnprintf_s(buf, n, _TRUNCATE, format, args);
}
