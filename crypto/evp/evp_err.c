...
static const ERR_STRING_DATA EVP_str_reasons[] = {
	...
	{ ERR_PACK(ERR_LIB_EVP, 0, EVP_R_INACCESSIBLE_KEY),
	  "inaccessible key" },
	...
	{ ERR_PACK(ERR_LIB_EVP, 0, EVP_R_INVALID_IV_LENGTH),
	  "invalid iv length" },
	...
	{ ERR_PACK(ERR_LIB_EVP, 0, EVP_R_KEY_SETUP_FAILED),
	  "key setup failed" },
	...
	{ ERR_PACK(ERR_LIB_EVP, 0, EVP_R_NO_OPERATION_SET),
	  "no operation set" },
	{ ERR_PACK(ERR_LIB_EVP, 0, EVP_R_NULL_MAC_PKEY_CTX),
	  "null mac pkey ctx" },
	...
	{ ERR_PACK(ERR_LIB_EVP, 0, EVP_R_TOO_MANY_RECORDS),
	  "too many records" },
	...
	{ ERR_PACK(ERR_LIB_EVP, 0, EVP_R_UNKNOWN_KEY_TYPE),
	  "unknown key type" },
	{ ERR_PACK(ERR_LIB_EVP, 0, EVP_R_UNKNOWN_MAX_SIZE),
	  "unknown max size" },
