...
static const ERR_STRING_DATA EVP_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_EVP, 0, EVP_R_CANNOT_RESEED_WITHOUT_PARENT_SET),
    "cannot reseed without parent set"},
    ...
    {ERR_PACK(ERR_LIB_EVP, 0, EVP_R_CTX_IS_NOT_REFERENCE_COUNTED),
    "ctx is not reference counted"},
    ...
    {ERR_PACK(ERR_LIB_EVP, 0, EVP_R_NULL_CONTEXT), "null context"},
    ...
    {ERR_PACK(ERR_LIB_EVP, 0, EVP_R_REFERENCE_COUNT_FAILURE),
    "reference count failure"},
    {ERR_PACK(ERR_LIB_EVP, 0, EVP_R_TOO_MANY_RECORDS), "too many records"},
    {ERR_PACK(ERR_LIB_EVP, 0, EVP_R_TOO_MUCH_ENTROPY_REQUESTED),
    "too much entropy requested"},
    {ERR_PACK(ERR_LIB_EVP, 0, EVP_R_UNABLE_TO_GET_PARAMS),
    "unable to get params"},
