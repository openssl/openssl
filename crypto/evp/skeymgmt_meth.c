			    ...
			    const OSSL_PARAM params[])
{
	...
	return (skeymgmt->generate != NULL) ?
		       skeymgmt->generate(provctx, params) :
		       NULL;
}
...
{
	return evp_generic_fetch_from_prov(prov, OSSL_OP_SKEYMGMT, name,
					   properties, skeymgmt_from_algorithm,
			      ...
			      void *data)
{
	...
	if (skeymgmt->prov != NULL)
		return evp_names_do_all(skeymgmt->prov, skeymgmt->name_id, fn,
					data);
