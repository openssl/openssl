...
#define IMPLEMENT_LEGACY_EVP_MD_METH_SHA3(nm, fn, tag)                         \
	...
	static int nm##_update(EVP_MD_CTX *ctx, const void *data,              \
			       size_t count)                                   \
	{                                                                      \
...
static const EVP_MD sha1_md = {
	...
	EVP_ORIG_GLOBAL,
	LEGACY_EVP_MD_METH_TABLE(sha1_init, sha1_update, sha1_final,
				 sha1_int_ctrl, SHA_CBLOCK),
};
...
#define EVP_MD_SHAKE(bitlen)                                                 \
	...
	{                                                                    \
		static const EVP_MD shake##bitlen##_md = {                   \
			...
			EVP_ORIG_GLOBAL,                                     \
			LEGACY_EVP_MD_METH_TABLE(                            \
				shake_init, sha3_int_update, sha3_int_final, \
				shake_ctrl,                                  \
				(KECCAK1600_WIDTH - bitlen * 2) / 8),        \
		};                                                           \
