...
#  ifdef OPENSSL_SYS_WIN_CORE
TRACELOGGING_DEFINE_PROVIDER(g_hProvider, "OpenSSL",
                              /*
                              * Product GUID generated by MS Tool (randomly), 
                              * Needed to send trace logs
...
#  ifdef OPENSSL_SYS_WIN_CORE
    ...
    if (SUCCEEDED(TraceLoggingRegister(g_hProvider))) {
