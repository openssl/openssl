...
static const ERR_STRING_DATA HTTP_str_reasons[] = {
	...
	{ ERR_PACK(ERR_LIB_HTTP, 0, HTTP_R_CONNECT_FAILURE),
	  "connect failure" },
	...
	{ ERR_PACK(ERR_LIB_HTTP, 0, HTTP_R_ERROR_PARSING_URL),
	  "error parsing url" },
	{ ERR_PACK(ERR_LIB_HTTP, 0, HTTP_R_ERROR_RECEIVING),
	  "error receiving" },
	...
	{ ERR_PACK(ERR_LIB_HTTP, 0, HTTP_R_INVALID_PORT_NUMBER),
	  "invalid port number" },
	{ ERR_PACK(ERR_LIB_HTTP, 0, HTTP_R_INVALID_URL_PATH),
	  "invalid url path" },
	...
	{ ERR_PACK(ERR_LIB_HTTP, 0, HTTP_R_TLS_NOT_ENABLED),
	  "tls not enabled" },
