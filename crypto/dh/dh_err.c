...
static const ERR_STRING_DATA DH_str_reasons[] = {
	{ ERR_PACK(ERR_LIB_DH, 0, DH_R_BAD_FFC_PARAMETERS),
	  "bad ffc parameters" },
	...
	{ ERR_PACK(ERR_LIB_DH, 0, DH_R_CHECK_P_NOT_PRIME),
	  "check p not prime" },
	{ ERR_PACK(ERR_LIB_DH, 0, DH_R_CHECK_P_NOT_SAFE_PRIME),
	  "check p not safe prime" },
	{ ERR_PACK(ERR_LIB_DH, 0, DH_R_CHECK_Q_NOT_PRIME),
	  "check q not prime" },
	...
	{ ERR_PACK(ERR_LIB_DH, 0, DH_R_MODULUS_TOO_LARGE),
	  "modulus too large" },
	{ ERR_PACK(ERR_LIB_DH, 0, DH_R_MODULUS_TOO_SMALL),
	  "modulus too small" },
