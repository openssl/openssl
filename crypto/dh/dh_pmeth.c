			       ...
			       BN_GENCB *pcb)
{
	...
	if (dctx->md != NULL)
		ossl_ffc_set_digest(&ret->params, EVP_MD_get0_name(dctx->md),
				    NULL);
	...
	if (dctx->paramgen_type == DH_PARAMGEN_TYPE_FIPS_186_2)
		rv = ossl_ffc_params_FIPS186_2_generate(libctx, &ret->params,
							FFC_PARAM_TYPE_DH,
							prime_len, subprime_len,
							&res, pcb);
	else
#endif
		/* For FIPS we always use the DH_PARAMGEN_TYPE_FIPS_186_4 generator */
		if (dctx->paramgen_type >= DH_PARAMGEN_TYPE_FIPS_186_2)
			rv = ossl_ffc_params_FIPS186_4_generate(
				libctx, &ret->params, FFC_PARAM_TYPE_DH,
...
static const EVP_PKEY_METHOD dh_pkey_meth = { EVP_PKEY_DH,
					      0,
					      pkey_dh_init,
					      pkey_dh_copy,
					      pkey_dh_cleanup,
...
static const EVP_PKEY_METHOD dhx_pkey_meth = { EVP_PKEY_DHX,
					       0,
					       pkey_dh_init,
					       pkey_dh_copy,
					       pkey_dh_cleanup,
