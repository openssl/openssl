...
static const ERR_STRING_DATA PKCS7_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_CTRL, 0),
     "PKCS7_ctrl"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_DATADECODE, 0),
     "PKCS7_dataDecode"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_DATAFINAL, 0),
     "PKCS7_dataFinal"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_DATAINIT, 0),
     "PKCS7_dataInit"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_DATAVERIFY, 0),
     "PKCS7_dataVerify"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_DECRYPT, 0),
     "PKCS7_decrypt"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_DECRYPT_RINFO, 0),
     "pkcs7_decrypt_rinfo"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_ENCODE_RINFO, 0),
     "pkcs7_encode_rinfo"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_ENCRYPT, 0),
     "PKCS7_encrypt"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_FINAL, 0),
     "PKCS7_final"},
    ...
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_SET_CIPHER, 0),
     "PKCS7_set_cipher"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_SET_CONTENT, 0),
     "PKCS7_set_content"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_SET_DIGEST, 0),
     "PKCS7_set_digest"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_SET_TYPE, 0),
     "PKCS7_set_type"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_SIGN, 0),
     "PKCS7_sign"},
    ...
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_VERIFY, 0),
     "PKCS7_verify"},
    {0, NULL}
};
...
static const ERR_STRING_DATA PKCS7_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_PKCS7, 0, PKCS7_R_CTRL_ERROR),
    "ctrl error"},
    {ERR_PACK(ERR_LIB_PKCS7, 0, PKCS7_R_DECRYPT_ERROR),
    "decrypt error"},
    {ERR_PACK(ERR_LIB_PKCS7, 0, PKCS7_R_DIGEST_FAILURE),
    "digest failure"},
    ...
    {ERR_PACK(ERR_LIB_PKCS7, 0, PKCS7_R_NO_CONTENT),
    "no content"},
    ...
    {ERR_PACK(ERR_LIB_PKCS7, 0, PKCS7_R_NO_SIGNERS),
    "no signers"},
    ...
    {ERR_PACK(ERR_LIB_PKCS7, 0, PKCS7_R_PKCS7_DATASIGN),
    "pkcs7 datasign"},
