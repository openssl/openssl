...
#define SLH_ADRS_SIZE_TYPECLEAR \
	SLH_ADRS_SIZE - (SLH_ADRS_OFF_TYPE + SLH_ADRS_SIZE_TYPE)
...
{
	memcpy(dst + SLH_ADRSC_OFF_KEYPAIR_ADDR,
	       src + SLH_ADRSC_OFF_KEYPAIR_ADDR, SLH_ADRSC_SIZE_KEYPAIR_ADDR);
}
