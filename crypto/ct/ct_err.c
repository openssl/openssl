...
static const ERR_STRING_DATA CT_str_functs[] = {
    {ERR_PACK(ERR_LIB_CT, CT_F_CTLOG_NEW, 0),
     "CTLOG_new"},
    ...
    {ERR_PACK(ERR_LIB_CT, CT_F_CTLOG_STORE_NEW, 0),
     "CTLOG_STORE_new"},
    {ERR_PACK(ERR_LIB_CT, CT_F_CT_BASE64_DECODE, 0),
     "ct_base64_decode"},
    ...
    {ERR_PACK(ERR_LIB_CT, CT_F_I2O_SCT, 0),
     "i2o_SCT"},
    {ERR_PACK(ERR_LIB_CT, CT_F_I2O_SCT_LIST, 0),
     "i2o_SCT_LIST"},
    {ERR_PACK(ERR_LIB_CT, CT_F_I2O_SCT_SIGNATURE, 0),
     "i2o_SCT_signature"},
    {ERR_PACK(ERR_LIB_CT, CT_F_O2I_SCT, 0),
     "o2i_SCT"},
    {ERR_PACK(ERR_LIB_CT, CT_F_O2I_SCT_LIST, 0),
     "o2i_SCT_LIST"},
    {ERR_PACK(ERR_LIB_CT, CT_F_O2I_SCT_SIGNATURE, 0),
     "o2i_SCT_signature"},
    {ERR_PACK(ERR_LIB_CT, CT_F_SCT_CTX_NEW, 0),
     "SCT_CTX_new"},
    {ERR_PACK(ERR_LIB_CT, CT_F_SCT_CTX_VERIFY, 0),
     "SCT_CTX_verify"},
    {ERR_PACK(ERR_LIB_CT, CT_F_SCT_NEW, 0),
     "SCT_new"},
    {ERR_PACK(ERR_LIB_CT, CT_F_SCT_NEW_FROM_BASE64, 0),
     "SCT_new_from_base64"},
    {ERR_PACK(ERR_LIB_CT, CT_F_SCT_SET0_LOG_ID, 0),
     "SCT_set0_log_id"},
    {ERR_PACK(ERR_LIB_CT, CT_F_SCT_SET1_EXTENSIONS, 0),
     "SCT_set1_extensions"},
    {ERR_PACK(ERR_LIB_CT, CT_F_SCT_SET1_LOG_ID, 0),
     "SCT_set1_log_id"},
    ...
    {ERR_PACK(ERR_LIB_CT, CT_F_SCT_SET_VERSION, 0),
     "SCT_set_version"},
    {0, NULL}
};
...
static const ERR_STRING_DATA CT_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_CT, 0, CT_R_LOG_CONF_INVALID),
    "log conf invalid"},
