...
#define LAZY(i)                                                            \
	...
	{                                                                  \
		_asm push i _asm push OFFSET OPENSSL_UplinkTable _asm call \
			OPENSSL_Uplink _asm add esp,                       \
...
#define LAZY(i)                                                          \
	...
	{                                                                \
		__asm__("pushl $" #i "; "                                \
			...
			"jmp   *%2 "                                     \
			: /* no outputs */                               \
			: "i"(OPENSSL_UplinkTable), "i"(OPENSSL_Uplink), \
