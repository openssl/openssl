...
#define UP_fprintf                       \
	(*(int (*)(void *, const char *, \
		   ...))OPENSSL_UplinkTable[APPLINK_FPRINTF])
#define UP_fgets \
	(*(char *(*)(char *, int, void *))OPENSSL_UplinkTable[APPLINK_FGETS])
#define UP_fread                              \
	(*(size_t (*)(void *, size_t, size_t, \
		      void *))OPENSSL_UplinkTable[APPLINK_FREAD])
#define UP_fwrite                                   \
	(*(size_t (*)(const void *, size_t, size_t, \
		      void *))OPENSSL_UplinkTable[APPLINK_FWRITE])
#define UP_fsetmod \
	(*(int (*)(void *, char))OPENSSL_UplinkTable[APPLINK_FSETMOD])
#define UP_feof (*(int (*)(void *))OPENSSL_UplinkTable[APPLINK_FEOF])
#define UP_fclose (*(int (*)(void *))OPENSSL_UplinkTable[APPLINK_FCLOSE])

#define UP_fopen                   \
	(*(void *(*)(const char *, \
		     const char *))OPENSSL_UplinkTable[APPLINK_FOPEN])
#define UP_fseek \
	(*(int (*)(void *, long, int))OPENSSL_UplinkTable[APPLINK_FSEEK])
...
#define UP_open \
	(*(int (*)(const char *, int, ...))OPENSSL_UplinkTable[APPLINK_OPEN])
#define UP_read                          \
	(*(ossl_ssize_t (*)(int, void *, \
			    size_t))OPENSSL_UplinkTable[APPLINK_READ])
#define UP_write                               \
	(*(ossl_ssize_t (*)(int, const void *, \
