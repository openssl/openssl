 ...
 * individual OSSL_CTX. That doesn't work with the self test though because
 * it should be run once regardless of the number of OSSL_CTXs we have.
 */
...
static int verify_integrity(OSSL_CORE_BIO *bio, OSSL_FUNC_BIO_read_ex_fn read_ex_cb,
                            ...
                            OSSL_CTX *libctx, OSSL_SELF_TEST *ev,
