...
#define OSSL_FIPS_PARAM(structname, paramname, initvalue)                      \
	OSSL_PARAM_DEFN(OSSL_PROV_PARAM_##paramname, OSSL_PARAM_INTEGER, NULL, \
			0),
#include "fips_indicator_params.inc"
#undef OSSL_FIPS_PARAM
...
#define OSSL_FIPS_PARAM(structname, paramname, initvalue)            \
	...
	if (p != NULL &&                                             \
	    !OSSL_PARAM_set_int(p, fgbl->fips_##structname.enabled)) \
		return 0;
#include "fips_indicator_params.inc"
#undef OSSL_FIPS_PARAM
...
#define FIPS_DIGESTS_COMMON()                                              \
	{ PROV_NAMES_SHA1, FIPS_DEFAULT_PROPERTIES, ossl_sha1_functions }, \
		{ PROV_NAMES_SHA2_224, FIPS_DEFAULT_PROPERTIES,            \
		  ossl_sha224_functions },                                 \
		{ PROV_NAMES_SHA2_256, FIPS_DEFAULT_PROPERTIES,            \
		  ossl_sha256_functions },                                 \
		{ PROV_NAMES_SHA2_384, FIPS_DEFAULT_PROPERTIES,            \
		  ossl_sha384_functions },                                 \
		{ PROV_NAMES_SHA2_512, FIPS_DEFAULT_PROPERTIES,            \
		...
		{ PROV_NAMES_SHA3_224, FIPS_DEFAULT_PROPERTIES,            \
		  ossl_sha3_224_functions },                               \
		{ PROV_NAMES_SHA3_256, FIPS_DEFAULT_PROPERTIES,            \
		  ossl_sha3_256_functions },                               \
		{ PROV_NAMES_SHA3_384, FIPS_DEFAULT_PROPERTIES,            \
		  ossl_sha3_384_functions },                               \
		{ PROV_NAMES_SHA3_512, FIPS_DEFAULT_PROPERTIES,            \
		  ossl_sha3_512_functions },                               \
		{ PROV_NAMES_SHAKE_128, FIPS_DEFAULT_PROPERTIES,           \
		  ossl_shake_128_functions },                              \
	{                                                                  \
		PROV_NAMES_SHAKE_256, FIPS_DEFAULT_PROPERTIES,             \
			ossl_shake_256_functions                           \
	}

static const OSSL_ALGORITHM fips_digests[] = { FIPS_DIGESTS_COMMON(),
					       { NULL, NULL, NULL } };
...
static const OSSL_ALGORITHM_CAPABLE fips_ciphers[] = {
	...
	ALGC(PROV_NAMES_AES_128_CBC_HMAC_SHA1,
...
#define FIPS_KDFS_COMMON()                                                     \
	{ PROV_NAMES_HKDF, FIPS_DEFAULT_PROPERTIES, ossl_kdf_hkdf_functions }, \
		{ PROV_NAMES_HKDF_SHA256, FIPS_DEFAULT_PROPERTIES,             \
		  ossl_kdf_hkdf_sha256_functions },                            \
		{ PROV_NAMES_HKDF_SHA384, FIPS_DEFAULT_PROPERTIES,             \
		  ossl_kdf_hkdf_sha384_functions },                            \
		{ PROV_NAMES_HKDF_SHA512, FIPS_DEFAULT_PROPERTIES,             \
		  ossl_kdf_hkdf_sha512_functions },                            \
		{ PROV_NAMES_TLS1_3_KDF, FIPS_DEFAULT_PROPERTIES,              \
		  ossl_kdf_tls1_3_kdf_functions },                             \
		{ PROV_NAMES_SSKDF, FIPS_DEFAULT_PROPERTIES,                   \
		  ossl_kdf_sskdf_functions },                                  \
		{ PROV_NAMES_PBKDF2, FIPS_DEFAULT_PROPERTIES,                  \
		  ossl_kdf_pbkdf2_functions },                                 \
		{ PROV_NAMES_SSHKDF, FIPS_DEFAULT_PROPERTIES,                  \
...
static const OSSL_ALGORITHM fips_kdfs[] = { FIPS_KDFS_COMMON(),
					    { NULL, NULL, NULL } };

static const OSSL_ALGORITHM fips_kdfs_internal[] = {
	FIPS_KDFS_COMMON(),
	/* For deterministic ECDSA */
	{ PROV_NAMES_HMAC_DRBG_KDF, FIPS_DEFAULT_PROPERTIES,
...
static const OSSL_ALGORITHM fips_rands[] = {
	...
	{ PROV_NAMES_CTR_DRBG, FIPS_DEFAULT_PROPERTIES,
	  ossl_drbg_ctr_functions },
	{ PROV_NAMES_HASH_DRBG, FIPS_DEFAULT_PROPERTIES,
...
static const OSSL_ALGORITHM fips_signature[] = {
	...
	{ PROV_NAMES_DSA, FIPS_DEFAULT_PROPERTIES,
...
static const OSSL_ALGORITHM fips_asym_kem[] = {
	...
	{ "X448MLKEM1024", FIPS_DEFAULT_PROPERTIES,
	  ossl_mlx_kem_asym_kem_functions },
#endif
...
static const OSSL_ALGORITHM fips_keymgmt[] = {
	...
	{ PROV_NAMES_X448, FIPS_UNAPPROVED_PROPERTIES,
	  ossl_x448_keymgmt_functions, PROV_DESCS_X448 },
	{ PROV_NAMES_ED25519, FIPS_DEFAULT_PROPERTIES,
	  ossl_ed25519_keymgmt_functions, PROV_DESCS_ED25519 },
	{ PROV_NAMES_ED448, FIPS_DEFAULT_PROPERTIES,
	  ossl_ed448_keymgmt_functions, PROV_DESCS_ED448 },
#endif
#endif
#ifndef OPENSSL_NO_ML_DSA
	{ PROV_NAMES_ML_DSA_44, FIPS_DEFAULT_PROPERTIES,
	...
	{ PROV_NAMES_TLS1_PRF, FIPS_DEFAULT_PROPERTIES,
	  ossl_kdf_keymgmt_functions, PROV_DESCS_TLS1_PRF_SIGN },
...
#ifndef OPENSSL_NO_SLH_DSA
	{ PROV_NAMES_SLH_DSA_SHA2_128S, FIPS_DEFAULT_PROPERTIES,
	  ossl_slh_dsa_sha2_128s_keymgmt_functions,
	  PROV_DESCS_SLH_DSA_SHA2_128S },
	{ PROV_NAMES_SLH_DSA_SHA2_128F, FIPS_DEFAULT_PROPERTIES,
	  ossl_slh_dsa_sha2_128f_keymgmt_functions,
	  PROV_DESCS_SLH_DSA_SHA2_128F },
	{ PROV_NAMES_SLH_DSA_SHA2_192S, FIPS_DEFAULT_PROPERTIES,
	  ossl_slh_dsa_sha2_192s_keymgmt_functions,
	  PROV_DESCS_SLH_DSA_SHA2_192S },
	{ PROV_NAMES_SLH_DSA_SHA2_192F, FIPS_DEFAULT_PROPERTIES,
	  ossl_slh_dsa_sha2_192f_keymgmt_functions,
	  PROV_DESCS_SLH_DSA_SHA2_192F },
	{ PROV_NAMES_SLH_DSA_SHA2_256S, FIPS_DEFAULT_PROPERTIES,
	  ossl_slh_dsa_sha2_256s_keymgmt_functions,
	  PROV_DESCS_SLH_DSA_SHA2_256S },
	{ PROV_NAMES_SLH_DSA_SHA2_256F, FIPS_DEFAULT_PROPERTIES,
	  ossl_slh_dsa_sha2_256f_keymgmt_functions,
	  PROV_DESCS_SLH_DSA_SHA2_256F },
	{ PROV_NAMES_SLH_DSA_SHAKE_128S, FIPS_DEFAULT_PROPERTIES,
	  ossl_slh_dsa_shake_128s_keymgmt_functions,
	  PROV_DESCS_SLH_DSA_SHAKE_128S },
	{ PROV_NAMES_SLH_DSA_SHAKE_128F, FIPS_DEFAULT_PROPERTIES,
	...
	{ PROV_NAMES_SLH_DSA_SHAKE_192S, FIPS_DEFAULT_PROPERTIES,
	  ...
	  PROV_DESCS_SLH_DSA_SHAKE_192S },
	{ PROV_NAMES_SLH_DSA_SHAKE_192F, FIPS_DEFAULT_PROPERTIES,
	  ossl_slh_dsa_shake_192f_keymgmt_functions,
	  PROV_DESCS_SLH_DSA_SHAKE_192F },
	{ PROV_NAMES_SLH_DSA_SHAKE_256S, FIPS_DEFAULT_PROPERTIES,
	  ossl_slh_dsa_shake_256s_keymgmt_functions,
	  PROV_DESCS_SLH_DSA_SHAKE_256S },
	{ PROV_NAMES_SLH_DSA_SHAKE_256F, FIPS_DEFAULT_PROPERTIES,
	  ossl_slh_dsa_shake_256f_keymgmt_functions,
	  PROV_DESCS_SLH_DSA_SHAKE_256F },
#endif /* OPENSSL_NO_SLH_DSA */
	{ NULL, NULL, NULL }
};
...
static const OSSL_ALGORITHM fips_skeymgmt[] = {
	{ PROV_NAMES_AES, FIPS_DEFAULT_PROPERTIES, ossl_aes_skeymgmt_functions,
	  PROV_DESCS_AES },
	{ PROV_NAMES_GENERIC, FIPS_DEFAULT_PROPERTIES,
	  ossl_generic_skeymgmt_functions, PROV_DESCS_GENERIC },
	{ NULL, NULL, NULL }
};
...
#define set_func(c, f)   \
	if (c == NULL)   \
		...
		case OSSL_FUNC_BIO_FREE:
			set_func(selftest_params.bio_free_cb,
	...
	if ((fgbl = ossl_lib_ctx_get_data(
		     libctx, OSSL_LIB_CTX_FIPS_PROV_INDEX)) == NULL)
		goto err;
...
#define OSSL_FIPS_PARAM(structname, paramname, unused)          \
	...
	{                                                       \
		FIPS_GLOBAL *fgbl = ossl_lib_ctx_get_data(      \
			libctx, OSSL_LIB_CTX_FIPS_PROV_INDEX);  \
                                                                \
