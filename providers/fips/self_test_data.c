 ...
 * the varants will be used, so we just test them all at once
 */
 ...
 */
...
#endif  /* OPENSSL_NO_LMS */
    {
        ...
        .u.kdf = { tls13_kdf_early_secret_params },
    ...
    },
    {
        ...
        .u.kdf = { tls13_kdf_client_early_secret_params },
        .depends_on = hkdf_depends_on
    },
    {
