...
static const TLS_GROUP_CONSTANTS group_list[] = {
    ...
    { OSSL_TLS_GROUP_ID_X25519MLKEM768, ML_KEM_768_SECBITS, TLS1_3_VERSION, 0, -1, -1, 1 },
    { OSSL_TLS_GROUP_ID_SecP256r1MLKEM768, ML_KEM_768_SECBITS, TLS1_3_VERSION, 0, -1, -1, 1 },
    { OSSL_TLS_GROUP_ID_SecP384r1MLKEM1024, ML_KEM_1024_SECBITS, TLS1_3_VERSION, 0, -1, -1, 1 },
#endif
};
...
# endif
# if !defined(OPENSSL_NO_ML_KEM) && !defined(OPENSSL_NO_ECX)
    TLS_GROUP_ENTRY("X25519MLKEM768", "X25519_ML-KEM-768", "X25519_ML-KEM-768", 41),
    TLS_GROUP_ENTRY("SecP256r1MLKEM768", "P256_ML-KEM-768", "P256_ML-KEM-768", 42),
    TLS_GROUP_ENTRY("SecP384r1MLKEM1024", "P384-KEM-1024", "P384-KEM-1024", 43),
# endif
};
