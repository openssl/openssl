...
static const TLS_GROUP_CONSTANTS group_list[35] = {
    ...
    { OSSL_TLS_GROUP_ID_brainpoolP256r1, 128, TLS1_VERSION, 0,
      DTLS1_VERSION, 0 },
    { OSSL_TLS_GROUP_ID_brainpoolP384r1, 192, TLS1_VERSION, 0,
      DTLS1_VERSION, 0 },
    { OSSL_TLS_GROUP_ID_brainpoolP512r1, 256, TLS1_VERSION, 0,
      DTLS1_VERSION, 0 },
