...
#  if !defined(OPENSSL_NO_ECX)
    TLS_GROUP_ENTRY("X25519MLKEM768", "", "X25519_ML-KEM-768", 41),
#  endif
    TLS_GROUP_ENTRY("SecP256r1MLKEM768", "", "P256_ML-KEM-768", 42),
    TLS_GROUP_ENTRY("SecP384r1MLKEM1024", "", "P384_ML-KEM-1024", 43),
# endif
};
