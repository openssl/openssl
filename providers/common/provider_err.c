...
static const ERR_STRING_DATA PROV_str_reasons[] = {
    ...
    { ERR_PACK(ERR_LIB_PROV, 0, PROV_R_FIPS_MODULE_MISSING_MAC_INTEGRITY_ERROR),
        "fips module missing mac integrity error" },
    ...
    { ERR_PACK(ERR_LIB_PROV, 0, PROV_R_KEY_IMMUTABLE_ONCE_SET),
        "key immutable once set" },
