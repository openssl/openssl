...
static const ERR_STRING_DATA PROV_str_reasons[] = {
	...
	{ ERR_PACK(ERR_LIB_PROV, 0, PROV_R_COFACTOR_REQUIRED),
	  "cofactor required" },
	...
	{ ERR_PACK(ERR_LIB_PROV, 0, PROV_R_DIGEST_NOT_ALLOWED),
	  "digest not allowed" },
	{ ERR_PACK(ERR_LIB_PROV, 0, PROV_R_EMS_NOT_ENABLED),
	  "ems not enabled" },
	...
	{ ERR_PACK(ERR_LIB_PROV, 0, PROV_R_FAILED_TO_DECRYPT),
	  "failed to decrypt" },
	...
	{ ERR_PACK(ERR_LIB_PROV, 0, PROV_R_INVALID_IV_LENGTH),
	  "invalid iv length" },
	...
	{ ERR_PACK(ERR_LIB_PROV, 0, PROV_R_INVALID_MEMORY_SIZE),
	  "invalid memory size" },
	{ ERR_PACK(ERR_LIB_PROV, 0, PROV_R_INVALID_MGF1_MD),
	  "invalid mgf1 md" },
	...
	{ ERR_PACK(ERR_LIB_PROV, 0, PROV_R_INVALID_PUBINFO),
	  "invalid pubinfo" },
	...
	{ ERR_PACK(ERR_LIB_PROV, 0, PROV_R_MISSING_XCGHASH),
	  "missing xcghash" },
	...
	{ ERR_PACK(ERR_LIB_PROV, 0, PROV_R_NOT_A_PRIVATE_KEY),
	  "not a private key" },
	{ ERR_PACK(ERR_LIB_PROV, 0, PROV_R_NOT_A_PUBLIC_KEY),
	  "not a public key" },
	{ ERR_PACK(ERR_LIB_PROV, 0, PROV_R_NOT_INSTANTIATED),
	  "not instantiated" },
	...
	{ ERR_PACK(ERR_LIB_PROV, 0, PROV_R_NO_PARAMETERS_SET),
	  "no parameters set" },
	...
	{ ERR_PACK(ERR_LIB_PROV, 0, PROV_R_TOO_MANY_RECORDS),
	  "too many records" },
	...
	{ ERR_PACK(ERR_LIB_PROV, 0, PROV_R_UNABLE_TO_RESEED),
	  "unable to reseed" },
