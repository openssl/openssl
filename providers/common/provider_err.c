...
static const ERR_STRING_DATA PROV_str_reasons[] = {
    ...
    { ERR_PACK(ERR_LIB_PROV, 0, PROV_R_BN_CTX_ERR), "bn ctx err" },
    { ERR_PACK(ERR_LIB_PROV, 0, PROV_R_BN_ERROR), "bn error" },
    { ERR_PACK(ERR_LIB_PROV, 0, PROV_R_BN_FAILURE), "bn failure" },
    { ERR_PACK(ERR_LIB_PROV, 0, PROV_R_BN_GET_ERR), "bn get err" },
