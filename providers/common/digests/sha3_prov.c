...
static OSSL_OP_digest_settable_ctx_types_fn shake_settable_ctx_types;
...
const OSSL_DISPATCH name##_functions[] = {                              \
    ...
    { OSSL_FUNC_DIGEST_SETTABLE_CTX_TYPES,                              \
...
static const OSSL_PARAM known_shake_settable_ctx_types[] = {
    {OSSL_DIGEST_PARAM_SSL3_MS, OSSL_PARAM_OCTET_STRING, NULL, 0, 0},
    OSSL_PARAM_END
};

static const OSSL_PARAM *shake_settable_ctx_types(void)
{
    return known_shake_settable_ctx_types;
}
...
#define SHAKE(bitlen) \
    ...
    OSSL_FUNC_SHA3_DIGEST(shake_##bitlen, bitlen, \
                          SHA3_BLOCKSIZE(bitlen), SHA3_MDSIZE(bitlen), \
                          EVP_MD_FLAG_XOF, \
                          shake_settable_ctx_types, shake_ctx_set_params)
#define KMAC(bitlen) \
