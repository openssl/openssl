...
extern const OSSL_DISPATCH ossl_turboshake_128_functions[];
extern const OSSL_DISPATCH ossl_turboshake_256_functions[];
extern const OSSL_DISPATCH ossl_kt_128_functions[];
extern const OSSL_DISPATCH ossl_kt_256_functions[];
