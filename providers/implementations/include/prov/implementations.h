...
extern const OSSL_DISPATCH ossl_hss_lms_keymgmt_functions[];
#endif
...
extern const OSSL_DISPATCH ossl_hss_lms_to_SubjectPublicKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH ossl_hss_lms_to_SubjectPublicKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH ossl_hss_lms_to_text_encoder_functions[];
...
extern const OSSL_DISPATCH ossl_xdr_to_hss_lms_decoder_functions[];
extern const OSSL_DISPATCH ossl_SubjectPublicKeyInfo_der_to_hss_lms_decoder_functions[];
