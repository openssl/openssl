...
extern const OSSL_DISPATCH ossl_aes256ecb_internal_functions[];
extern const OSSL_DISPATCH ossl_aes192ecb_internal_functions[];
extern const OSSL_DISPATCH ossl_aes128ecb_internal_functions[];
