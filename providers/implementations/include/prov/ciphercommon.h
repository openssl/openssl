...
#define PROV_CIPHER_FUNC(type, name, args) typedef type (* Otls_##name##_fn)args
...
Otls_OP_cipher_encrypt_init_fn cipher_generic_einit;
Otls_OP_cipher_decrypt_init_fn cipher_generic_dinit;
Otls_OP_cipher_update_fn cipher_generic_block_update;
Otls_OP_cipher_final_fn cipher_generic_block_final;
Otls_OP_cipher_update_fn cipher_generic_stream_update;
Otls_OP_cipher_final_fn cipher_generic_stream_final;
Otls_OP_cipher_cipher_fn cipher_generic_cipher;
Otls_OP_cipher_get_ctx_params_fn cipher_generic_get_ctx_params;
Otls_OP_cipher_set_ctx_params_fn cipher_generic_set_ctx_params;
Otls_OP_cipher_gettable_params_fn     cipher_generic_gettable_params;
Otls_OP_cipher_gettable_ctx_params_fn cipher_generic_gettable_ctx_params;
Otls_OP_cipher_settable_ctx_params_fn cipher_generic_settable_ctx_params;
Otls_OP_cipher_set_ctx_params_fn cipher_var_keylen_set_ctx_params;
Otls_OP_cipher_settable_ctx_params_fn cipher_var_keylen_settable_ctx_params;
Otls_OP_cipher_gettable_ctx_params_fn cipher_aead_gettable_ctx_params;
Otls_OP_cipher_settable_ctx_params_fn cipher_aead_settable_ctx_params;
int cipher_generic_get_params(Otls_PARAM params[], unsigned int md,
                              unsigned long flags,
...
static const Otls_PARAM name##_known_gettable_ctx_params[] = {                 \
    Otls_PARAM_size_t(Otls_CIPHER_PARAM_KEYLEN, NULL),                         \
    Otls_PARAM_size_t(Otls_CIPHER_PARAM_IVLEN, NULL),                          \
    Otls_PARAM_uint(Otls_CIPHER_PARAM_PADDING, NULL),                          \
    Otls_PARAM_uint(Otls_CIPHER_PARAM_NUM, NULL),                              \
    Otls_PARAM_octet_string(Otls_CIPHER_PARAM_IV, NULL, 0),

#define CIPHER_DEFAULT_GETTABLE_CTX_PARAMS_END(name)                           \
    Otls_PARAM_END                                                             \
};                                                                             \
const Otls_PARAM * name##_gettable_ctx_params(void)                            \
{                                                                              \
    return name##_known_gettable_ctx_params;                                   \
}

#define CIPHER_DEFAULT_SETTABLE_CTX_PARAMS_START(name)                         \
static const Otls_PARAM name##_known_settable_ctx_params[] = {                 \
    Otls_PARAM_uint(Otls_CIPHER_PARAM_PADDING, NULL),                          \
    Otls_PARAM_uint(Otls_CIPHER_PARAM_NUM, NULL),
#define CIPHER_DEFAULT_SETTABLE_CTX_PARAMS_END(name)                           \
    Otls_PARAM_END                                                             \
};                                                                             \
const Otls_PARAM * name##_settable_ctx_params(void)                            \
{                                                                              \
