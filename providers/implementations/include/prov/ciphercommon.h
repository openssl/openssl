...
#define CIPHER_DEFAULT_GETTABLE_CTX_PARAMS(name, ...)                    \
    ...
    /* end of CIPHER_DEFAULT_GETTABLE_CTX_PARAMS */

#define CIPHER_DEFAULT_SETTABLE_CTX_PARAMS(name, ...)                    \
    ...
    /* end of CIPHER_DEFAULT_SETTABLE_CTX_PARAMS */
