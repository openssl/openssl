...
#define PROV_NAMES_AES_256_WRAP_PAD_INV \
	"AES-256-WRAP-PAD-INV:AES256-WRAP-PAD-INV"
#define PROV_NAMES_AES_192_WRAP_PAD_INV \
	"AES-192-WRAP-PAD-INV:AES192-WRAP-PAD-INV"
#define PROV_NAMES_AES_128_WRAP_PAD_INV \
...
#define PROV_NAMES_SHA2_512_224 \
	"SHA2-512/224:SHA-512/224:SHA512-224:2.16.840.1.101.3.4.2.5"
#define PROV_NAMES_SHA2_512_256 \
 ...
 */
#define PROV_NAMES_BLAKE2S_256 \
	"BLAKE2S-256:BLAKE2s256:1.3.6.1.4.1.1722.12.2.2.8"
#define PROV_NAMES_BLAKE2B_512 \
	"BLAKE2B-512:BLAKE2b512:1.3.6.1.4.1.1722.12.2.1.16"
...
#define PROV_NAMES_HKDF_SHA256 \
	"HKDF-SHA256:id-alg-hkdf-with-sha256:1.2.840.113549.1.9.16.3.28"
#define PROV_DESCS_HKDF_SHA256_SIGN \
	"OpenSSL HKDF-SHA256 via EVP_PKEY implementation"
#define PROV_NAMES_HKDF_SHA384 \
	"HKDF-SHA384:id-alg-hkdf-with-sha384:1.2.840.113549.1.9.16.3.29"
#define PROV_DESCS_HKDF_SHA384_SIGN \
	"OpenSSL HKDF-SHA384 via EVP_PKEY implementation"
#define PROV_NAMES_HKDF_SHA512 \
	"HKDF-SHA512:id-alg-hkdf-with-sha512:1.2.840.113549.1.9.16.3.30"
#define PROV_DESCS_HKDF_SHA512_SIGN \
	"OpenSSL HKDF-SHA512 via EVP_PKEY implementation"
...
#define PROV_DESCS_SLH_DSA_SHAKE_128S \
	"OpenSSL SLH-DSA-SHAKE-128s implementation"
#define PROV_DESCS_SLH_DSA_SHAKE_128F \
	"OpenSSL SLH-DSA-SHAKE-128f implementation"
#define PROV_DESCS_SLH_DSA_SHAKE_192S \
	"OpenSSL SLH-DSA-SHAKE-192s implementation"
#define PROV_DESCS_SLH_DSA_SHAKE_192F \
	"OpenSSL SLH-DSA-SHAKE-192f implementation"
#define PROV_DESCS_SLH_DSA_SHAKE_256S \
	"OpenSSL SLH-DSA-SHAKE-256s implementation"
#define PROV_DESCS_SLH_DSA_SHAKE_256F \
	"OpenSSL SLH-DSA-SHAKE-256f implementation"
