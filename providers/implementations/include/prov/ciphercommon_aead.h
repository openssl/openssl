...
#define IMPLEMENT_aead_cipher(alg, lc, UCMODE, flags, kbits, blkbits, ivbits) \
	...
	{                                                                     \
		return ossl_cipher_generic_get_params(                        \
			params, EVP_CIPH_##UCMODE##_MODE, flags, kbits,       \
			blkbits, ivbits);                                     \
	}                                                                     \
	...
	const OSSL_DISPATCH ossl_##alg##kbits##lc##_functions[] = {           \
		{ OSSL_FUNC_CIPHER_NEWCTX,                                    \
		  (void (*)(void))alg##kbits##lc##_newctx },                  \
		{ OSSL_FUNC_CIPHER_FREECTX,                                   \
		  (void (*)(void))alg##_##lc##_freectx },                     \
		{ OSSL_FUNC_CIPHER_DUPCTX,                                    \
		  (void (*)(void))alg##kbits##lc##_dupctx },                  \
		{ OSSL_FUNC_CIPHER_ENCRYPT_INIT,                              \
		  (void (*)(void))ossl_##lc##_einit },                        \
		{ OSSL_FUNC_CIPHER_DECRYPT_INIT,                              \
		  (void (*)(void))ossl_##lc##_dinit },                        \
		{ OSSL_FUNC_CIPHER_UPDATE,                                    \
		  (void (*)(void))ossl_##lc##_stream_update },                \
		{ OSSL_FUNC_CIPHER_FINAL,                                     \
		  (void (*)(void))ossl_##lc##_stream_final },                 \
		{ OSSL_FUNC_CIPHER_CIPHER,                                    \
		  (void (*)(void))ossl_##lc##_cipher },                       \
