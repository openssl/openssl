...
{
    return ml_kem_get_ctx_params_list;
}

static int ml_kem_get_ctx_params(ossl_unused void *vctx, OSSL_PARAM params[])
{
    struct ml_kem_get_ctx_params_st p;

    return ml_kem_get_ctx_params_decoder(params, &p);
}
#endif
