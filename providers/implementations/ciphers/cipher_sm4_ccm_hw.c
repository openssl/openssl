...
static int ccm_sm4_initkey(PROV_CCM_CTX *ctx, const unsigned char *key,
			   size_t keylen)
{
...
#ifdef HWSM4_CAPABLE
	if (HWSM4_CAPABLE) {
		SM4_HW_CCM_SET_KEY_FN(HWSM4_set_encrypt_key, HWSM4_encrypt,
				      NULL, NULL);
	} else
#endif /* HWSM4_CAPABLE */
		...
		if (VPSM4_EX_CAPABLE) {
		SM4_HW_CCM_SET_KEY_FN(vpsm4_ex_set_encrypt_key,
				      vpsm4_ex_encrypt, NULL, NULL);
	} else
#endif /* VPSM4_EX_CAPABLE */

#ifdef VPSM4_CAPABLE
		if (VPSM4_CAPABLE) {
		SM4_HW_CCM_SET_KEY_FN(vpsm4_set_encrypt_key, vpsm4_encrypt,
				      NULL, NULL);
	} else
#endif /* VPSM4_CAPABLE */
	{
		SM4_HW_CCM_SET_KEY_FN(ossl_sm4_set_key, ossl_sm4_encrypt, NULL,
				      NULL);
	}
	return 1;
}

static const PROV_CCM_HW ccm_sm4 = { ccm_sm4_initkey,
