...
#define IMPLEMENT_tdes_cipher(type, UCTYPE, lcmode, UCMODE, flags, kbits,      \
	...
	{                                                                      \
		return ossl_tdes_newctx(                                       \
			provctx, EVP_CIPH_##UCMODE##_MODE, kbits, blkbits,     \
			ivbits, flags,                                         \
			ossl_prov_cipher_hw_tdes_##type##_##lcmode());         \
	}                                                                      \
	static OSSL_FUNC_cipher_get_params_fn                                  \
		tdes_##type##_##lcmode##_get_params;                           \
...
#define PROV_CIPHER_HW_tdes_mode(type, mode)                                 \
	static const PROV_CIPHER_HW type##_##mode = {                        \
		...
		ossl_cipher_hw_tdes_##mode, ossl_cipher_hw_tdes_copyctx      \
	};                                                                   \
