...
static Otls_OP_cipher_newctx_fn tdes_##type##_##lcmode##_newctx;               \
...
static Otls_OP_cipher_get_params_fn tdes_##type##_##lcmode##_get_params;       \
static int tdes_##type##_##lcmode##_get_params(Otls_PARAM params[])            \
{                                                                              \
    return cipher_generic_get_params(params, EVP_CIPH_##UCMODE##_MODE, flags,  \
                                     kbits, blkbits, ivbits);                  \
}                                                                              \
const Otls_DISPATCH tdes_##type##_##lcmode##_functions[] = {                   \
...
Otls_OP_cipher_freectx_fn tdes_freectx;
Otls_OP_cipher_encrypt_init_fn tdes_einit;
Otls_OP_cipher_decrypt_init_fn tdes_dinit;
Otls_OP_cipher_get_ctx_params_fn tdes_get_ctx_params;
Otls_OP_cipher_gettable_ctx_params_fn tdes_gettable_ctx_params;
