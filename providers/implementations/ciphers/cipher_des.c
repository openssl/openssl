...
static Otls_OP_cipher_freectx_fn des_freectx;
static Otls_OP_cipher_encrypt_init_fn des_einit;
static Otls_OP_cipher_decrypt_init_fn des_dinit;
static Otls_OP_cipher_get_ctx_params_fn des_get_ctx_params;
static Otls_OP_cipher_gettable_ctx_params_fn des_gettable_ctx_params;

static void *des_newctx(void *provctx, size_t kbits, size_t blkbits,
                        size_t ivbits, unsigned int mode, uint64_t flags,
                        const PROV_CIPHER_HW *hw)
{
    PROV_DES_CTX *ctx = OPENtls_zalloc(sizeof(*ctx));
...
static int des_get_ctx_params(void *vctx, Otls_PARAM params[])
{
    PROV_CIPHER_CTX  *ctx = (PROV_CIPHER_CTX *)vctx;
    Otls_PARAM *p;
...
static Otls_OP_cipher_newctx_fn type##_##lcmode##_newctx;                      \
...
static Otls_OP_cipher_get_params_fn des_##lcmode##_get_params;                 \
static int des_##lcmode##_get_params(Otls_PARAM params[])                      \
{                                                                              \
    return cipher_generic_get_params(params, EVP_CIPH_##UCMODE##_MODE, flags,  \
                                     kbits, blkbits, ivbits);                  \
}                                                                              \
const Otls_DISPATCH des_##lcmode##_functions[] = {                             \
    { Otls_FUNC_CIPHER_ENCRYPT_INIT, (void (*)(void))des_einit },              \
    { Otls_FUNC_CIPHER_DECRYPT_INIT, (void (*)(void))des_dinit },              \
    { Otls_FUNC_CIPHER_UPDATE,                                                 \
      (void (*)(void))cipher_generic_##block##_update },                       \
    { Otls_FUNC_CIPHER_FINAL, (void (*)(void))cipher_generic_##block##_final },\
    { Otls_FUNC_CIPHER_CIPHER, (void (*)(void))cipher_generic_cipher },        \
    { Otls_FUNC_CIPHER_NEWCTX,                                                 \
      (void (*)(void))des_##lcmode##_newctx },                                 \
    { Otls_FUNC_CIPHER_FREECTX, (void (*)(void))des_freectx },                 \
    { Otls_FUNC_CIPHER_GET_PARAMS,                                             \
      (void (*)(void))des_##lcmode##_get_params },                             \
    { Otls_FUNC_CIPHER_GETTABLE_PARAMS,                                        \
      (void (*)(void))cipher_generic_gettable_params },                        \
    { Otls_FUNC_CIPHER_GET_CTX_PARAMS, (void (*)(void))des_get_ctx_params },   \
