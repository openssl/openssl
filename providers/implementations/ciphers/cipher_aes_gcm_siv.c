...
static void *ossl_aes_gcm_siv_dupctx(void *vctx)
{
	...
	if (in->aad != NULL) {
		if ((ret->aad = OPENSSL_memdup(in->aad, UP16(ret->aad_len))) ==
		    NULL)
			goto err;
	}
...
static int ossl_aes_gcm_siv_get_ctx_params(void *vctx, OSSL_PARAM params[])
{
	...
	if (p != NULL && p->data_type == OSSL_PARAM_OCTET_STRING) {
		if (!ctx->enc || !ctx->generated_tag ||
		    ...
		    !OSSL_PARAM_set_octet_string(p, ctx->tag,
						 sizeof(ctx->tag))) {
...
#define IMPLEMENT_cipher(alg, lc, UCMODE, flags, kbits, blkbits, ivbits)      \
	...
	static OSSL_FUNC_cipher_get_params_fn                                 \
		ossl_##alg##_##kbits##_##lc##_get_params;                     \
	static OSSL_FUNC_cipher_get_ctx_params_fn                             \
		ossl_##alg##_##lc##_get_ctx_params;                           \
	static OSSL_FUNC_cipher_gettable_ctx_params_fn                        \
		ossl_##alg##_##lc##_gettable_ctx_params;                      \
	static OSSL_FUNC_cipher_set_ctx_params_fn                             \
		ossl_##alg##_##lc##_set_ctx_params;                           \
	static OSSL_FUNC_cipher_settable_ctx_params_fn                        \
		ossl_##alg##_##lc##_settable_ctx_params;                      \
	static int ossl_##alg##_##kbits##_##lc##_get_params(                  \
		OSSL_PARAM params[])                                          \
	{                                                                     \
	...
	const OSSL_DISPATCH ossl_##alg##kbits##lc##_functions[] = {           \
		{ OSSL_FUNC_CIPHER_NEWCTX,                                    \
		  (void (*)(void))ossl_##alg##kbits##_##lc##_newctx },        \
		{ OSSL_FUNC_CIPHER_FREECTX,                                   \
		  (void (*)(void))ossl_##alg##_##lc##_freectx },              \
		{ OSSL_FUNC_CIPHER_DUPCTX,                                    \
		  (void (*)(void))ossl_##alg##_##lc##_dupctx },               \
		{ OSSL_FUNC_CIPHER_ENCRYPT_INIT,                              \
		  (void (*)(void))ossl_##alg##_##lc##_einit },                \
		{ OSSL_FUNC_CIPHER_DECRYPT_INIT,                              \
		  (void (*)(void))ossl_##alg##_##lc##_dinit },                \
		{ OSSL_FUNC_CIPHER_UPDATE,                                    \
		  (void (*)(void))ossl_##alg##_##lc##_stream_update },        \
		{ OSSL_FUNC_CIPHER_FINAL,                                     \
		  (void (*)(void))ossl_##alg##_##lc##_stream_final },         \
		{ OSSL_FUNC_CIPHER_CIPHER,                                    \
		  (void (*)(void))ossl_##alg##_##lc##_cipher },               \
		{ OSSL_FUNC_CIPHER_GET_PARAMS,                                \
		  (void (*)(void))ossl_##alg##_##kbits##_##lc##_get_params }, \
		{ OSSL_FUNC_CIPHER_GETTABLE_PARAMS,                           \
		  (void (*)(void))ossl_cipher_generic_gettable_params },      \
		{ OSSL_FUNC_CIPHER_GET_CTX_PARAMS,                            \
		  (void (*)(void))ossl_##alg##_##lc##_get_ctx_params },       \
		{ OSSL_FUNC_CIPHER_GETTABLE_CTX_PARAMS,                       \
		  (void (*)(void))ossl_##alg##_##lc##_gettable_ctx_params },  \
		{ OSSL_FUNC_CIPHER_SET_CTX_PARAMS,                            \
		  (void (*)(void))ossl_##alg##_##lc##_set_ctx_params },       \
		{ OSSL_FUNC_CIPHER_SETTABLE_CTX_PARAMS,                       \
		  (void (*)(void))ossl_##alg##_##lc##_settable_ctx_params },  \
		OSSL_DISPATCH_END                                             \
	}
