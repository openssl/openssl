...
#define IMPLEMENT_cipher(lcmode, UCMODE, kbits, flags)                         \
	static OSSL_FUNC_cipher_get_params_fn                                  \
		aes_##kbits##_##lcmode##_get_params;                           \
	...
	{                                                                      \
		return aes_xts_newctx(provctx, EVP_CIPH_##UCMODE##_MODE,       \
				      flags, 2 * kbits, AES_XTS_BLOCK_BITS,    \
				      AES_XTS_IV_BITS);                        \
	}                                                                      \
	const OSSL_DISPATCH ossl_aes##kbits##xts_functions[] = {               \
		{ OSSL_FUNC_CIPHER_NEWCTX,                                     \
		  (void (*)(void))aes_##kbits##_xts_newctx },                  \
		{ OSSL_FUNC_CIPHER_ENCRYPT_INIT,                               \
		  (void (*)(void))aes_xts_einit },                             \
		{ OSSL_FUNC_CIPHER_DECRYPT_INIT,                               \
		  (void (*)(void))aes_xts_dinit },                             \
		{ OSSL_FUNC_CIPHER_UPDATE,                                     \
		  (void (*)(void))aes_xts_stream_update },                     \
		{ OSSL_FUNC_CIPHER_FINAL,                                      \
		  (void (*)(void))aes_xts_stream_final },                      \
