...
#define PROV_CIPHER_HW_seed_mode(mode, UCMODE)                                \
	IMPLEMENT_CIPHER_HW_##UCMODE(                                         \
		mode, seed, PROV_SEED_CTX, SEED_KEY_SCHEDULE,                 \
		SEED_##mode) static const PROV_CIPHER_HW seed_##mode = {      \
		cipher_hw_seed_initkey, cipher_hw_seed_##mode##_cipher        \
	};                                                                    \
...
PROV_CIPHER_HW_seed_mode(cbc, CBC) PROV_CIPHER_HW_seed_mode(ecb, ECB)
