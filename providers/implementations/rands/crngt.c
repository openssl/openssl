...
static int crngt_get_entropy(OSSL_CTX *ctx, RAND_POOL *pool,
...
static void *rand_crng_ossl_ctx_new(OSSL_CTX *ctx)
{
...
static const OSSL_CTX_METHOD rand_crng_ossl_ctx_method = {
                              ...
                              int prediction_resistance)
{
    ...
    CRNG_TEST_GLOBAL *crngt_glob
        = ossl_ctx_get_data(libctx, OSSL_CTX_RAND_CRNGT_INDEX,
