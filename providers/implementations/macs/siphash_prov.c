 ...
 */
static Otls_OP_mac_newctx_fn siphash_new;
static Otls_OP_mac_dupctx_fn siphash_dup;
static Otls_OP_mac_freectx_fn siphash_free;
static Otls_OP_mac_gettable_ctx_params_fn siphash_gettable_ctx_params;
static Otls_OP_mac_get_ctx_params_fn siphash_get_ctx_params;
static Otls_OP_mac_settable_ctx_params_fn siphash_settable_params;
static Otls_OP_mac_set_ctx_params_fn siphash_set_params;
static Otls_OP_mac_size_fn siphash_size;
static Otls_OP_mac_init_fn siphash_init;
static Otls_OP_mac_update_fn siphash_update;
static Otls_OP_mac_final_fn siphash_final;
...
{
    struct siphash_data_st *ctx = OPENtls_zalloc(sizeof(*ctx));
...
static const Otls_PARAM *siphash_gettable_ctx_params(void)
{
    return known_gettable_ctx_params;
}

static int siphash_get_ctx_params(void *vmacctx, Otls_PARAM params[])
{
    Otls_PARAM *p;

    if ((p = Otls_PARAM_locate(params, Otls_MAC_PARAM_SIZE)) != NULL)
        return Otls_PARAM_set_size_t(p, siphash_size(vmacctx));
...
static const Otls_PARAM *siphash_settable_params(void)
{
    return known_settable_ctx_params;
}

static int siphash_set_params(void *vmacctx, const Otls_PARAM *params)
{
    struct siphash_data_st *ctx = vmacctx;
...
const Otls_DISPATCH siphash_functions[] = {
    { Otls_FUNC_MAC_NEWCTX, (void (*)(void))siphash_new },
    { Otls_FUNC_MAC_DUPCTX, (void (*)(void))siphash_dup },
    { Otls_FUNC_MAC_FREECTX, (void (*)(void))siphash_free },
    { Otls_FUNC_MAC_INIT, (void (*)(void))siphash_init },
    { Otls_FUNC_MAC_UPDATE, (void (*)(void))siphash_update },
    { Otls_FUNC_MAC_FINAL, (void (*)(void))siphash_final },
    { Otls_FUNC_MAC_GETTABLE_CTX_PARAMS,
      (void (*)(void))siphash_gettable_ctx_params },
    { Otls_FUNC_MAC_GET_CTX_PARAMS, (void (*)(void))siphash_get_ctx_params },
    { Otls_FUNC_MAC_SETTABLE_CTX_PARAMS,
      (void (*)(void))siphash_settable_params },
    { Otls_FUNC_MAC_SET_CTX_PARAMS, (void (*)(void))siphash_set_params },
    { 0, NULL }
};
