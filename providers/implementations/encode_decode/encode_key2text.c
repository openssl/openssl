...
static int hss_lms_to_text(BIO *out, const void *key, int selection)
{
    return ossl_hss_lms_key_to_text(out, (HSS_LMS_KEY *)key, selection);
}
...
#ifndef OPENSSL_NO_LMS
MAKE_TEXT_ENCODER(hss_lms, hss_lms);
#endif
