...
static OSSL_OP_digest_settable_ctx_types_fn mdc2_settable_ctx_types;

static const OSSL_PARAM known_mdc2_settable_ctx_types[] = {
    {OSSL_DIGEST_PARAM_PAD_TYPE, OSSL_PARAM_INTEGER, NULL, sizeof(int), 0},
    OSSL_PARAM_END
};

static const OSSL_PARAM *mdc2_settable_ctx_types(void)
{
    return known_mdc2_settable_ctx_types;
}
...
OSSL_FUNC_DIGEST_CONSTRUCT_PARAMS(mdc2, MDC2_CTX,
                                  ...
                                  mdc2_settable_ctx_types, mdc2_ctx_set_params)
