...
static const unsigned char known_answer[] = { 0x52, 0x97, 0x93, 0x78, 0x27,
					      0x58, 0x7d, 0x62, 0x8b, 0x00,
					      0x25, 0xb5, 0xec, 0x39, 0x5e,
					      0x2d, 0x7f, 0x3e, 0xd4, 0x19 };
...
int main(int argc, char **argv)
{
	...
	if (digest_len == 20) {
         ...
         */
		if (CRYPTO_memcmp(digest, known_answer, sizeof(known_answer)) !=
		    0) {
			fprintf(stderr,
