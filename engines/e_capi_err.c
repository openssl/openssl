...
static ERR_STRING_DATA CAPI_str_reasons[] = {
    ...
    {ERR_PACK(0, 0, CAPI_R_CANT_GET_KEY),
    "cant get key"},
    {ERR_PACK(0, 0, CAPI_R_CANT_SET_HASH_VALUE),
    "cant set hash value"},
    ...
    {ERR_PACK(0, 0, CAPI_R_DECRYPT_ERROR),
    "decrypt error"},
    {ERR_PACK(0, 0, CAPI_R_ENGINE_NOT_INITIALIZED),
    "engine not initialized"},
    {ERR_PACK(0, 0, CAPI_R_ENUMCONTAINERS_ERROR),
    "enumcontainers error"},
    {ERR_PACK(0, 0, CAPI_R_ERROR_ADDING_CERT),
    "error adding cert"},
    {ERR_PACK(0, 0, CAPI_R_ERROR_CREATING_STORE),
    ...
    {ERR_PACK(0, 0, CAPI_R_ERROR_OPENING_STORE),
    "error opening store"},
    {ERR_PACK(0, 0, CAPI_R_ERROR_SIGNING_HASH),
    "error signing hash"},
    {ERR_PACK(0, 0, CAPI_R_FILE_OPEN_ERROR),
    "file open error"},
    {ERR_PACK(0, 0, CAPI_R_FUNCTION_NOT_SUPPORTED),
    "function not supported"},
    {ERR_PACK(0, 0, CAPI_R_GETUSERKEY_ERROR),
    "getuserkey error"},
    {ERR_PACK(0, 0, CAPI_R_INVALID_DIGEST_LENGTH),
    "invalid digest length"},
    {ERR_PACK(0, 0, CAPI_R_INVALID_DSA_PUBLIC_KEY_BLOB_MAGIC_NUMBER),
    "invalid dsa public key blob magic number"},
    {ERR_PACK(0, 0, CAPI_R_INVALID_LOOKUP_METHOD),
