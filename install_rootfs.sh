...
mkdir -p $TARGET_DIR/opt/openssl/
...
cp -rf build/bin/openssl $TARGET_DIR/opt/openssl/
cp -rf _run_stress.sh $TARGET_DIR/opt/openssl/
cp -rf run_stress.sh $TARGET_DIR/opt/openssl/
cp -rf run.sh $TARGET_DIR/opt/openssl/
