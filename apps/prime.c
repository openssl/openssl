		...
		for (; *argv; argv++) {
			...
			if (!in_file) {
				...
				while ((bytes_read =
					...
					valid_digits_length = strspn(
						file_read_buf,
						"1234567890abcdefABCDEF");
					file_read_buf[valid_digits_length] =
						'\0';
