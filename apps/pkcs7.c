...
typedef enum OPTION_choice {
    ...
    OPT_TEXT, OPT_PRINT, OPT_PRINT_CERTS, OPT_PRINT_CLEAN,
...
int pkcs7_main(int argc, char **argv)
{
    ...
    int i, print_certs = 0, text = 0, noout = 0, p7_print = 0, clean = 0, ret = 1;
    OPTION_CHOICE o;
