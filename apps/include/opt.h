 ...
 */
# define OPT_V_ENUM OPT_V__FIRST = 2000, \
...
# define OPT_V_OPTIONS \
    ...
    { "eku", OPT_V_EKU, 's', "certificate Extended Key Usage, e.g., serverAuth"}, \
...
# define OPT_V_CASES OPT_V__FIRST: case OPT_V__LAST: break; \
case OPT_V_POLICY: \
case OPT_V_PURPOSE: \
case OPT_V_EKU: \
 ...
 */
# define OPT_X_ENUM OPT_X__FIRST = 1000, \
 ...
 */
# define OPT_S_ENUM OPT_S__FIRST = 3000, \
...
# define OPT_S_OPTIONS \
    ...
    {"prefer_no_dhe_kex", OPT_S_PREFER_NO_DHE_KEX, '-', "In TLSv1.3 prefer non-(ec)dhe over (ec)dhe-based key exchange on resumption"}, \
    ...
    {"client_sigalgs", OPT_S_CLIENTSIGALGS, 's', "Signature algorithms to support for client certificate authentication (colon-separated list)" }, \
    {"groups", OPT_S_GROUPS, 's', "Groups to advertise (colon-separated list)" }, \
    {"curves", OPT_S_CURVES, 's', "Groups to advertise (colon-separated list)" }, \
    ...
    {"no_ems", OPT_S_NO_EMS, '-', "Disable Extended master secret extension"}
 ...
 * Provider options.
 */
# define OPT_PROV_ENUM OPT_PROV__FIRST = 1600, \
...
# define OPT_SECTION(sec) \
    { OPT_SECTION_STR, 1, '-', sec " options:\n" }
# define OPT_PARAMETERS() \
