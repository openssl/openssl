...
#define OPT_S_ENUM                                                           \
	...
	OPT_S_CLIENTRENEG, OPT_S_LEGACYCONN, OPT_S_ONRESUMP,                 \
	OPT_S_NOLEGACYCONN, OPT_S_ALLOW_NO_DHE_KEX, OPT_S_PREFER_NO_DHE_KEX, \
	OPT_S_PRIORITIZE_CHACHA, OPT_S_STRICT, OPT_S_SIGALGS,                \
	OPT_S_CLIENTSIGALGS, OPT_S_GROUPS, OPT_S_CURVES, OPT_S_NAMEDCURVE,   \
	OPT_S_CIPHER, OPT_S_CIPHERSUITES, OPT_S_RECORD_PADDING,              \
	OPT_S_DEBUGBROKE, OPT_S_COMP, OPT_S_MINPROTO, OPT_S_MAXPROTO,        \
	OPT_S_NO_RENEGOTIATION, OPT_S_NO_MIDDLEBOX, OPT_S_NO_ETM,            \
	OPT_S_NO_EMS, OPT_S_NO_TX_CERT_COMP, OPT_S_NO_RX_CERT_COMP,          \
	OPT_S__LAST
...
#define OPT_S_OPTIONS                                                                              \
	OPT_SECTION("TLS/SSL"),                                                                    \
		...
		{ "no_tx_cert_comp", OPT_S_NO_TX_CERT_COMP, '-',                                   \
		  "Disable sending TLSv1.3 compressed certificates" },                             \
		{ "no_rx_cert_comp", OPT_S_NO_RX_CERT_COMP, '-',                                   \
		  "Disable receiving TLSv1.3 compressed certificates" },                           \
...
#define OPT_PROV_ENUM                                                      \
	OPT_PROV__FIRST = 1600, OPT_PROV_PROVIDER, OPT_PROV_PROVIDER_PATH, \
	OPT_PROV_PROPQUERY, OPT_PROV_PARAM, OPT_PROV__LAST
...
#define OPT_PROV_OPTIONS                                                                   \
	OPT_SECTION("Provider"),                                                           \
		{ "provider-path", OPT_PROV_PROVIDER_PATH, 's',                            \
		  "Provider load path (must be before 'provider' argument if required)" }, \
		{ "provider", OPT_PROV_PROVIDER, 's',                                      \
		  "Provider to load (can be specified multiple times)" },                  \
		{ "provparam", OPT_PROV_PARAM, 's',                                        \
		  "Set a provider key-value parameter" },                                  \
...
#define OPT_FMT_ANY                                                      \
	(OPT_FMT_PEM | OPT_FMT_DER | OPT_FMT_B64 | OPT_FMT_PKCS12 |      \
