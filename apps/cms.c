...
const OPTIONS cms_options[] = {
    ...
    {"verify_receipt", OPT_VERIFY_RECEIPT, '<',
        "Exit with failure if receipt signatures do not verify"},
    ...
    {"receipt_request_all", OPT_RR_ALL, '-',
        "When signing, create receipt request for all recipients"},
    {"receipt_request_first", OPT_RR_FIRST, '-',
        "When signing, create receipt request for first recipient"},
    ...
    {"secretkey", OPT_SECRETKEY, 's',
        "Use specified key to decrypt/encrypt recipients or content"},
