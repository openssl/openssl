...
const OPTIONS s_server_options[] = {
    ...
    {"ssl_config", OPT_SSL_CONFIG, 's',
     "Configure SSL_CTX using the section 'val' from the config file"},
    ...
    {"CAstore", OPT_CASTORE, ':', "URI to a store of CA's to use"},
    ...
    {"servername", OPT_SERVERNAME, 's',
     "Servername for the HostName TLS extension"},
    ...
    {"no_cache", OPT_NO_CACHE, '-', "Disable the session cache"},
