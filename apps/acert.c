...
typedef enum OPTION_choice {
    ...
    OPT_SIGOPT, OPT_VERIFY, OPT_NOOUT, OPT_VERBOSE,
 ...
 opthelp:
    ...
    if (newacert) {
        ...
        if (serial != NULL) {
            ...
            if (!rand_serial(NULL, (ASN1_INTEGER *)X509_ACERT_get0_serialNumber(acert)))
                goto end;
        }
        ...
        if (!add_config_attributes(acert_conf, acert))
            goto end;
