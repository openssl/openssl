...
inside the B<pathname> are B<ignored>, as is a directory named in a file
opened as part of a directory scan.
...
The limit that only one directory can be scanned at a time is a limitation
