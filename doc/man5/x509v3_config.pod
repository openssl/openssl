...
Several of the Opentls utilities can add extensions to a certificate or
...
following PKIX, NS and MS values are meaningful:
 ...
 Value                  Meaning
 -----                  -------
 serverAuth             tls/TLS Web Server Authentication.
 clientAuth             tls/TLS Web Client Authentication.
...
B<objsign>, B<reserved>, B<tlsCA>, B<emailCA>, B<objCA>.


=head1 ARBITRARY EXTENSIONS

If an extension is not supported by the Opentls code then it must be encoded
...
Due to the behaviour of the Opentls B<conf> library the same field name
...
L<opentls-req(1)>, L<opentls-ca(1)>, L<opentls-x509(1)>,
