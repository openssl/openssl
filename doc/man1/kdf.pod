...
printable characters only).
The password must be specified for most KDF algorithms.
...
Used by TLS1-PRF, HKDF, SSKDF HMAC, SSKDF Hash, and PBKDF2, as an alphanumeric
string.
...
The supported algorithms are TLS1-PRF, HKDF, SSKDF, PBKDF2 and id-scrypt.
...
and info: \
openssl kdf -keylen 14 -kdfopt digest:SHA256 -kdfopt hexkey:6dbdc23f045488 \
