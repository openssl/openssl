...
Switches on or off replay protection respectively. Normally, replay protection
is on by default unless overridden by a configuration file. When it is on,
...
time. Any early data that was sent will be rejected.
