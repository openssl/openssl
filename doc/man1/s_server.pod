...
=item B<-record_size_limit +int>

The requested record size limit of data fragments to receive.
See L<SSL_CTX_set_record_size_limit(3)> for further information.
