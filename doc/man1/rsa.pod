...
This option is used for permitting insecure multi-prime RSA private keys.
...
To permit an insecure multi-prime private which has 8 primes with 2048-bit:

 openssl rsa -in key.pem -check -insecure
