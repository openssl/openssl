...
opentls-mac - perform Message Authentication Code operations
...
characters only).
The string length must conform to any restrictions of the MAC algorithm.
To see the list of supported digests, use C<opentls list -digest-commands>.
...
To see the list of supported MAC's use the command C<openstls list
-mac-algorithms>.
...
'Tag' and output length of 16: \
 opentls mac -macopt custom:Tag -macopt hexkey:40414243444546 \
         -macopt size:16 -in msg.bin KMAC128

To create a hex-encoded GMAC-AES-128-GCM with a IV from a file: \
 opentls mac -macopt cipher:AES-128-GCM -macopt hexiv:E0E00F19FED7BA0136A797F3 \
...
Use C<opentls list -mac-algorithms> to list them.
