...
In simple terms, the more primes a multi-prime RSA key has, the easier it is for
it to be factored. This link describs the security of multi-prime RSA:
https://www.imperialviolet.org/2011/04/09/multiprime.html. And if you want to
know more, this link provides the requisite details:
