...
client certificate chain when certificate specified via B<-cert> option is in
use.
...
The directory to use for building the chain provided to server. This directory
