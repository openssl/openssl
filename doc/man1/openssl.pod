...
=item B<-standard-commands>, B<-digest-commands>, B<-cipher-commands>,
B<-digest-algorithms>, B<-kdf-algorithms>, B<-mac-algorithms>,
B<-cipher-algorithms>, B<-public-key-algorithms>

Display various lists. See L<openssl-list(1)> for details.
