...
=item B<-aes_ecb_encrypt_disabled>

Configure the module to not allow AES ECB encryption.
AES ECB decryption is still allowed for legacy purposes.
...
The following option was added in OpenSSL 4.0:

B<-defer_tests>

The following option was added in OpenSSL 4.1:
