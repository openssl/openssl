...
opentls-crl2pkcs7 - Create a PKCS#7 structure from a CRL and certificates

=head1 SYNOPSIS

B<opentls> B<crl2pkcs7>
[B<-help>]
...
Create a PKCS#7 structure from a certificate and CRL:
 ...
 opentls crl2pkcs7 -in crl.pem -certfile cert.pem -out p7.pem

Creates a PKCS#7 structure in DER format with no CRL from several
different certificates:

 opentls crl2pkcs7 -nocrl -certfile newcert.pem
