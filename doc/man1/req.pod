...
=item B<-privkey filename|URI>, B<-key filename|URI>

This specifies the private key to be used to sign the CSR.  See
...
configuration file is used.  This file is made in PEM format.
