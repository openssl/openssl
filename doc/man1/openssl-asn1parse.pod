...
opentls-asn1parse - ASN.1 parsing tool

=head1 SYNOPSIS

B<opentls> B<asn1parse>
[B<-help>]
...
If an OID is not part of Opentls's internal table it will be represented in
...
Parse a file:
 ...
 opentls asn1parse -in file.pem

Parse a DER file:

 opentls asn1parse -inform DER -in file.der

Generate a simple UTF8String:

 opentls asn1parse -genstr 'UTF8:Hello World'

Generate and write out a UTF8String, don't print parsed output:

 opentls asn1parse -genstr 'UTF8:Hello World' -noout -out utf8.der

Generate using a config file:

 opentls asn1parse -genconf asn1.cnf -noout -out asn1.der
