...
=item B<rsa_keygen_mode:mode>

The mode in use when generating a key, either 'insecure' or 'secure', is
availiable at the current stage. If not specified 'secure' is used.
