...
opentls-list - list algorithms and features
...
as input to the L<opentls-dgst(1)> or L<opentls-speed(1)> commands.

=item B<-cipher-commands>

Display a list of cipher commands, which are typically used as input
to the L<opentls-dgst(1)> or L<opentls-speed(1)> commands.
