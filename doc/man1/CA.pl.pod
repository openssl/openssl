...
use by a beginner. Its behavior isn't always what is wanted. For more control
over the behavior of the certificate commands call the L<openssl(1)> command
directly.
...
the B<-newca> option terminated abnormally. To get the correct behavior
