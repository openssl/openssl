...
[B<-naccept> I<+int>]
[B<-serverinfo> I<val>]
[B<-certform> I<DER|PEM>]
[B<-key> I<infile>]
[B<-keyform> I<format>]
[B<-pass> I<val>]
[B<-dcert> I<infile>]
[B<-dcertform> I<DER|PEM>]
[B<-dkey> I<infile>]
[B<-dkeyform> I<DER|PEM>]
[B<-dpass> I<val>]
[B<-nbio_test>]
[B<-crlf>]
[B<-debug>]
...
[B<-xchain>]
[B<-xchain_build>]
[B<-xcertform> I<DER|PEM>]
[B<-xkeyform> I<DER|PEM>]
[B<-nbio>]
...
=item B<-dcertform> I<DER|PEM>, B<-dkeyform> I<DER|PEM>, B<-dpass> I<val>
...
=item B<-xcertform> I<DER|PEM>, B<-xkeyform> I<DER|PEM>
