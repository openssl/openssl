...
[B<-naccept> I<+int>]
[B<-serverinfo> I<val>]
[B<-certform> I<DER>|I<PEM>]
[B<-key> I<infile>]
[B<-keyform> I<format>]
[B<-pass> I<val>]
[B<-dcert> I<infile>]
[B<-dcertform> I<DER>|I<PEM>]
[B<-dkey> I<infile>]
[B<-dkeyform> I<DER>|I<PEM>]
[B<-dpass> I<val>]
[B<-nbio_test>]
[B<-crlf>]
[B<-debug>]
...
[B<-xchain>]
[B<-xchain_build>]
[B<-xcertform> I<DER>|I<PEM>]
[B<-xkeyform> I<DER>|I<PEM>]
[B<-nbio>]
...
=item B<-dcertform> I<DER>|I<PEM>, B<-dkeyform> I<DER>|I<PEM>, B<-dpass> I<val>
...
=item B<-xcertform> I<DER>|I<PEM>, B<-xkeyform> I<DER>|I<PEM>
