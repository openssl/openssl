...
Specifies the ID string when verifying an SM2 certificate. The ID string is
required by the SM2 signature algorithm for signing and verification.

=item B<-sm2-hex-id>

Specifies the SM2 ID string in binary form. The only valid input of this option
