...
C<smime_sign>, C<smime_encrypt>, C<crlsign>, C<ocsphelper>, C<timestampsign>,
...
C<ssl_server>, C<smime_sign> with alias C<pkcs7>, B<smime_encrypt>, C<code_sign>, and C<default>.
