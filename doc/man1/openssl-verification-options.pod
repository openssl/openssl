...
Unknown critical extensions are generally rejected as required by RFC 5280,
but for certificates used solely as trust anchors,
which are explicitly exempted from X.509 and RFC requirements,
this is done only in strict mode.
