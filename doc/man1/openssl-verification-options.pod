...
These options are deprecated.  Unless OpenSSL was configured with the
C<enable-deprecated-suiteb> option they are rejected with an error.
...
The B<-suiteB_128_only>, B<-suiteB_128> and B<-suiteB_192> options were
deprecated in OpenSSL 4.2 and are rejected unless OpenSSL was configured
with C<enable-deprecated-suiteb>.
