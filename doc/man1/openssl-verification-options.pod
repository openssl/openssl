...
also within the OpenSSL libraries and in various OpenSSL commands.
...
i.e., a chain ending in a certificate that normally would not be trusted
...
is presently supported, but may in the future be withdrawn.
