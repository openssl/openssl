...
Add an ESS signing-certificate or ESS signing-certificate-v2 signed-attribute 
to the SignerInfo
...
A CAdES Basic Electronic Signature (CAdES-BES), as defined in 
ETSI EN 319 122-1 V1.1.1, contains:
