...
digest sign and digest verify using PureEdDSA and B<Ed25519> (see
L<RFC8032|https://tools.ietf.org/html/rfc8032>). It has associated private
and public key formats compatible with draft-ietf-curdle-pkix-04.
