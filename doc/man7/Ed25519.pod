...
In details, B<ed25519>, B<ed448> and B<eddsa> are valid algorithm names. If B<eddsa>
is specified to L<speed(1)> application, then both Ed25519 and Ed448 are benchmarked.
