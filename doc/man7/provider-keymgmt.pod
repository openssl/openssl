...
For example, the combination of B<OSSL_KEYMGMT_B_PRIVATE_KEY> and
B<OSSL_KEYMGMT_B_PUBLIC_KEY> (or B<OSSL_KEYMGMT_SELECT_KEY> for short)
is expected to check that the pairwise consistency of I<keydata> is
valid.
