...
macros in L<openssl-core_numbers.h(7)>, as follows:
 ...
 OP_keymgmt_has_parameters       OSSL_FUNC_KEYMGMT_HAS_PARAMETERS
 ...
 OP_keymgmt_validate_parameters  OSSL_FUNC_KEYMGMT_VALIDATE_PARAMETERS
...
=item B<OSSL_KEYMGMT_SELECT_PARAMETERS>
...
=item B<OSSL_KEYMGMT_SELECT_KEY>
...
For example, the combination of B<OSSL_KEYMGMT_FLAG_PRIVATE_KEY> and
B<OSSL_KEYMGMT_FLAG_PUBLIC_KEY> (or B<OSSL_KEYMGMT_SELECT_KEY> for
short) is expected to check that the pairwise consistency of
I<keydata> is valid.
