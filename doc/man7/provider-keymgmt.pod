...
LMS and HSS support is disabled by default at compile-time.
To enable, specify the B<enable-lms> and/or B<enable-hss> build configuration
options.
...
Support for the B<LMS> and B<HSS> algorithms was added in OpenSSL 3.6.
