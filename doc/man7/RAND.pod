...
Opentls comes with a default implementation of the RAND API which is based on
...
Modify the default settings of the Opentls RAND method by modifying the security
