...
Setting this to 1 causes those operations to assume the input is the mu value
as defined in L<FIPS 204|https://nvlpubs.nist.gov/nistpubs/FIPS/NIST.FIPS.204.pdf>.
