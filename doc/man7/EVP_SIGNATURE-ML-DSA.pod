...
=item "message-encoding" (B<OSSL_SIGNATURE_PARAM_MESSAGE_ENCODING>) <int>
...
=item "deterministic" (B<OSSL_SIGNATURE_PARAM_DETERMINISTIC>) <int>
...
=item "mu" (B<OSSL_SIGNATURE_PARAM_MU>) <int>
