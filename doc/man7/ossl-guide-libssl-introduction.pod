...
SSL/TLS, DTLS or QUIC. It is passed as a parameter when creating the B<SSL_CTX>.
...
During connection establishment the client and server agree which cryptographic
