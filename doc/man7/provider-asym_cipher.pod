...
The following property is set by some of the OpenSSL asymmetric cipher
algorithms. Third party implementations can set additional properties not
mentioned here.
...
This boolean property is set to "yes" if the implementation performs blinding
to prevent some side-channel attacks.
