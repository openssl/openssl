...
using the ML-DSA Signature Parameter B<OSSL_SIGNATURE_PARAM_MU> C<mu>.
...
An optional parameter related to "Hash-ML-DSA" that is used to fetch a digest
algorithm associated with an OID. (See the definition of PreHash M' above).
