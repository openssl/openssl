...
The following FIPS non-FIPS validated (unapproved) algorithms use the
"fips-indicator".
...
=item X25519 and X448

=back

The non-FIPS validated algorithms have a property query value of "fips=no".
