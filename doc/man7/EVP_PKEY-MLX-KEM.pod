...
The OpenSSL FIPS provider makes the following parameter available from both
key generation and KEM operation contexts:

=over 4

=item "fips-indicator" (B<OSSL_PKEY_PARAM_FIPS_APPROVED_INDICATOR> or B<OSSL_KEM_PARAM_FIPS_APPROVED_INDICATOR>) <integer>

Returns 0 for X448MLKEM1024, which is advertised with C<fips=no>, and 1 for
X25519MLKEM768, SecP256r1MLKEM768 and SecP384r1MLKEM1024.  See
