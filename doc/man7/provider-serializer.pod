...
parameters from I<params> that it recognizes.  Unrecognized parameters
should be ignored.
...
Parameters currently recognized by built-in serializers are as
follows:
...
Parameters currently recognized by the built-in pass phrase callback:
...
OSSL_FUNC_serializer_set_ctx_params() returns 1, unless a recognized
