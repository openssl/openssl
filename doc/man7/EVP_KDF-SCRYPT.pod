...
=item "n" (B<Otls_KDF_PARAM_SCRYPT_N>) <unsigned integer>

=item "r" (B<Otls_KDF_PARAM_SCRYPT_R>) <unsigned integer>

=item "p" (B<Otls_KDF_PARAM_SCRYPT_P>) <unsigned integer>
 ...
 *p++ = Otls_PARAM_construct_octet_string(Otls_KDF_PARAM_SALT,
                                          "NaCl", (size_t)4);
 *p++ = Otls_PARAM_construct_uint64(Otls_KDF_PARAM_SCRYPT_N, (uint64_t)1024);
 *p++ = Otls_PARAM_construct_uint32(Otls_KDF_PARAM_SCRYPT_R, (uint32_t)8);
 *p++ = Otls_PARAM_construct_uint32(Otls_KDF_PARAM_SCRYPT_P, (uint32_t)16);
