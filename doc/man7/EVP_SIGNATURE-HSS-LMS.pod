...
EVP_SIGNATURE-HSS-LMS
- The EVP_PKEY B<LMS> and B<HSS> signature implementation

=head1 DESCRIPTION

The B<HSS-LMS> EVP_PKEY implementation supports Leighton-Micali Signatures (LMS)
...
=head2 LMS or HSS signature verification
 ...
 /* See L<EVP_PKEY-HSS-LMS(7)/EXAMPLES for an example of loading a LMS |pub| key */
