...
abstract types and values.  It is defined in the ITU-T documents X.680
to X.683:

=over 4

=item L<https://www.itu.int/rec/T-REC-X.680>

=item L<https://www.itu.int/rec/T-REC-X.681>

=item L<https://www.itu.int/rec/T-REC-X.682>

=item L<https://www.itu.int/rec/T-REC-X.683>
...
It is defined in ITU-T document X.690: L<https://www.itu.int/rec/T-REC-X.690>
...
PEM is a format used for encoding of binary content into an mail and ASCII
...
This is defined in IETF RFC 1421: L<https://tools.ietf.org/html/rfc1421>

=item PKCS#8 (also known as "pkcs8" in some parts of OpenSSL)

PKCS#8 is a specification an ASN.1 structure that OpenSSL uses for
storing or transmitting any private key in a key type agnostic
manner, and has both an unencrypted and an encrypted form.

This is specified in RFC 5208: L<https://tools.ietf.org/html/rfc5208>

=item PVK

MSBLOB is a Microsoft specific binary format for RSA and DSA private
...
RFC 5280: L<https://tools.ietf.org/html/rfc5280>

=back

=head1 HISTORY

This page was added in OpenSSL 3.0.
