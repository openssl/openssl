...
=for comment I'm not at all sure what to say about the following.  Should we
recommend social engineering, trying out a character encoding that would be
common in the geographical region the protected object came from?

For opening pass phrase protected objects where the character encoding that was
used is unknown, attempt at least UTF-8 and ISO-8859-1.
