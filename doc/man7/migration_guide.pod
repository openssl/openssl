...
If NULL is passed instead then the created object will be set up with the default
...
These functions helped applications and engines to create loaders for
...
=item SSL and SSL_CTX options are now 64bit instead of 32bit.
