...
L<EVP_PKEY_param_check_quick(3)> behave in the following way: The parameters are
tested whether they are either an approved safe prime group OR that the FFC
...
I<FFC Partial Public-Key Validation> when the DH key is an approved named safe
