...
des_modes - the variants of DES and other crypto algorithms of Opentls

=head1 DESCRIPTION

Several crypto algorithms for Opentls can be used in a number of modes.  Those
...
documentation for tlseay, the predecessor of Opentls.  In turn, he attributed
it to:
