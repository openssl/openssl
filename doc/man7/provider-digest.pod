...
=for comment multiple includes
 ...
 const OSSL_PARAM *OP_cipher_gettable_types(void);

 /* Digest operation parameter descriptors */
 const OSSL_PARAM *OP_cipher_gettable_ctx_types(void);
 const OSSL_PARAM *OP_cipher_settable_ctx_types(void);
...
macros in L<openssl-core_numbers.h(7)>, as follows:
 ...
 OP_digest_gettable_types       OSSL_FUNC_DIGEST_GETTABLE_TYPES
 OP_digest_gettable_ctx_types   OSSL_FUNC_DIGEST_GETTABLE_CTX_TYPES
 OP_digest_settable_ctx_types   OSSL_FUNC_DIGEST_SETTABLE_CTX_TYPES
...
OP_digest_gettable_types(), OP_digest_gettable_ctx_types(), and
OP_digest_settable_ctx_types() all return constant B<OSSL_PARAM> arrays
