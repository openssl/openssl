...
=item B<EVP_MD_FLAG_UPDATE_NULL>

This digest method allows NULL input to be processed by OSSL_FUNC_digest_update.
...
The flag B<EVP_MD_FLAG_UPDATE_NULL> was added in OpenSSL 4.1.
