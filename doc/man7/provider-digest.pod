...
The OpenSSL FIPS provider supports the following gettable context parameter:

=over 4

=item "fips-indicator" (B<OSSL_DIGEST_PARAM_FIPS_APPROVED_INDICATOR>) <integer>
...
The "fips-indicator" context parameter was added in OpenSSL 3.5.9.
