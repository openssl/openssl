...
=for comment multiple includes
 ...
 const OSSL_PARAM *OP_cipher_get_params(void);

 /* Digest operation parameter descriptors */
 const OSSL_PARAM *OP_cipher_ctx_get_params(void);
 const OSSL_PARAM *OP_cipher_ctx_set_params(void);
...
macros in L<openssl-core_numbers.h(7)>, as follows:
 ...
 OP_digest_get_param_types      OSSL_FUNC_DIGEST_GET_PARAM_TYPES
 OP_digest_ctx_get_param_types  OSSL_FUNC_DIGEST_CTX_GET_PARAM_TYPES
 OP_digest_ctx_set_param_types  OSSL_FUNC_DIGEST_CTX_SET_PARAM_TYPES
...
OP_digest_get_param_types(), OP_digest_ctx_get_param_types(), and
OP_digest_ctx_set_param_types() all return constant B<OSSL_PARAM> arrays
