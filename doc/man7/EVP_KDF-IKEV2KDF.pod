...
shared secret, and nonces:
 ...
 EVP_KDF *kdf;
 EVP_KDF_CTX *kctx;
 unsigned char secret[32] = "0123456789abcdef...";
 unsigned char ni[16] = "initiator_nonce...";
 unsigned char nr[16] = "responder_nonce...";
 ...
 *p++ = OSSL_PARAM_construct_octet_string(OSSL_KDF_PARAM_IKEV2_NI,
                                          ni, sizeof(ni));
 *p++ = OSSL_PARAM_construct_octet_string(OSSL_KDF_PARAM_IKEV2_NR,
                                          nr, sizeof(nr));
...
=head2 Example of the parameters deriving DKM(Initial SA)

 unsigned char ni[16] = "initiator_nonce...";
 unsigned char nr[16] = "responder_nonce...";
 unsigned char spii[8] = "init_spi";
 unsigned char spir[8] = "resp_spi";
 unsigned char skeyseed[32] = "derived_sekey_from_previous_step...";
 int mode = 1; /* deriving DKM */
 unsigned char out["user can specify the size"];
 size_t outlen = sizeof(out);
 OSSL_PARAM params[8], *p = params;

 *p++ = OSSL_PARAM_construct_utf8_string(OSSL_KDF_PARAM_DIGEST,
                                         SN_sha256, strlen(SN_sha256));
 *p++ = OSSL_PARAM_construct_octet_string(OSSL_KDF_PARAM_SEEDKEY,
                                          skeyseed, sizeof(skeyseed));
 *p++ = OSSL_PARAM_construct_octet_string(OSSL_KDF_PARAM_IKEV2_NI,
                                          ni, sizeof(ni));
 *p++ = OSSL_PARAM_construct_octet_string(OSSL_KDF_PARAM_IKEV2_NR,
                                          nr, sizeof(nr));
 *p++ = OSSL_PARAM_construct_octet_string(OSSL_KDF_PARAM_IKEV2_SPII,
                                          spii, sizeof(spii));
 *p++ = OSSL_PARAM_construct_octet_string(OSSL_KDF_PARAM_IKEV2_SPIR,
                                          spir, sizeof(spir));
 *p++ = OSSL_PARAM_construct_int(OSSL_KDF_PARAM_MODE, &mode);
 *p = OSSL_PARAM_construct_end();

=head2 Example of the parameters used for deriving DKM(Child_SA)

 unsigned char ni[16] = "initiator_nonce...";
 unsigned char nr[16] = "responder_nonce...";
 unsigned char sk_d[32] = "the sk_d from DKM";
 int mode = 1; /* deriving DKM */
 unsigned char out["user can specify the size"];
 size_t outlen = sizeof(out);
 OSSL_PARAM params[6], *p = params;
...
=head2 Example of the parameters used for deriving DKM(Child_DH)

 uint8_t ni[16] = "initiator_nonce...";
 uint8_t nr[16] = "responder_nonce...";
 unsigned char sk_d[32] = "the sk_d from DKM";
 int mode = 1; /* deriving DKM */
 unsigned char out["user can specify the size"];
 size_t outlen = sizeof(out);
 OSSL_PARAM params[7], *p = params;
 unsigned char new_secret[32] = "0123456789abcdef...";
 ...
 *p++ = OSSL_PARAM_construct_octet_string(OSSL_KDF_PARAM_IKEV2_NR,
                                          nr, sizeof(nr));
 *p++ = OSSL_PARAM_construct_octet_string(OSSL_KDF_PARAM_IKEV2_SECRET,
                                          new_secret, sizeof(new_secret));
 *p++ = OSSL_PARAM_construct_int(OSSL_KDF_PARAM_MODE, &mode);
 *p = OSSL_PARAM_construct_end();

=head2 Example of the parameters used for rekeying the IKE SA
