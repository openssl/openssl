...
OSSL_FUNC_keyexch_init() initializes a key exchange operation given a provider side key
...
It is also passed a previously initialized key exchange context in the I<ctx>
parameter.
...
secret.
A previously initialized key exchange context is passed in the I<ctx>
parameter.
...
Common parameters currently recognized by built-in key exchange algorithms are
as follows.
