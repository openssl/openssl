...
"master secret" is used instead of "extended master secret"
Setting this to zero will ignore the error and set the approved "indicator" to 0.
This option is used by the OpenSSL FIPS provider, and breaks FIPS compliance if
set to 0.

=item "indicator" (B<OSSL_KDF_PARAM_FIPS_APPROVED_INDICATOR>) <int>
