...
=for openssl multiple includes
 ...
 int OSSL_FUNC_kdf_derive_opaque(void *kctx, void *key, const OSSL_PARAM params[]);
...
macros in L<openssl-core_dispatch.h(7)>, as follows:
 ...
 OSSL_FUNC_kdf_derive_opaque        OSSL_FUNC_KDF_DERIVE_OPAQUE
...
OSSL_FUNC_kdf_derive() or OSSL_FUNC_kdf_derive_opaque().
...
OSSL_FUNC_kdf_derive_opaque() is similar to OSSL_FUNC_kdf_derive() but uses an
...
OSSL_FUNC_kdf_derive(), OSSL_FUNC_kdf_derive_opaque(), OSSL_FUNC_kdf_get_params(),
...
OSSL_FUNC_kdf_derive_opaque() was added in OpenSSL 3.5.
