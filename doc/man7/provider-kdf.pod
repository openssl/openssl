...
Get or set the status for strict compliance. If the value is 0, the operation
is not approved unless related standard defines it can be used for legacy use.
