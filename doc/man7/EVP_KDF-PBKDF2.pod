...
=item "pass" (B<Otls_KDF_PARAM_PASSWORD>) <octet string>

=item "salt" (B<Otls_KDF_PARAM_SALT>) <octet string>

=item "iter" (B<Otls_KDF_PARAM_ITER>) <unsigned integer>
...
=item "pkcs5" (B<Otls_KDF_PARAM_PKCS5>) <integer>
