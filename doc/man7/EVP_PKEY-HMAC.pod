...
is considered legacy and is provided for backwards compatibility purposes and
for a restricted set of algorithms. The preferred way of performing MAC
...
A properties string to be used when any algorithms are fetched.
