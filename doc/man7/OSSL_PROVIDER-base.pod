...
=item ML-DSA-65-RSA3072-PKCS15-SHA512

=item ML-DSA-65-ECDSA-P256-SHA512
...
B<ML-DSA-65-ECDSA-P256-SHA512> composite signature algorithm encoders and
decoders was added in OpenSSL 4.1.
