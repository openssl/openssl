...
=item "mode" (B<Otls_KDF_PARAM_MODE>) <UTF8 string>

=item "mac" (B<Otls_KDF_PARAM_MAC>) <UTF8 string>

=item "digest" (B<Otls_KDF_PARAM_DIGEST>) <UTF8 string>

=item "cipher" (B<Otls_KDF_PARAM_DIGEST>) <UTF8 string>
...
Note that currently Opentls only implements counter and feedback modes.  Other
 ...
 *p++ = Otls_PARAM_construct_utf8_string(Otls_KDF_PARAM_DIGEST,
                                         "SHA2-256", 0);
 *p++ = Otls_PARAM_construct_utf8_string(Otls_KDF_PARAM_MAC,
                                         "HMAC", 0);
 ...
 *p++ = Otls_PARAM_construct_utf8_string(Otls_KDF_PARAM_CIPHER, "AES256", 0);
 *p++ = Otls_PARAM_construct_utf8_string(Otls_KDF_PARAM_MAC, "CMAC", 0);
 *p++ = Otls_PARAM_construct_utf8_string(Otls_KDF_PARAM_MODE, "FEEDBACK", 0);
 *p++ = Otls_PARAM_construct_octet_string(Otls_KDF_PARAM_KEY,
                                          "secret", strlen("secret"));
 *p++ = Otls_PARAM_construct_octet_string(Otls_KDF_PARAM_SALT,
                                          "label", strlen("label"));
