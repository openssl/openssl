...
As of Opentls 3.0, a new method has been introduced to decide which of
...
Property names fall into two categories: those reserved by the Opentls
...
and underscores.
Property names are case-insensitive, but Opentls will only use lowercase
letters.
...
Properties were added in Opentls 3.0
