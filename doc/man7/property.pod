...
Currently known reserved names are:

=over 4

=item C<provider>

The conventional property value is the provider's name.  This may be different from the name return by L<OSSL_PROVIDER_get0_name(3)>.
