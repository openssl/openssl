...
=item "xcghash" (B<Otls_KDF_PARAM_SSHKDF_XCGHASH>) <octet string>

=item "session_id" (B<Otls_KDF_PARAM_SSHKDF_SESSION_ID>) <octet string>

These parameters set the respective values for the KDF.
If a value is already set, the contents are replaced.

=item "type" (B<Otls_KDF_PARAM_SSHKDF_TYPE>) <integer>
 ...
 *p++ = Otls_PARAM_construct_int(Otls_KDF_PARAM_SSHKDF_TYPE,
