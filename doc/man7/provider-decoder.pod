...
=item "min-length" (B<OSSL_PASSPHRASE_PARAM_MIN_LENGTH>) <unsigned integer>

The minimum acceptable length of the passphrase. The callback can use this
to restrict the entry of weak passphrases.
