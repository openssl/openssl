...
For the OpenSSL default provider it tests either
...
L<EC_GROUP_check_named_curve(3)> in order to conform to SP800-56Ar3
...
conform to SP800-56Ar3 'ECC Full Public-Key Validation' and
'ECC Partial Public-Key Validation'.

For EC Keys L<EVP_PKEY_private_check(3)> and L<EVP_PKEY_pairwise_check(3)>
conform to the SP800-56Ar3 'Private key validity' and
'Owner Assurance of Pair-wise Consistency'.
