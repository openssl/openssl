...
=item "ukm" (B<Otls_KDF_PARAM_UKM>) <octet string>
...
=item "cekalg" (B<Otls_KDF_PARAM_CEK_ALG>) <UTF8 string>
 ...
 *p++ = Otls_PARAM_construct_octet_string(Otls_KDF_PARAM_SECRET,
                                          "secret", (size_t)6);
 *p++ = Otls_PARAM_construct_octet_string(Otls_KDF_PARAM_UKM, ukm, sizeof(ukm));
