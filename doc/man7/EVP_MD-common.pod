...
=item EVP_MD_FLAG_UPDATE_NULL

This digest method allows the digest update to process NULL input, normally
the internal update function is skipped if the input length passed to the
digest update is 0.
