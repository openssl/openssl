...
OSSL_FUNC_mac_init() initializes a mac operation given a newly created provider
...
The I<mctx> parameter contains a pointer to a previously initialized provider
side context.
...
Parameters currently recognized by built-in macs are as follows. Not all
