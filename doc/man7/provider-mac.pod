...
Specifies the number of rounds per message block for SipHash.  By default this
is I<2>.

=item "d-rounds" (B<OSSL_MAC_PARAM_D_ROUNDS>) <unsigned integer>

Specifies the number of finalisation rounds for SipHash.  By default this is
I<4>.
