...
=for openssl multiple includes
 ...
 int OSSL_FUNC_mac_init_opaque(void *mctx, const void *key, const OSSL_PARAM params[]);
...
macros in L<openssl-core_dispatch.h(7)>, as follows:
 ...
 OSSL_FUNC_mac_init_opaque          OSSL_FUNC_MAC_INIT_OPAQUE
...
at least one of OSSL_FUNC_mac_init() and OSSL_FUNC_mac_init_opaque(),
...
OSSL_FUNC_mac_init_opaque() is similar but uses an opaque provider-specific object
...
OSSL_FUNC_mac_init(), OSSL_FUNC_mac_init_opaque(),
...
The function OSSL_FUNC_mac_init_opaque() was introduced in OpenSSL 3.5.
