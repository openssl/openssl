...
For an overview of the OpenSSL source tree layout, see the
B<directory-structure.md> file. This file is available in the source
distribution of OpenSSL in the B<doc> directory.
