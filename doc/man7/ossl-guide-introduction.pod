...
For those contributing to OpenSSL or developing with it, the following resources are available:

=over 4

=item F<directory-structure.md>: An overview of the OpenSSL repository structure

This document explains the major directories and files in the OpenSSL repository, 
helping contributors understand the codebase organization.
