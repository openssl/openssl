...
The base provider also includes the "SEED-SRC" algorithm.
...
The base provider also includes all of these encoding algorithms.  Some of
these may be used in combination with the FIPS provider.
...
The base provider also includes all of these decoding algorithms.  Some of
these may be used in combination with the FIPS provider.
