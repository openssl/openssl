...
=item ML-DSA-65-RSA3072-PKCS15-SHA512, see L<EVP_SIGNATURE-COMPOSITE-ML-DSA(7)>

=item ML-DSA-65-ECDSA-P256-SHA512, see L<EVP_SIGNATURE-COMPOSITE-ML-DSA(7)>
...
=item ML-DSA-65-RSA3072-PKCS15-SHA512, see L<EVP_KEYMGMT-COMPOSITE-ML-DSA(7)>

=item ML-DSA-65-ECDSA-P256-SHA512, see L<EVP_KEYMGMT-COMPOSITE-ML-DSA(7)>
...
B<ML-DSA-65-ECDSA-P256-SHA512> composite signature algorithms was added in
OpenSSL 4.1.
