...
macros in L<openssl-core_numbers.h(7)>, as follows:
 ...
 OP_cipher_gettable_types       OSSL_FUNC_CIPHER_GETTABLE_TYPES
 OP_cipher_gettable_ctx_types   OSSL_FUNC_CIPHER_GETTABLE_CTX_TYPES
 OP_cipher_settable_ctx_types   OSSL_FUNC_CIPHER_SETTABLE_CTX_TYPES
...
OP_cipher_gettable_types(), OP_cipher_gettable_ctx_types(), and
OP_cipher_settable_ctx_types() all return constant B<OSSL_PARAM> arrays
