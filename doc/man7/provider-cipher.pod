...
=for openssl multiple includes
 ...
 int OSSL_FUNC_cipher_decrypt_init(void *cctx, const unsigned char *key,
                                   size_t keylen, const unsigned char *iv,
                                   size_t ivlen, const OSSL_PARAM params[]);
 int OSSL_FUNC_cipher_encrypt_opaque_init(void *cctx, void *skeydata,
...
macros in L<openssl-core_dispatch.h(7)>, as follows:
 ...
 OSSL_FUNC_cipher_encrypt_opaque_init  OSSL_FUNC_CIPHER_ENCRYPT_OPAQUE_INIT
 OSSL_FUNC_cipher_decrypt_opaque_init  OSSL_FUNC_CIPHER_DECRYPT_OPAQUE_INIT
...
OSSL_FUNC_cipher_encrypt_opaque_init() and
OSSL_FUNC_cipher_decrypt_opaque_init() are the variants of the
OSSL_FUNC_cipher_encrypt_init()/OSSL_FUNC_cipher_decrypt_init() working with
opaque objects conataining provider-specific key handles instead of raw bytes.
...
OSSL_FUNC_cipher_encrypt_opaque_init(), OSSL_FUNC_cipher_decrypt_opaque_init(),
...
The OSSL_FUNC_cipher_encrypt_opaque_init() and
OSSL_FUNC_cipher_decrypt_opaque_init() were introduced in OpenSSL 3.5.
