...
macros in L<openssl-core_numbers.h(7)>, as follows:
 ...
 OP_cipher_get_param_types      OSSL_FUNC_CIPHER_GET_PARAM_TYPES
 OP_cipher_ctx_get_param_types  OSSL_FUNC_CIPHER_CTX_GET_PARAM_TYPES
 OP_cipher_ctx_set_param_types  OSSL_FUNC_CIPHER_CTX_SET_PARAM_TYPES
...
OP_cipher_get_param_types(), OP_cipher_ctx_get_param_types(), and
OP_cipher_ctx_set_param_types() all return constant B<OSSL_PARAM> arrays
