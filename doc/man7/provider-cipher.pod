...
Gets the current IV for the associated cipher ctx.

=item B<OSSL_CIPHER_PARAM_ORIGINAL_IV> ("oiv") <octet_string OR octet_ptr>

Gets the Original IV for the associated cipher ctx.
