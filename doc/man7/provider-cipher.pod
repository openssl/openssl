...
OSSL_FUNC_cipher_encrypt_init() initializes a cipher operation for encryption given a
...
a previously initialized cipher operation.
The I<cctx> parameter contains a pointer to a previously initialized provider
side context.
...
context in the I<cctx> parameter that should have been previously initialized via
...
Parameters currently recognized by built-in ciphers are as follows. Not all
