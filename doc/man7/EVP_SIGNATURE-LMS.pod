...
EVP_SIGNATURE-LMS
- The EVP_PKEY B<LMS> and B<HSS> signature implementation

=head1 DESCRIPTION

The B<LMS> EVP_PKEY implementation supports Leighton-Micali Signatures (LMS)
and Hierarchical Signature System (HSS) described in [RFC 8554](https://datatracker.ietf.org/doc/html/rfc8854)
and [SP 800-208](https://csrc.nist.gov/pubs/sp/800/208/final).
The OpenSSL providers only support HSS/LMS signature verification, as this is a
...
functions used for HSS/LMS signatures. Streaming is not currently supported,
...
LMS/HSS support is disabled by default at compile-time.
...
LMS/HSS should only be used for older deployments.
...
=head2 LMS or HSS signature verification
...
OpenSSL 4.0.
Support for HSS was added in OpenSSL 4.1.
