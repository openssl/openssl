...
The FIPS provider support for determinisitic digital signature generation for
ECDSA.
...
Deterministic digital signature generation for ECDSA was added to the FIPS provider in OpenSSL 3.6.
