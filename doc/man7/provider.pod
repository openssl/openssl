...
Fetch any available implementation of SHA2-256 in the default context:
 ...
 EVP_MD *md = EVP_MD_fetch("SHA2-256", NULL, NULL);
 ...
 EVP_MD_meth_free(md);

Fetch any available implementation of AES-128-CBC in the default context:

 EVP_CIPHER *cipher = EVP_CIPHER_fetch("AES-128-CBC", NULL, NULL);
 ...
...
context:
 ...
 EVP_MD *md = EVP_MD_fetch("SHA2-256", NULL, "provider=default");
 ...
 EVP_MD_meth_free(md);
...
context:
 ...
 EVP_MD *md = EVP_MD_fetch("SHA2-256", ctx, "provider=default");
 ...
 EVP_MD_meth_free(md);
...
implementation of WHIRLPOOL from it:
 ...
 EVP_MD *md = EVP_MD_fetch("WHIRLPOOL", NULL, "provider=legacy");
 ...
 EVP_MD_meth_free(md);
...
other providers:
 ...
 EVP_MD *md_whirlpool = EVP_MD_fetch("whirlpool", NULL, NULL);
 EVP_MD *md_sha256 = EVP_MD_fetch("SHA2-256", NULL, NULL);
 ...
