...
OSSL_FUNC_store_delete() deletes the last object from the URI opened by
OSSL_FUNC_store_load(). In case a passphrase needs to be prompted to unlock
an object, I<pw_cb> should be called.
