...
The default Opentls RAND method is based on the RAND_DRBG class,
...
You need to change the default settings of the standard Opentls RAND
...
previous Opentls versions to call RAND_add() before calling RAND_bytes().
...
In most cases Opentls will automatically choose a suitable seed source
