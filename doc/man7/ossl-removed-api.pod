...
=item BIO_sock_cleanup (Deprecated in 1.1.0) - removed, no-op

=item COMP_zlib_cleanup (Deprecated in 1.1.0) - removed, no-op

=item CONF_modules_free (Deprecated in 1.1.0) - removed, no-op

=item CRYPTO_cleanup_all_ex_data (Deprecated in 1.1.0) - removed, no-op

=item ENGINE_cleanup (Deprecated in 1.1.0) - removed, no-op

=item ERR_free_strings (Deprecated in 1.1.0) - removed, no-op
...
=item EVP_cleanup (Deprecated in 1.1.0) - removed, no-op
...
=item OBJ_cleanup (Deprecated in 1.1.0) - removed, no-op

=item OPENSSL_atexit - No longer used, use libc atexit() if you must use this.

=item RAND_cleanup (Deprecated in 1.1.0) - removed, no-op

=item SSL_COMP_free_compression_methods (Deprecated in 1.1.0) - removed, no-op
