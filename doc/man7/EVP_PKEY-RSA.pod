...
For RSA keys L<EVP_PKEY_public_check(3)> conforms to the SP800-56Br1 public key
...
For RSA keys L<EVP_PKEY_private_check(3)> conforms to the SP800-56Br1 private key
test.

For RSA keys L<EVP_PKEY_pairwise_check(3)> conforms to the
SP800-56Br1 KeyPair Validation check for the OpenSSL fips provider. The
