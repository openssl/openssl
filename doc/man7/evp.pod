...
Providers can supply implementations for a wide range of cryptographic operations,
including symmetric algorithms (ciphers), digests, asymmetric algorithms (public key algorithms),
key management, parameter generation, and more.
For more information, consult the provider(7) man page.
