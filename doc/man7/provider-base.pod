...
provider):
 ...
 OBJ_add_sigid                  OSSL_FUNC_OBJ_ADD_SIGID
 OBJ_create                     OSSL_FUNC_OBJ_CREATE
 OBJ_txt2nid                    OSSL_FUNC_OBJ_TXT2NID
 OBJ_sn2nid                     OSSL_FUNC_OBJ_SN2NID
 OBJ_ln2nid                     OSSL_FUNC_OBJ_LN2NID
...
OPENSSL_hexstr2buf(), OBJ_add_sigid(), OBJ_create(), OBJ_txt2nid(), OBJ_sn2nid()
and OBJ_ln2nid() correspond exactly to the public functions with
