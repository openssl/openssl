...
F<libcrypto>):
 ...
 provider_get_capabilties       OSSL_FUNC_PROVIDER_GET_CAPABILITIES
...
The provider_get_capabilties() function should call the callback I<cb> passing
...
passed in through the provider_get_capabilties function. Each group should have
