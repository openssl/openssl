...
F<libcrypto>):
 ...
 ossl_prov_get_capabilities     OSSL_FUNC_PROVIDER_GET_CAPABILITIES
...
The ossl_prov_get_capabilities() function should call the callback I<cb> passing
...
passed in through the ossl_prov_get_capabilities function. Each group should have
