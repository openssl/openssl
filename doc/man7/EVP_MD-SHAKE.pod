...
For CSHAKE, it may be set as a UTF8 string with a length of at most 512
bytes. For KangarooTwelve, it may be set as an octet string with a length of
at most 512 bytes. It is empty by default.
...
TURBOSHAKE-128, TURBOSHAKE-256, KT-128, and KT-256 were added in OpenSSL 4.2.
