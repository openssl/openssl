...
=head1 SYNOPSIS
 ...
 int OSSL_FUNC_encoder_does(void *provctx, int selection);
...
macros in L<openssl-core_dispatch.h(7)>, as follows:
 ...
 OSSL_FUNC_encoder_does                OSSL_FUNC_ENCODER_DOES
...
OSSL_FUNC_encoder_does() should tell if a particular implementation supports
any of the combinations given by I<selection>.
...
OSSL_FUNC_encoder_does() returns 1 if the encoder implementation supports
any of the I<selection> bits, otherwise 0.
