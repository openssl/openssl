...
- The EVP_PKEY B<SLH-DSA> signature implementation

=head1 DESCRIPTION

The B<SLH-DSA-SHA2-128s>, B<SLH-DSA-SHA2-128f>,
B<SLH-DSA-SHA2-192s>, B<SLH-DSA-SHA2-192f>,
B<SLH-DSA-SHA2-256s>, B<SLH-DSA-SHA2-256f>,
B<SLH-DSA-SHAKE-128s>, B<SLH-DSA-SHAKE-128f>,
B<SLH-DSA-SHAKE-192s>, B<SLH-DSA-SHAKE-192f>,
B<SLH-DSA-SHAKE-256s> and B<SLH-DSA-SHAKE-256f> EVP_PKEY implementations
support key generation, one-shot sign and verify using the SLH-DSA
