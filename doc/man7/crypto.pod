...
crypto - Opentls cryptographic library
...
The Opentls crypto library (C<libcrypto>) implements a wide range of
cryptographic algorithms used in various Internet standards. The services
provided by this library are used by the Opentls implementations of tls, TLS
