...
=head1 SYNOPSIS
 ...
 void *OSSL_FUNC_skeymgmt_generate(void *provctx,
                                   const OSSL_PARAM params[]);
 OSSL_PARAM *OSSL_FUNC_skeymgmt_gen_settable_params(void *provctx);
 OSSL_PARAM *OSSL_FUNC_skeymgmt_imp_settable_params(void *provctx);
...
OSSL_FUNC_skeymgmt_get_key_id() returns a 0-terminated string identifying the
