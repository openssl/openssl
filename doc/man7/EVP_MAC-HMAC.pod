...
Set the status for strict compliance. The value 0 or 1 is expected.
If set to 0, the operation is not approved unless related standard defines it
can be used for legacy use.
...
Get the status for strict compliance. If the value is 0, the operation is not
approved unless related standard defines it can be used for legacy use.
