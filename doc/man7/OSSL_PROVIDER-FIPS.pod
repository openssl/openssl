...
=item "tls1-prf-ems-check" (B<OSSL_PROV_PARAM_TLS1_PRF_EMS_CHECK>) <unsigned integer>

For further information refer to the L<openssl-fipsinstall(1)> options for
B<-no_security_checks> and B<-ems_check>.
