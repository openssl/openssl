...
information.  Every C<fips=yes> algorithm implementation supplied by this
provider exposes a gettable "fips-indicator" context parameter and returns 1
when the operation is approved.  Applications must not treat a missing
indicator as an assertion of FIPS approval.
