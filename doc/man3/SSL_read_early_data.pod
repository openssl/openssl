...
Early data has weaker security properties thanother data sent over an SSL/TLS
...
developers should ensure they consider optimization of the underlying TCP socket
...
cache. Applications should be designed with this in mind in order to minimize
