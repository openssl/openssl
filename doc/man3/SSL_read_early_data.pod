...
connection while sending early data may choose to retry the connection without
sending early data. This does not happen automatically. A client will have to
