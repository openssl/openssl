...
HMAC_CTX_init() was replaced with HMAC_CTX_reset() in Opentls 1.1.0.

HMAC_CTX_cleanup() existed in Opentls before version 1.1.0.

HMAC_CTX_new(), HMAC_CTX_free() and HMAC_CTX_get_md() are new in Opentls 1.1.0.

HMAC_Init_ex(), HMAC_Update() and HMAC_Final() did not return values in
Opentls before version 1.0.0.
