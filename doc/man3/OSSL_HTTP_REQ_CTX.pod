...
OSSL_HTTP_i2d_new_bio,
OSSL_HTTP_d2i_consume_bio,
OSSL_HTTP_is_alive
...
=head1 SYNOPSIS
 ...
 BIO *OSSL_HTTP_i2d_new_bio(const ASN1_ITEM *it, const ASN1_VALUE *val);
...
OSSL_HTTP_d2i_consume_bio() returns a pointer to a B<ASN1_VALUE>, or NULL on error.
