...
=head1 THE RAND_METHOD STRUCTURE
 ...
 typedef struct rand_meth_st {
     ...
     void (*cleanup)(void);
     int (*add)(const void *buf, int num, int randomness);
...
The seed and add members of RAND_METHOD can return 1 on success or 0 on failure,
although error codes are not currently passed through the corresponding
RAND_seed() and RAND_add() functions.
