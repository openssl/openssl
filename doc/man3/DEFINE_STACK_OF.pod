...
OPENSSL_sk_pop_free, OPENSSL_sk_pop_free_thunk, OPENSSL_sk_push,
OPENSSL_sk_reserve, OPENSSL_sk_set, OPENSSL_sk_set_thunks,
OPENSSL_sk_set_cmp_func, OPENSSL_sk_shift, OPENSSL_sk_sort, OPENSSL_sk_unshift,
...
OPENSSL_sk_pop_free_thunk(), OPENSSL_sk_push(), OPENSSL_sk_reserve(),
OPENSSL_sk_set(), OPENSSL_sk_set_cmp_func(), OPENSSL_sk_set_thunks(),
OPENSSL_sk_shift(), OPENSSL_sk_sort(), OPENSSL_sk_unshift(), OPENSSL_sk_value(),
OPENSSL_sk_zero().

OPENSSL_sk_set_thunks() and OPENSSL_sk_pop_free_thunk(), while public by
...
OPENSSL_sk_set_thunks() and OPENSSL_sk_pop_free_thunk() were added in
OpenSSL 3.6.0.
