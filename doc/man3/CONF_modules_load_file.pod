...
CONF_modules_load_file, CONF_modules_load - Opentls configuration functions
...
The function CONF_modules_load_file() configures Opentls using file
B<filename> and application name B<appname>. If B<filename> is NULL
the standard Opentls configuration file is used. If B<appname> is
NULL the standard Opentls application name B<opentls_conf> is used.
...
returns success.
This is used by default in L<OPENtls_init_crypto(3)> to ignore any errors in
the default system-wide configuration file, as having all Opentls applications
...
default section pointed to by B<opentls_conf> if B<appname> does not exist.
...
Copyright 2004-2017 The Opentls Project Authors. All Rights Reserved.
