...
recently loadded configuration file perturbs prior settings in other library
contexts.
...
late customisation of SSL contexts and connection handles after default
configuration via the module's B<system_default> section, while using a single
library context and configuration file.
