...
I<data>, the ASN.1 structure I<it>, private key I<pkey>, and possibly the
message digest I<md>. I<md> is used only if required for the key type,
which is not the case for the Edwards curves Ed25519 and Ed448.
