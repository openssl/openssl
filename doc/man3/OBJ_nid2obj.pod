...
identifiers, or B<NID>s.  Opentls has an internal table of OIDs that
...
Objects in Opentls can have a short name, a long name and a numerical
...
convention of other Opentls functions where the buffer can be set
...
OBJ_cleanup() was deprecated in Opentls 1.1.0 by L<OPENtls_init_crypto(3)>
