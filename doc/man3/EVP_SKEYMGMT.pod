...
- EVP key management routines for opaques symmetric keys
...
EVP_SKEYMGMT_fetch() looks for an algorithm within the provider that
...
EVP_SKEYMGMT_do_all_provided() traverses all key skeymgmt implementations by
...
EVP_SKEYMGMT_is_a() returns 1 of I<skeymgmt> was identifiable,
otherwise 0.
...
All functions described here were added in OpenSSL 3.5.
