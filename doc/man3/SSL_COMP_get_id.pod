...
In versions of OpenSSL prior to 1.1.0 SSL_COMP_free_compression_methods();
in OpenSSL 1.1.0 or later, this function does nothing.
...
SSL_COMP_add_compression_method() is no longer supported in OpenSSL 1.1.0;
adding compression methods at run-time is not possible.
