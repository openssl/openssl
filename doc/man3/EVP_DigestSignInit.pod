...
Ignoring failure of EVP_DigestSignInit() and EVP_DigestSignInit_ex() functions
can lead to subsequent undefined behavior when calling EVP_DigestSignUpdate(),
EVP_DigestSignFinal(), or EVP_DigestSign().
