...
offers an implementation optimized for use with NIST recommended curves (NIST curves are available through
...
optimized implementations for the NIST P224, P256 and P521 curves respectively. Note, however, that these
