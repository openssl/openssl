...
B<name>, clearing any previously specified hostname.
If B<name> is NULL or empty, the list of hostnames is cleared, and
...
TLS clients are recommended to use this function or X509_VERIFY_PARAM_add1_host()
