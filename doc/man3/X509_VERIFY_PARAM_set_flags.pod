...
X509_VERIFY_PARAM_set1_ocsp_verify_other,
X509_VERIFY_PARAM_get0_ocsp_verify_other
...
X509_VERIFY_PARAM_set1_ocsp_verify_other() sets the certificates used to
check OCSP responses which does not include the signer certificate and
were not signed by the issuing Certificate Authority (CA).

X509_VERIFY_PARAM_get0_ocsp_verify_other() get the certificates to
check OCSP responses which does not include the signer certificate and
were not signed by the issuing Certificate Authority (CA).
...
X509_VERIFY_PARAM_set1_ocsp_verify_other()return 1 for success and 0 for
failure.
...
X509_VERIFY_PARAM_get0_ocsp_verify_other() returns the additional signer
...
The functions X509_VERIFY_PARAM_set1_ocsp_verify_other() and
X509_VERIFY_PARAM_get0_ocsp_verify_other() were added in OpenSSL 4.0
