...
X509_VERIFY_PARAM_set_eku() sets the Extended Key Usage (EKU) in I<param> to I<nid>.
...
It determines the acceptable EKU for the certificate chain to be verified.
