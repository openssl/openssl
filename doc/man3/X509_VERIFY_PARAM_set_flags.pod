...
Yet if in the resulting flags B<X509_VP_FLAG_LOCKED> is set, it just
...
to I<purpose>. This determines the acceptable use of the certificate
...
X509_VERIFY_PARAM_get0_name() returns a string pointer
or NULL if the value has not been set or on error.
