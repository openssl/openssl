...
X509_VERIFY_PARAM_set1_ocsp_extra_untrusted,
X509_VERIFY_PARAM_get0_ocsp_extra_untrusted
...
X509_VERIFY_PARAM_set1_ocsp_extra_untrusted() sets further certificates used to
check OCSP responses that does not include the needed signer certificate
or intermediate CA certificates.

X509_VERIFY_PARAM_get0_ocsp_extra_untrusted() gets the certificates
that were set using X509_VERIFY_PARAM_set1_ocsp_extra_untrusted().
...
X509_VERIFY_PARAM_set1_email(),
X509_VERIFY_PARAM_set1_ip(), X509_VERIFY_PARAM_add1_ip(),
X509_VERIFY_PARAM_set1_ip_asc(), X509_VERIFY_PARAM_add1_ip_asc() and
X509_VERIFY_PARAM_set1_ocsp_extra_untrusted() return 1 for success and 0 for
failure.
...
X509_VERIFY_PARAM_get0_ocsp_extra_untrusted() returns the additional signer
certificates for checking OCSP responses.
...
The functions X509_VERIFY_PARAM_set1_ocsp_extra_untrusted() and
X509_VERIFY_PARAM_get0_ocsp_extra_untrusted() were added in OpenSSL 4.1.
