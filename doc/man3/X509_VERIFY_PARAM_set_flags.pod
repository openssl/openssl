...
B<X509_V_FLAG_CHECK_SS_SIGNATURE> requests checking the self-signature of
a self-issued root CA or end entity certificate at the end of certificate
chains (unless key usage restrictions in the certificate prohibit this).
