...
whether initialization has been completed for this BIO or not. A nonzero value
indicates that initialization is complete, whilst zero indicates that it is not.
Often initialization will complete during initial construction of the BIO. For
some BIOs however, initialization may not complete until after additional steps
