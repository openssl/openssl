...
OPENtls_s390xcap - the IBM z processor capabilities vector

=head1 SYNOPSIS

 env OPENtls_s390xcap=... <application>
...
set the B<OPENtls_s390xcap> environment variable before you start the
...
Disables all instruction set extensions which the z196 processor does not implement:
 ...
 OPENtls_s390xcap="z196"

Disables the vector facility:

 OPENtls_s390xcap="stfle:~0:~0:~0x4000000000000000"

Disables the KM-XTS-AES and and the KIMD-SHAKE function codes:

 OPENtls_s390xcap="km:~0x2800:~0;kimd:~0xc000000:~0"
