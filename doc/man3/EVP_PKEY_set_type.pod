...
EVP_PKEY_set_type() initializes I<pkey> to contain an internal legacy
...
EVP_PKEY_set_type_str() initializes I<pkey> to contain an internal legacy
key. When doing this, it finds a L<EVP_PKEY_ASN1_METHOD(3)>
...
EVP_PKEY_set_type_by_keymgmt() initializes I<pkey> to contain an
internal provider side key.  When doing this, it associates I<pkey>
with I<keymgmt>.  For keys initialized like this, the numeric type
