...
fall-back.
See L<OSSL_PROVIDER-default(7)> for more information on this fall-back
behaviour.
...
OSSL_PROVIDER_do_all() returns 1 if all callback functions return 1, or 0 if
any callback I<cb> returns 0; callback processing is stopped if a first
callback returns 0.
