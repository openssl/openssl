...
=head1 SYNOPSIS
 ...
 void OSSL_SELF_TEST_set_callback(OSSL_CTX *ctx, OSSL_CALLBACK *cb, void *cbarg);
 void OSSL_SELF_TEST_get_callback(OSSL_CTX *ctx, OSSL_CALLBACK **cb, void **cbarg);

=head1 DESCRIPTION

Set or gets the optional application callback (and the callback argument) that
is called during self testing.
The application callback B<OSSL_CALLBACK> is associated with a B<OSSL_CTX>.
