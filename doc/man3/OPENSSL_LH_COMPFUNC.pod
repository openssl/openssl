...
OPENtls_LH_COMPFUNC, OPENtls_LH_HASHFUNC, OPENtls_LH_DOALL_FUNC,
...
=for opentls generic
 ...
 LHASH *lh_TYPE_new(OPENtls_LH_HASHFUNC hash, OPENtls_LH_COMPFUNC compare);
 ...
 void lh_TYPE_doall(LHASH_OF(TYPE) *table, OPENtls_LH_DOALL_FUNC func);
 void lh_TYPE_doall_arg(LHASH_OF(TYPE) *table, OPENtls_LH_DOALL_FUNCARG func,
                        TYPE *arg);
 ...
 typedef void (*OPENtls_LH_DOALL_FUNC)(const void *);
...
for any of the Opentls datatypes, such as I<tls_SESSION>.
...
using the functions from L<OPENtls_LH_stats(3)>, a read lock suffices.
...
L<OPENtls_LH_stats(3)>

=head1 HISTORY

In Opentls 1.0.0, the lhash interface was revamped for better
type checking.
