...
specific. So instead of returning an LHASH_OF(TYPE) value it returns a void *.
...
are implemented as type checked wrappers around the OPENSSL_LH functions. Most
