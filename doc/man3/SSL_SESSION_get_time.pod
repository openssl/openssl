...
SSL_SESSION_set_time_ex(), SSL_SESSION_get_time_ex(),
SSL_SESSION_get_timeout_ex(), and SSL_SESSION_set_timeout_ex()
use B<time_t> to represent time.
