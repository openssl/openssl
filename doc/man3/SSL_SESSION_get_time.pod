...
SSL_SESSION_get_timeout_ex,
SSL_SESSION_set_timeout_ex,
...
=head1 SYNOPSIS
 ...
 int SSL_SESSION_set_timeout_ex(SSL_SESSION *s, time_t tm);
...
SSL_SESSION_get_timeout_ex(), and SSL_SESSION_set_timeout_t() functions are
...
SSL_SESSION_get_time_ex(),
SSL_SESSION_set_time_ex(),
SSL_SESSION_get_timeout_ex(), and
SSL_SESSION_set_timeout_ex()
