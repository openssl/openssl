...
=head1 SYNOPSIS
 ...
 int SSL_SESSION_set_timeout_update_cache(const SSL *ssl, long tm);
...
referencerd by B<ssl> in in seconds to B<tm>, and ensures that the any 
