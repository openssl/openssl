...
OSSL_PARAM_locate, OSSL_PARAM_get_TYPE, OSSL_PARAM_set_TYPE,
OSSL_PARAM_get_BN, OSSL_PARAM_set_BN
- OSSL_PARAM helpers
...
OSSL_PARAM_SIZED_BN() is a macro that provides support for defining large
integers in an OSSL_PARAM array.
