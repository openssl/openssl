...
OPENSSL_CTX_get0_primary_drbg() returns a pointer to the I<primary> DRBG instance
...
be NULL in which case the default OPENSSL_CTX is used. RAND_DRBG_get0_primary(),
