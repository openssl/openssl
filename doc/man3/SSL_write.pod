...
=head1 SYNOPSIS
 ...
 int SSL_writev_ex2(SSL *s, const struct ossl_iovec *iov, size_t iovcnt,
                   uint64_t flags,
                   size_t *written);
 int SSL_writev_ex(SSL *s, const struct ossl_iovec *iov, size_t iovcnt,
                  size_t *written);
 int SSL_writev(SSL *ssl, const struct ossl_iovec *iov, int iovcnt);
...
The definition of the B<ossl_iovec> structure is included above.
