...
the write function operation. The behavior of the write functions depends on the
underlying BIO.
...
B<buf> of length B<num> has been written. This default behavior can be changed
