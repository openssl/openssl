...
=head1 SYNOPSIS
 ...
 int SSL_write(SSL *ssl, const void *buf, int num);
  int SSL_write_ex2(SSL *s, const struct ossl_iovec *iov, size_t iovcnt,
                   uint64_t flags,
                   size_t *written);
 int SSL_write_ex(SSL *s, const struct ossl_iovec *iov, size_t iovcnt,
                  size_t *written);
 int SSL_write(SSL *ssl, const struct ossl_iovec *iov, int iovcnt);
