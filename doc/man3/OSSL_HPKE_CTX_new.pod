...
Encryption (HPKE) defined in RFC9180 as well as Post Quantum algorithms.
Understanding the HPKE specification is likely required before using these APIs.
HPKE is used by various other IETF specifications, including the TLS Encrypted
...
=item 0x40 B<OSSL_HPKE_KEM_ID_ML_KEM_512>

=item 0x41 B<OSSL_HPKE_KEM_ID_ML_KEM_768>

=item 0x42 B<OSSL_HPKE_KEM_ID_ML_KEM_1024>

=item 0x50 B<OSSL_HPKE_KEM_ID_MLKEM768_P256>

=item 0x51 B<OSSL_HPKE_KEM_ID_MLKEM1024_P384>

=item 0x647A B<OSSL_HPKE_KEM_ID_XWING>
...
Authentication is not used. Post Quantum algorithms only use this mode.
...
=item https://datatracker.ietf.org/doc/rfc9180/
...
Support for Post Quantum algorithms B<OSSL_HPKE_KEM_ID_ML_KEM_512>,
B<OSSL_HPKE_KEM_ID_ML_KEM_768>, B<OSSL_HPKE_KEM_ID_ML_KEM_1024>,
B<OSSL_HPKE_KEM_ID_MLKEM768_P256>, B<OSSL_HPKE_KEM_ID_MLKEM1024_P384> and
B<OSSL_HPKE_KEM_ID_XWING> were added in OpenSSL 4.1.
