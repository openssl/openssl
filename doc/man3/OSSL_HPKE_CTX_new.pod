...
The X-Wing KEM combines ML-KEM-768 and X25519.  Its encapsulated key is
1120 bytes and its public key is 1216 bytes.  X-Wing supports the base and
PSK modes, but not the sender-authenticated modes.
