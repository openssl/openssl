...
Switches on or off replay protection respectively. With replay protection on,
...
is only used by servers. Anti-replay measures are required to comply with the
TLSv1.3 specification. Some applications may be able to mitigate the replay
