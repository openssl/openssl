...
Enables support for TLSv1.3 certificate compression, same as clearing
B<SSL_OP_NO_CERTIFICATE_COMPRESSION>.
This command was introduced in OpenSSL 3.1.0.

=item B<-no_cert_comp>

Disables support for TLSv1.3 certificate compression, same as setting
B<SSL_OP_NO_CERTIFICATE_COMPRESSION>.
