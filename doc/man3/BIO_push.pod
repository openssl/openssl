...
BIO_push() function prepends the BIO I<b>, which may be a chain of BIOs,
to I<next> and returns I<b>.  In other words, it pushes I<b> on I<next>.
I<next> may be NULL, which means that nothing is appended to I<b>.
If I<b> is NULL the function does nothing and returns I<next>.

BIO_pop() removes the BIO I<b> from a chain and returns the next BIO
