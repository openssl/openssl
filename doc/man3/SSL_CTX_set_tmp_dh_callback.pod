...
values. To do so they should call SSL_CTX_set0_tmp_dh_pkey() or
...
DH parameters are supplied in a B<DH> object instead in the I<dh> argument.
Applications should use "auto" parameters instead, or call
...
return the parameters to be used in a DH object.
