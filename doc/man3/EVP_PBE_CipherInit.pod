...
EVP_PBE_alg_add_type() and EVP_PBE_alg_add() add an algorithm to the list of known algorithms.
Their parameters have the same meaning as for PBE algorithm search functions.
