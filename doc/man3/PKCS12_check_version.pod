...
As this version number was not previously checked on loading,
...
PKCS12_check_version() should be called after loading a PKCS #12
...
PKCS12_check_version() was added in OpenSSL 4.1.
