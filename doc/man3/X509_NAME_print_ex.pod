...
X509_NAME_print() prints out I<name> to I<bp>. Multiple lines are used if the output exceeds
80 characters. I<obase> is a legacy varibale that is unused in current versions of OpenSSL.
