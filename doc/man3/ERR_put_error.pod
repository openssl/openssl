...
ERR_raise, ERR_raise_data, CRYPTO_malloc_with_err,
CRYPTO_realloc_with_err, CRYPTO_clear_realloc_with_err,
...
CRYPTO_malloc_with_err(), CRYPTO_realloc_with_err(), and
CRYPTO_clear_realloc_with_err() are meant to be used only internally.

CRYPTO_malloc_with_err() calls I<(*fn)(num, file, line)>
...
CRYPTO_realloc_with_err() is like CRYPTO_malloc_with_err()
but calls I<CRYPTO_realloc(addr, num, file, line)>.

CRYPTO_clear_realloc_with_err() is like CRYPTO_malloc_with_err()
...
CRYPTO_malloc_with_err(), CRYPTO_realloc_with_err(), and
CRYPTO_clear_realloc_with_err() return whatever the underlying
...
CRYPTO_malloc_with_err(), CRYPTO_realloc_with_err(), and
CRYPTO_clear_realloc_with_err() were added in OpenSSL 3.1.
