...
The connect BIO supports the following ctrls via the L<BIO_ctrl(3)> function:

=over 4
=item <BIO_CTRL_RESET>

=item <BIO_C_DO_STATE_MACHINE>

=item <BIO_C_GET_CONNECT>

=item <BIO_C_SET_CONNECT>

=item <BIO_C_SET_NBIO>

=item <BIO_C_SET_CONNECT_MODE>
...
=item <BIO_CTRL_SET_CALLBACK>

=item <BIO_CTRL_GET_CALLBACK>

=item BIO_CTRL_EOF>

=item <BIO_CTRL_SET_KTLS>

=item <BIO_CTRL_GET_KTLS_SEND>

=item <BIO_CTRL_GET_KTLS_RECV>

=item <BIO_CTRL_SET_KTLS_TX_SEND_CTRL_MSG>

=item <BIO_CTRL_CLEAR_KTLS_TX_CTRL_MSG>
