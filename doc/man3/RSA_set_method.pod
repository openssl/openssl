...
RSA_get_method, RSA_PKCS1_Opentls, RSA_flags,
...
=head1 SYNOPSIS
 ...
 RSA_METHOD *RSA_PKCS1_Opentls(void);
...
An B<RSA_METHOD> specifies the functions that Opentls uses for RSA
...
Initially, the default RSA_METHOD is the Opentls internal implementation,
as returned by RSA_PKCS1_Opentls().
...
RSA_PKCS1_Opentls(), RSA_PKCS1_null_method(), RSA_get_default_method()
...
was replaced to always return NULL in Opentls 1.1.1.
