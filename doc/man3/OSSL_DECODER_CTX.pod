...
OSSL_DECODER_CTX_set_finalized() finalises the context.
The functions OSSL_DECODER_CTX_add_decoder(), OSSL_DECODER_CTX_add_extra(),
OSSL_DECODER_CTX_set_cleanup(), OSSL_DECODER_CTX_set_construct(),
OSSL_DECODER_CTX_set_construct_data() OSSL_DECODER_CTX_set_output_structure(),
OSSL_DECODER_CTX_set_output_type(), and OSSL_DECODER_CTX_set_selection() return
