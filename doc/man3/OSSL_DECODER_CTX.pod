crypto: function OSSL_DECODER_CTX_set_input_structure(3) undocumented

crypto: function OSSL_DECODER_CTX_set_selection(3) undocumented

crypto: function OSSL_DECODER_INSTANCE_get_input_structure(3) undocumented
=pod
...
structure for the encoder method from a encoder instance I<encoder_inst>.
This may be NULL.
