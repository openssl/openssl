...
reinitialised by calling BIO_reset(), or BIO_set_md() before any more
...
Calling BIO_get_md_ctx() will return the context and initialise the BIO
state. This allows applications to initialise the context externally
