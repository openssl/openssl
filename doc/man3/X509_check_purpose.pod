...
X509_check_purpose() uses the internal B<ossl_x509v3_cache_extensions()>
function to fill in various internal fields of the certificate structure I<x>.
This is why its I<x> argument cannot be of type I<const X509 *>.
