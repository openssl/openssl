...
These functions in fact utilise the underlying B<memcmp> of the C library to do
...
X509_NAME_cmp() and wrappers utilise the value B<-2> to indicate errors in some
