...
(B<primary_reseed_time_interval> and B<secondary_reseed_time_interval>)
of DRBG instances.
The default values are set independently for primary DRBG instances,
which don't have a primary, and secondary DRBG instances, which are chained
to a primary DRBG.
...
trusted os entropy source or from a primary DRBG instance, which was seeded
...
(I<primary>, and I<public> or I<private>), it is necessary to call
