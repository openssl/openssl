...
The returned object, including a provider-defined ciphersuite, is maintained
by B<ssl> and must not be released.
...
The returned object is maintained by B<ssl> and must not be released.
...
Provider-defined TLS 1.3 ciphersuites became visible through these functions
in OpenSSL 4.1.
