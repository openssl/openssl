...
disabling the warnings with compiler specific directives, but may be
...
may be removed in later major OpenSSL releases, at which point the
use of these macros will not save you.
