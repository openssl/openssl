...
tls_alert_type_string, tls_alert_type_string_long, tls_alert_desc_string, tls_alert_desc_string_long - get textual description of alert information

=head1 SYNOPSIS

 #include <opentls/tls.h>

 const char *tls_alert_type_string(int value);
 const char *tls_alert_type_string_long(int value);

 const char *tls_alert_desc_string(int value);
 const char *tls_alert_desc_string_long(int value);

=head1 DESCRIPTION

tls_alert_type_string() returns a one letter string indicating the
type of the alert specified by B<value>.

tls_alert_type_string_long() returns a string indicating the type of the alert
specified by B<value>.

tls_alert_desc_string() returns a two letter string as a short form
describing the reason of the alert specified by B<value>.

tls_alert_desc_string_long() returns a string describing the reason
of the alert specified by B<value>.

=head1 NOTES

When one side of an tls/TLS communication wants to inform the peer about
...
The following strings can occur for tls_alert_type_string() or
tls_alert_type_string_long():
...
The following strings can occur for tls_alert_desc_string() or
tls_alert_desc_string_long():
...
L<tls(7)>, L<tls_CTX_set_info_callback(3)>
