...
=head1 SYNOPSIS
 ...
 int X509_VERIFY_PARAM_add1_ip_asc(X509_VERIFY_PARAM *param,
                                   const char *ip_asc);
 char *X509_VERIFY_PARAM_get1_ip_asc(X509_VERIFY_PARAM *param, int n);
...
X509_VERIFY_PARAM_get1_ip_asc() returns a string containing the I<n>th
...
The signature for X509_VERIFY_PARAM_get1_ip_asc() changed to add a index
parameter in Openssl 4.1.
