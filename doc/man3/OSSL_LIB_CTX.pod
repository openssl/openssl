...
OSSL_LIB_CTX_freeze_method_store
...
=head1 SYNOPSIS
 ...
 void *OSSL_LIB_CTX_freeze_method_store(OSSL_LIB_CTX *ctx);
...
OSSL_LIB_CTX_freeze_method_store() returns 1 on success, 0 on error. A frozen library context
...
OSSL_LIB_CTX_freeze_method_store() was introduced in OpenSSL 4.0.
