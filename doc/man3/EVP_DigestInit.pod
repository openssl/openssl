...
=item "n" (B<OSSL_DIGEST_PARAM_N>)<UTF8 string>

Sets the function name string. By default this is an empty string.
It is used by L<EVP_MD-CSHAKE(7)>.

=item "s" (B<OSSL_DIGEST_PARAM_S>)<UTF8 string>

Sets a customisation string. By default this is an empty string.
It is used by L<EVP_MD-CSHAKE(7)>.
