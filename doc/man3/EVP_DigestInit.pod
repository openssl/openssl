...
It may be used by B<BLAKE2B-512>, B<SHAKE-128> and B<SHAKE-256> to set the
output length used by EVP_DigestFinal_ex() and EVP_DigestFinal().
"xoflen" should not be used for the fixed output shake algorithms which
includes B<SHAKE-128/256>, B<SHAKE-256/512>, B<SHAKE-256/192> and
B<SHAKE-256/256>.
