...
made, but further calls to EVP_DigestFinalXOF can be made to squeeze more
output from the function. Further, EVP_DigestInit_ex() can still be
called to initialize a new operation.
