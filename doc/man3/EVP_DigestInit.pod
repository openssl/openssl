...
Returns 1 if I<md> is an Extendable-output Function (XOF) otherwise it returns 0.
SHAKE-128, SHAKE-256, CSHAKE-128, CSHAKE-256, TUPLEHASH-128 and TUPLEHASH-256 are
XOF functions.
...
It may be used by SHAKE-128, CSHAKE-128, TUPLEHASH-128, SHAKE-256, CSHAKE-256
and TUPLEHASH-256 to set the output length used by EVP_DigestFinal_ex() and
EVP_DigestFinal().
...
It is used by L<EVP_MD-CSHAKE(7)> and L<EVP_MD-TUPLEHASH(7)>.
