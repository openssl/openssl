...
EVP_KDF_settable_ctx_params() get a constant B<Otls_PARAM> array that
...
=item "cipher" (B<Otls_KDF_PARAM_CIPHER>) <UTF8 string>
...
=item "maclen" (B<Otls_KDF_PARAM_MAC_SIZE>) <unsigned integer>
...
=item "maxmem_bytes" (B<Otls_KDF_PARAM_SCRYPT_MAXMEM>) <unsigned integer>
