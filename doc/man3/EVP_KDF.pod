...
The KDF lifecycle is defined by this diagram:
                     ...
                     + - - - - - - - - - +  |
                       |                    |
                       | EVP_KDF_derive     | EVP_KDF_CTX_reset
                       v                    |
    EVP_KDF_derive   +-------------------+  |
  + - - - - - - - -  |                   |  |
  '                  |     deriving      |  |
...
In the future, the transitions illustrated will be enforced.
When this is done, it will not be considered a breaking change to the API.
