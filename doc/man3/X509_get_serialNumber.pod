...
X509_get_issuer_serial() returns the entire IssuerSerial structure from the
I<baseCertificateId> field of the I<issuer> field of the attribute certificate,
if it is present, returning NULL otherwise.
