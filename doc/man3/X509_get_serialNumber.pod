...
X509_get_issuer_serial() returns a pointer to the entire IssuerSerial structure
from the I<baseCertificateId> field of the I<issuer> field of the attribute
certificate, if the structure is present, or returning NULL otherwise.
