...
Sessions that have used a provider-defined ciphersuite do not issue tickets,
regardless of these settings. SSL_new_session_ticket() returns 0 for such
sessions; see L<provider-base(7)>.
