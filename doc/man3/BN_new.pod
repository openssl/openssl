...
L<OPENtls_secure_malloc(3)> is used to store the value.
...
L<ERR_get_error(3)>, L<OPENtls_secure_malloc(3)>

=head1 HISTORY

BN_init() was removed in Opentls 1.1.0; use BN_new() instead.
