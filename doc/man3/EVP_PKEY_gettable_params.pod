...
EVP_PKEY_get_uint64_param() retrieves a key I<pkey> unit64_t value I<*out>
associated with a name of I<key_name> if it fits into C<uint64_t> type. For
parameters that do not fit into C<uint64_t> use EVP_PKEY_get_bn_param().
...
The function EVP_PKEY_get_uint64_param() was added in OpenSSL 3.5.
