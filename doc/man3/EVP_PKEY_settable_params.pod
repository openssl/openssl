...
EVP_PKEY_set_int_param, EVP_PKEY_set_size_t_param, EVP_PKEY_set_uint64_param,
...
EVP_PKEY_set_uint64_param() sets an uint64_t value I<in> into a key I<pkey> for
the associated field I<key_name>.
...
The function EVP_PKEY_set_uint64_param() was added in OpenSSL 3.5.
All other functions were added in OpenSSL 3.0.
