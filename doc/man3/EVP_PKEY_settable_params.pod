...
EVP_PKEY_gettable_params() and EVP_PKEY_settable_params()
return a constant L<OSSL_PARAM(3)> array on success or NULL on error,
which may mean that the operation is not supported.
