...
=head2 Creating an ECC keypair using raw key data
 ...
 /*
  * Fix data to represent the private and public key.  The private
  * is passed as an integer, while the public key is an octet string.
  */
 ...
 int main()
 {
     ...
     if (param_bld != NULL) {
         OSSL_PARAM_BLD_push_utf8_string(param_bld, "curve-name",
                                         "prime256v1", 0);
