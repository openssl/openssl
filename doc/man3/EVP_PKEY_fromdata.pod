...
are the EVP_PKEY_fromdata() set of functions.  In real applications,
...
=head2 Creating an ECC keypair using raw key data
  ...
  * We're not doing that here, since this is not an of BIGNUM
 ...
 const OSSL_PARAM params[] = {
     OSSL_PARAM_ulong("curve-name", "prime256v1"),
