...
=item SSL_OP_NO_RECORD_SIZE_LIMIT_EXT

Disable the Record Size Limit extension.

Clients will not send the extension in the ClientHello and a server will ignore
if a Record Size Limit is present in the ServerHello.
