...
9999 in I<tm> to a POSIX time value in I<out>. Only the fields
I<tm_year>, I<tm_mon>, I<tm_mday>, I<tm_hour>, I<tm_min>, and
I<tm_sec> will be read from I<tm> and all other fields will be
ignored. Out of range values, including leap seconds, are not
permitted.
...
I<tm>.  Only the fieldsI<tm_year>, I<tm_mon>, I<tm_mday>, I<tm_hour>,
I<tm_min>, and I<tm_sec> will be used from I<tm> and all other fields
will be ignored, and will be zeroed in the result. Out of range
values, including leap seconds, are not permitted.
...
seconds per day (86400). Only the fields I<tm_year>, I<tm_mon>,
I<tm_mday>, I<tm_hour>, I<tm_min>, and I<tm_sec> will be used from in
I<from> and I<to>. all other fields will be ignored. Out of range
values, including leap seconds, are not permitted.
...
OPENSSL_timegm() returns 1 for success or 0 for failure.  It can fail
if the time is not representable in a time_t, or if the year is less
than 0 or more than 9999.
...
OPENSSL_gmtime() is not platform-agnostic due to possible limitations
in the range of the platform I<time_t> type. OPENSSL_posix_to_tm
provides similar functionally in a platform independent manner.
