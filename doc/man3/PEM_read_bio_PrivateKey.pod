...
versions of Opentls is important.
...
The PEM read routines in some versions of Opentls will not correctly reuse
...
in Opentls 1.1.0; applications should use the PKCS7 standard instead
