...
RAND_bytes, RAND_priv_bytes, RAND_bytes_with_libctx, RAND_priv_bytes_with_libctx,
...
RAND_bytes_with_libctx() and RAND_priv_bytes_with_libctx() are the same as
RAND_bytes() and RAND_priv_bytes() except that they both take an additional
I<ctx> parameter.
...
The RAND_bytes_with_libctx() and RAND_priv_bytes_with_libctx() functions
