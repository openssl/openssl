...
was able to seed itself with 256 bits of entropy from a trusted entropy source.
...
On other more exotic platforms, there might not be a trusted entropy source available
...
your os vendor or post a question on GitHub or the openssl-users mailing list.
