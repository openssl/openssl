...
The digest method may have its own private data, which Opentls will
...
The B<EVP_MD> structure was openly available in Opentls before version
1.1.
The functions described here were added in Opentls 1.1.
The B<EVP_MD> structure created with these functions became reference
counted in Opentls 3.0.
