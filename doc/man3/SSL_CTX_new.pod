...
=head1 SYNOPSIS
 ...
 SSL_CTX *SSL_CTX_new_ex(const SSL_METHOD *method,
...
SSL_CTX_new_ex() creates a new B<SSL_CTX> object with the given
B<SSL_SESSION_CACHE> object, which stores the sessions. Passing B<cache>
as NULL is identical to SSL_CTX_new() functionality.
...
SSL_CTX_new() and SSL_CTX_new_ex() initialize the list of ciphers, the session cache setting, the
...
SSL_CTX_new_ex() was introduced in OpenSSL 1.1.1.
...
L<SSL_CTX_get1_session_cache(3)>
