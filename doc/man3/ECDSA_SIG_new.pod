...
'r' and 's' into or from a signature. This is mainly used for testing purposes as shown
in the L</EXAMPLES>.
...
Extract signature 'r' and 's' values from a ECDSA 'signature'
of size 'signaturelen':
...
Convert 'r' and 's' byte arrays into a ECDSA_SIG signature:
...
The deprecated functions related to ECDSA were moved to L<ECDSA_sign(3)>
in OpenSSL 3.2.
