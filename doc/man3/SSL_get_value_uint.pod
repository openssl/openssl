...
to L<SSL_accept_connection(3)>. The default limit for pending connections is 256. The INITIAL
QUIC packet which exceeds the limit is silently discarded. Setting the value to zero disables
the limit.
