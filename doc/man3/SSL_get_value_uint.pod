...
SSL_VALUE_QUIC_MAX_PENDING_CHANNELS,
...
=head1 SYNOPSIS
 ...
 #define SSL_VALUE_QUIC_MAX_PENDING_CHANNELS
...
SSL connection object. The connection is removed from pending queue by call
to L<SSL_accept_connection(3)>. The default limit for pending connections is 32. The INITIAL
QUIC packet which exceeds the limit is silently discarded.
