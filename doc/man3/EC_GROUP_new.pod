...
(e.g., "P-256", "P-384", "P-521"). If the curve does not have a NIST name,
NULL is returned.

EC_curve_nist2nid() converts a NIST curve I<name> (e.g., "P-256") into the
corresponding NID. If the name is not recognized, B<NID_undef> is returned.
