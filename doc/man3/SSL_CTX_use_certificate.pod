...
private key being assigned via SSL_CTX_use_PrivateKey(), etc. This function may be called multiple times to configure multiple certificate and private key pairs of different types on the same SSL_CTX or SSL object.
