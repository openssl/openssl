...
the default OpenSSL directory. Alternatively the B<SSL_CERT_DIR> environment
...
B<SSL_CERT_FILE> environment variable can be defined to override this location.
