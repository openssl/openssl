...
Furthermore, this function is expected to initialise what needs to be
initialised, to create a private data store (B<OSSL_STORE_LOADER_CTX>, see
...
It's expected to load the next available data, convert it into a data
