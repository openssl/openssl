...
SSL_CTX_set_quiet_shutdown, SSL_CTX_get_quiet_shutdown, SSL_set_quiet_shutdown, SSL_get_quiet_shutdown - manipulate shutdown behavior
...
is sent to the peer. This behavior violates the TLS standard.

The default is normal shutdown behavior as described by the TLS standard.
