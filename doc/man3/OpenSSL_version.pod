...
number string, C<MAJOR.MINOR.PATCH>.
...
The "OPENSSLDIR" setting of the library build in the form C<OPENSSLDIR: "...">
if available, or "OPENSSLDIR: N/A" otherwise.

=item OPENSSL_ENGINES_DIR

The "ENGINESDIR" setting of the library build in the form C<ENGINESDIR: "...">
if available, or "ENGINESDIR: N/A" otherwise.

=item OPENSSL_MODULES_DIR

The "MODULESDIR" setting of the library build in the form C<MODULESDIR: "...">
...
For an unknown B<t>, the text C<not available> is returned.
