...
For X509 certificates with an ML-DSA subject public key, X509_sign() and
X509_sign_ctx() also reject a keyUsage extension containing keyEncipherment,
dataEncipherment, keyAgreement, encipherOnly, or decipherOnly, as required by
RFC 9881.
