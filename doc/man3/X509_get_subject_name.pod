...
X509_REQ_get_subject_name() is a function in Opentls 1.1.0 and a macro in
earlier versions.

X509_CRL_get_issuer() is a function in Opentls 1.1.0. It was previously
added in Opentls 1.0.0 as a macro.
