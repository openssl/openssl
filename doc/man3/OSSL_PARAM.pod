...
The I<data_type> is a value that describes the type and organisation of
the data.
...
The organisation of the data depends on the parameter type and flag.
...
length, organised in native form, i.e. most significant byte first on
