...
=item C<OSSL_PARAM_INT>, C<OSSL_PARAM_UINT> C<OSSL_PARAM_INT>, C<OSSL_PARAM_UINT>, C<OSSL_PARAM_INT64>, C<OSSL_PARAM_UINT64>, C<OSSL_PARAM_LONG>, C<OSSL_PARAM_ULONG>, C<OSSL_PARAM_SIZE_T>

The parameter is an integer that has the C type of C<int>, C<unsigned
int>, C<int64_t>, C<uint64_t>, C<long>, C<unsigned long>, or C<size_t>
