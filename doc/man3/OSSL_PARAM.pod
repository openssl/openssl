...
This example shows a special case where I<-Wincompatible-pointer-types-discards-qualifiers> may be set during compilation, where the above examples may cause compilation warnings or errors. Specifically, the value for I<data> cannot be a I<const char*>. 
