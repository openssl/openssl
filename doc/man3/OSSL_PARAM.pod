...
=item C<OSSL_PARAM_INT>, C<OSSL_PARAM_UINT> C<OSSL_PARAM_INT>, C<OSSL_PARAM_UINT>, C<OSSL_PARAM_INT64>, C<OSSL_PARAM_UINT64>, C<OSSL_PARAM_LONG>, C<OSSL_PARAM_ULONG>, C<OSSL_PARAM_SIZE_T>, C<OSSL_PARAM_DOUBLE>

The parameter is an integer that has the C type of C<int>,
C<unsigned int>, C<int64_t>, C<uint64_t>, C<long>, C<unsigned long>,
C<size_t>, or C<double>,
respectively, and is represented in its native form.

=item C<BIGNUM>

The parameter is an OpenSSL C<BIGNUM> and is represented using
BN_lebin2bn() or BN_bin2bn(), depending on whether the platform is
