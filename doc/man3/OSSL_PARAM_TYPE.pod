...
OSSL_PARAM_locate_get_TYPE() behaves exactly like:
OSSL_PARAM_get_TYPE(OSSL_PARAM_locate(B<p>, B<key>), B<val>).

OSSL_PARAM_locate_set_TYPE() behaves exactly like:
OSSL_PARAM_set_TYPE(OSSL_PARAM_locate(B<p>, B<key>), B<val>).

OSSL_PARAM_locate_get_BN() behaves exactly like:
OSSL_PARAM_locate_get_BN(OSSL_PARAM_locate(B<p>, B<key>), B<val>).

OSSL_PARAM_locate_set_BN() behaves exactly like:
OSSL_PARAM_locate_set_BN(OSSL_PARAM_locate(B<p>, B<key>), B<val>).

OSSL_PARAM_locate_get_utf8_string() behaves exactly like:
OSSL_PARAM_locate_get_utf8_string(OSSL_PARAM_locate(B<p>, B<key>), B<val>,
B<max_len>).

OSSL_PARAM_locate_set_utf8_string() behaves exactly like:
OSSL_PARAM_locate_set_utf8_string(OSSL_PARAM_locate(B<p>, B<key>), B<val>).

OSSL_PARAM_locate_get_octet_string() behaves exactly like:
OSSL_PARAM_locate_get_octet_string(OSSL_PARAM_locate(B<p>, B<key>), B<val>,
B<max_len>, B<used_len>).

OSSL_PARAM_locate_set_octet_string() behaves exactly like:
OSSL_PARAM_locate_set_octet_string(OSSL_PARAM_locate(B<p>, B<key>), B<val>,
B<len>).

OSSL_PARAM_locate_get_utf8_ptr() behaves exactly like:
OSSL_PARAM_locate_get_utf8_ptr(OSSL_PARAM_locate(B<p>, B<key>), B<val>).

OSSL_PARAM_locate_set_utf8_ptr() behaves exactly like:
OSSL_PARAM_locate_set_utf8_ptr(OSSL_PARAM_locate(B<p>, B<key>), B<val>).

OSSL_PARAM_locate_get_octet_ptr() behaves exactly like:
OSSL_PARAM_locate_get_octet_ptr(OSSL_PARAM_locate(B<p>, B<key>), B<val>,
B<used_len>).

OSSL_PARAM_locate_set_octet_ptr() behaves exactly like:
OSSL_PARAM_locate_set_octet_ptr(OSSL_PARAM_locate(B<p>, B<key>), B<val>,
B<used_len>).
...
or, more succinctly, like this:
    ...
    OSSL_PARAM_locate_set_utf8_ptr(params, "foo", "foo value");
    OSSL_PARAM_locate_set_utf8_string(params, "bar", "bar value");
