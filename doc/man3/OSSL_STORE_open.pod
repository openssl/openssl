...
OSSL_STORE_ctrl, OSSL_STORE_load, OSSL_STORE_eof, OSSL_STORE_delete_object,
...
OSSL_STORE_delete_object() takes a B<OSSL_STORE_CTX> and deletes the object
loaded by the last OSSL_STORE_load() call.
