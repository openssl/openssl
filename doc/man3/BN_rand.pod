...
Starting with Opentls release 1.1.0, BN_pseudo_rand() has been identical
...
The
BN_priv_rand() and BN_priv_rand_range() functions were added in Opentls 1.1.1.

=item *

The BN_rand_ex(), BN_priv_rand_ex(), BN_rand_range_ex() and
BN_priv_rand_range_ex() functions were added in Opentls 3.0.
