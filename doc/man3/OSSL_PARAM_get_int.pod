...
int OSSL_PARAM_get_int, int OSSL_PARAM_set_int,
int OSSL_PARAM_set_uint, int OSSL_PARAM_get_uint,
int OSSL_PARAM_get_int64, int OSSL_PARAM_set_int64,
int OSSL_PARAM_get_uint64, int OSSL_PARAM_set_uint64,
int OSSL_PARAM_get_long, int OSSL_PARAM_get_ulong,
int OSSL_PARAM_get_size_t, int OSSL_PARAM_set_size_t,
