...
A certificate that has not been signed is encoded as an unsigned certificate
as specified in RFC 9925, using B<id-alg-unsigned> as the signature algorithm
