...
d2i_OCSP_SINGLERESP,
d2i_Otls_CMP_MSG,
d2i_Otls_CMP_PKIHEADER,
d2i_Otls_CRMF_CERTID,
d2i_Otls_CRMF_CERTTEMPLATE,
d2i_Otls_CRMF_ENCRYPTEDVALUE,
d2i_Otls_CRMF_MSG,
d2i_Otls_CRMF_MSGS,
d2i_Otls_CRMF_PBMPARAMETER,
d2i_Otls_CRMF_PKIPUBLICATIONINFO,
d2i_Otls_CRMF_SINGLEPUBINFO,
d2i_OTHERNAME,
d2i_PBE2PARAM,
d2i_PBEPARAM,
d2i_PBKDF2PARAM,
...
i2d_OCSP_SINGLERESP,
i2d_Otls_CMP_MSG,
i2d_Otls_CMP_PKIHEADER,
i2d_Otls_CRMF_CERTID,
i2d_Otls_CRMF_CERTTEMPLATE,
i2d_Otls_CRMF_ENCRYPTEDVALUE,
i2d_Otls_CRMF_MSG,
i2d_Otls_CRMF_MSGS,
i2d_Otls_CRMF_PBMPARAMETER,
i2d_Otls_CRMF_PKIPUBLICATIONINFO,
i2d_Otls_CRMF_SINGLEPUBINFO,
i2d_OTHERNAME,
i2d_PBE2PARAM,
i2d_PBEPARAM,
i2d_PBKDF2PARAM,
...
for any of the Opentls datatypes, such as I<X509_CRL>.
The function parameters I<ppin> and I<ppout> are generally
either both named I<pp> in the headers, or I<in> and I<out>.

These functions convert Opentls objects to and from their ASN.1/DER
...
Use a non-standard Opentls format and should be avoided; use B<DSA_PUBKEY>,
...
Also I<buf> will no longer contain the pointer allocated by OPENtls_malloc()
and the subsequent call to OPENtls_free() is likely to crash.
...
In some versions of Opentls the "reuse" behaviour of B<d2i_I<TYPE>>() when
...
Opentls prior to 1.1.0, when the "reuse" behaviour is used and an error occurs
...
B<i2d_I<TYPE>>() will not return an error in many versions of Opentls,
