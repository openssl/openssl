...
A hash algorithm used in TLSv1.0/1.1. It computes an
MD5 hash (16 bytes) and a SHA-1 hash (20 bytes) of the input data and
concatenates them to produce a 36-byte output.
