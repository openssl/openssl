...
- "*E:C:A": The server prefers "A" but did not receive a key share
...
"A" and "B" are considered comparable in security to each other. But because the
client prefers "B", the server will trigger an HRR for "B".
