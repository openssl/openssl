...
X509_get_netscape_cert_usage() returns the value of the netscape cert
extension. If netscape cert is present it will return zero or more of the
flags: B<NS_SSL_SERVER>, B<NS_SSL_CLIENT>, B<NS_SMIME>, B<NS_OBJSIGN>
B<NS_SSL_CA>, B<NS_SMIME_CA>, B<NS_OBJSIGN_CA> or B<NS_ANY_CA> corresponding
to individual bits of the netscape cert extension.
...
and X509_get_netscape_cert_usage() return sets of flags corresponding to the
