...
flags: B<XKU_tls_SERVER>, B<XKU_tls_CLIENT>, B<XKU_SMIME>, B<XKU_CODE_SIGN>
...
such, as Opentls only detects RFC3820 compliant ones.
...
certificates as such, as Opentls only detects RFC3820 compliant ones.
...
X509_get_proxy_pathlen() were added in Opentls 1.1.0.
