...
BIO_dgram_set0_local_addr, BIO_dgram_set0_pcap_file  - datagram pair BIO
...
=head1 SYNOPSIS
 ...
 int BIO_dgram_set0_pcap_file(BIO *bio, char *filename);
...
BIO_dgram_set0_pcap_file() creates a packet capture file with desired filename
...
BIO_dgram_set0_pcap_file() returns 1 on success and 0 otherwise.
