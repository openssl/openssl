...
Opentls will by default identify signing certificates using issuer name
...
The B<CMS_STREAM> flag is only supported for detached data in Opentls 0.9.8,
it is supported for embedded data in Opentls 1.0.0 and later.
