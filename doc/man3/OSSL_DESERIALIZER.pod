...
=head1 SYNOPSIS
 ...
 OSSL_DESERIALIZER *OSSL_DESERIALIZER_fetch(OSSL_CTX *ctx, const char *name,
...
has been loaded into the B<OSSL_CTX> given by I<ctx>, having the
...
L<OSSL_DESERIALIZER_CTX_new_by_EVP_PKEY(3)>, L<OSSL_CTX(3)>
