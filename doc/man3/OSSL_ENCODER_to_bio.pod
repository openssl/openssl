...
OSSL_ENCODER_to_data() runs the encoding process for the context I<encoder>,
...
OSSL_ENCODER_to_bio() runs the encoding process for the context I<encoder>,
with the output going to the B<BIO> I<out>.
