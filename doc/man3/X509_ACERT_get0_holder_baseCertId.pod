...
OSSL_OBJECT_DIGEST_INFO_set0_digest - get and set Attribute Certificate holder fields
...
attribute certificate holder.  OSSL_OBJECT_DIGEST_INFO_set0_digest() sets the
