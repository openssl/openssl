...
Warning: It is essential that the calling code connect the underlying socket to
...
break the cryptographic protections of DTLS but may facilitate a denial of
service attack or allow unencrypted information in the DTLS handshake to be
learned by an attacker. This is due to the historical design of
