...
ASN1_OCTET_STRING_cmp() and ASN1_OCTET_STRING_set() are equivalent to the
corresponding ASN1_STRING functions. They are provided for type safety when
working with B<ASN1_OCTET_STRING> values.
