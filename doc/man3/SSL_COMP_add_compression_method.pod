...
The following functions have been deprecated since OpenSSL 5.0, and can be
...
were deprecated in OpenSSL 5.0.
TLS record-level compression is obsolete and a security liability
(see the CRIME attack). Use B<SSL_OP_NO_COMPRESSION> to disable compression
instead. These functions will be removed in a future version.
