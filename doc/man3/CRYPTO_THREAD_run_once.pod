...
CRYPTO_atomic_load, CRYPTO_atomic_load_ptr, CRYPTO_atomic_store, CRYPTO_atomic_store_ptr,
CRYPTO_atomic_load_int, CRYPTO_atomic_cmp_exch, OSSL_set_max_threads, OSSL_get_max_threads,
...
=head1 SYNOPSIS
 ...
 int CRYPTO_atomic_cmp_exch(void **ptr, void **expected, void *desired, CRYPTO_RWLOCK *lock);
...
CRYPTO_atomic_load_ptr() work exactly the same as CRYPTO_atomic_load but allows
for the fetching of pointer values, rather than integer types.
...
CRYPTO_atomic_store_ptr() works exactly as CRYPTO_atomic_store() does, but stores
pointer values rather than integer types.
...
CRYPTO_atomic_cmp_exch atomically compares the contents of I<*ptr> to the contents
of I<*expected> and, if they are equal, writes I<desired> into I<*ptr>, returning 1.
If I<*ptr> and I<*expected> are not equal, zero is returned and the contents of
I<*ptr> are written into *expected.
...
CRYPTO_atomic_cmp_exch(), CRYPTO_atomic_load_ptr(), CRYPTO_atomic_store_ptr(),
