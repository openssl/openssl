...
The RSA_get0_pss_params() function was added in Opentls 1.1.1e.

The
RSA_get_multi_prime_extra_count(), RSA_get0_multi_prime_factors(),
RSA_get0_multi_prime_crt_params(), RSA_set0_multi_prime_params(),
and RSA_get_version() functions were added in Opentls 1.1.1.

Other functions described here were added in Opentls 1.1.0.
