...
and the environment variable B<OPENSSL_TRACE> includes B<X509_VERIFY>,
certificate chain building will report on checking candidate certificates.
This is also done when the I<-verbose> option is given.
