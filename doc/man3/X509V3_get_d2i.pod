...
X509V3_get_d2i, X509V3_get0_value, X509V3_add1_i2d,
X509V3_EXT_d2i, X509V3_EXT_i2d,
X509_get_ext_d2i, X509_get0_ext_value, X509_add1_ext_i2d,
X509_ACERT_get_ext_d2i, X509_ACERT_get0_ext_value, X509_ACERT_add1_ext_i2d,
X509_CRL_get_ext_d2i, X509_CRL_get0_ext_value, X509_CRL_add1_ext_i2d,
X509_REVOKED_get_ext_d2i, X509_REVOKED_get0_ext_value,
...
=head1 SYNOPSIS
 ...
 int X509_ACERT_get0_ext_value(const X509_ACERT *x, int nid,
                               const void **value, int *outcome);
 ...
 int X509_CRL_get0_ext_value(const X509_CRL *crl, int nid, const void **value,
                             int *outcome);
 ...
 int X509_REVOKED_get0_ext_value(const X509_REVOKED *r, int nid,
                                 const void **value, int *outcome);
...
or NULL is returned. The caller owns the returned structure and frees it with
the free function of its type.

X509V3_get0_value() looks for the extension with OID I<nid> in I<x> and gets
its value as L<X509_EXTENSION_get0_value(3)> does: if I<value> is not NULL,
I<*value> is set to a borrowed pointer to the decoded structure, or to NULL if
there is none; if I<outcome> is not NULL, I<*outcome> is set to one of the
B<X509_EXT_VALUE_> values described there, or to B<X509_EXT_VALUE_ABSENT> if
there is no extension with OID I<nid>, or to B<X509_EXT_VALUE_DUPLICATE> if
...
The caller owns the returned structure.

X509V3_EXT_i2d() encodes the extension specific structure I<ext_struc>
with OID I<ext_nid> and criticality I<crit>.

X509_get_ext_d2i(), X509_get0_ext_value() and X509_add1_ext_i2d() operate on
the extensions of certificate I<x>. They are otherwise identical to
X509V3_get_d2i(), X509V3_get0_value() and X509V3_add1_i2d().

X509_ACERT_get_ext_d2i(), X509_ACERT_get0_ext_value() and
X509_ACERT_add1_ext_i2d() operate on the extensions of B<X509_ACERT> structure
I<x>. They are otherwise identical to X509V3_get_d2i(), X509V3_get0_value()
and X509V3_add1_i2d().

X509_CRL_get_ext_d2i(), X509_CRL_get0_ext_value() and X509_CRL_add1_ext_i2d()
operate on the extensions of CRL I<crl>. They are otherwise identical to
X509V3_get_d2i(), X509V3_get0_value() and X509V3_add1_i2d().

X509_REVOKED_get_ext_d2i(), X509_REVOKED_get0_ext_value() and
X509_REVOKED_add1_ext_i2d() operate on the extensions of B<X509_REVOKED>
structure I<r> (i.e for CRL entry extensions). They are otherwise identical to
X509V3_get_d2i(), X509V3_get0_value() and X509V3_add1_i2d().
...
X509V3_get0_value() and its variants return 1 if I<*outcome> is
B<X509_EXT_VALUE_DECODED> and 0 otherwise.
...
X509V3_get0_value(), X509_get0_ext_value(), X509_ACERT_get0_ext_value(),
X509_CRL_get0_ext_value() and X509_REVOKED_get0_ext_value() were added in
OpenSSL 4.1.
