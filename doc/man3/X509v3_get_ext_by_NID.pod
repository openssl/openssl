...
Modifying the extensions of a certificate with X509_add_ext() or
X509_delete_ext() after it has been parsed or signed does not update the
certificate's cached extension data; see L<x509(7)>.
