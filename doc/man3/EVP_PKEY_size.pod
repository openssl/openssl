...
=head1 SYNOPSIS
 ...
 const OSSL_PARAM *EVP_PKEY_gettable_params(EVP_PKEY_CTX *ctx);
...
EVP_PKEY_gettable_params() returns an OSSL_PARAM array on success or NULL on
error.
