...
library expects that the function will set an arbitrary I<name>, initialise
...
The initialisation vector I<iv> should be a random value. The cipher context
...
I<ctx> will be set with the retrieved parameters and the initialisation vector
