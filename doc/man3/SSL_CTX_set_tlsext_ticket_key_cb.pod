...
initialized with L<EVP_CIPHER_CTX_reset(3)> and L<EVP_MAC_new_ctx(3)>
respectively.
...
I<ctx> should use the initialization vector I<iv>. The cipher context can be
...
initialized with L<EVP_MAC_new_ctx(3)> and the digest set with
     ...
     if (enc) { /* create new session */
         ...
         if (key == NULL) {
             ...
             key = createkey(); /*
                                 ...
                                 * createkey needs to initialize a name,
