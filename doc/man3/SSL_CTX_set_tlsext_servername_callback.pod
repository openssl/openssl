...
TLS clients are recommended to use this function
as well as L<X509_VERIFY_PARAM_set1_host(3)> or L<X509_VERIFY_PARAM_add1_host(3)>
for server hostname validation.
