...
EVP_aes_128_xts,
EVP_aes_256_xts,
EVP_aes_128_cbc_hmac_sha1_etm,
EVP_aes_128_cbc_hmac_sha256_etm,
EVP_aes_128_cbc_hmac_sha512_etm,
EVP_aes_192_cbc_hmac_sha1_etm,
EVP_aes_192_cbc_hmac_sha256_etm,
EVP_aes_192_cbc_hmac_sha512_etm,
EVP_aes_256_cbc_hmac_sha1_etm,
EVP_aes_256_cbc_hmac_sha256_etm,
EVP_aes_256_cbc_hmac_sha512_etm
- EVP AES cipher
...
=item EVP_aes_128_cbc_hmac_sha1_etm(),
EVP_aes_192_cbc_hmac_sha1_etm()
EVP_aes_256_cbc_hmac_sha1_etm()

Authenticated encryption in encrypt-then-mac order with AES in CBC mode using
SHA-1 as HMAC, with keys of 128,192 and 256 bits length respectively.

=item EVP_aes_128_cbc_hmac_sha256_etm(),
EVP_aes_192_cbc_hmac_sha256_etm()
EVP_aes_256_cbc_hmac_sha256_etm()

Authenticated encryption in encrypt-then-mac order with AES in CBC mode using
SHA-256 as HMAC, with keys of 128,192 and 256 bits length respectively.

=item EVP_aes_128_cbc_hmac_sha512_etm(),
EVP_aes_192_cbc_hmac_sha512_etm()
EVP_aes_256_cbc_hmac_sha512_etm()

Authenticated encryption in encrypt-then-mac order with AES in CBC mode using
SHA-512 as HMAC, with keys of 128,192 and 256 bits length respectively.
