...
RAND_DRBG_get0_master_ex() returns a pointer to the I<master> DRBG instance
...
RAND_DRBG_get0_master_ex(), RAND_DRBG_get0_public_ex() and
...
The RAND_DRBG_get0_master_ex(), RAND_DRBG_get0_public_ex() and
