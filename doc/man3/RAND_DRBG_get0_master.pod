...
The default RAND API implementation (RAND_OpenSSL()) utilises three
...
at initialisation time, before creating additional threads.

During initialisation, it is possible to change the reseed interval
