...
RNAD_DRBG_get0_master_ex,
RAND_DRBG_get0_public_ex,
RAND_DRBG_get0_private_ex,
...
=head1 SYNOPSIS
 ...
 RAND_DRBG *RNAD_DRBG_get0_master_ex(OPENSSL_CTX *ctx);
...
RNAD_DRBG_get0_master_ex() returns a pointer to the I<master> DRBG instance
for the given OPENSSL_CTX B<ctx>.

RAND_DRBG_get0_public_ex() returns a pointer to the I<public> DRBG instance
for the given OPENSSL_CTX B<ctx>.

RAND_DRBG_get0_private_ex() returns a pointer to the I<private> DRBG instance
for the given OPENSSL_CTX B<ctx>.
...
RNAD_DRBG_get0_master_ex(), RAND_DRBG_get0_public_ex() and
RAND_DRBG_get0_private_ex() respectively except that the default OPENSSL_CTX
is always used.
...
The RNAD_DRBG_get0_master_ex(), RAND_DRBG_get0_public_ex() and
RAND_DRBG_get0_private_ex() functions were added in OpenSSL 3.0.
