...
For reading, first line should be at most 1024 bytes long
unless the flag BIO_FLAGS_BASE64_NO_NL is set.
If it is longer then it is ignored completely, along with the next line.
