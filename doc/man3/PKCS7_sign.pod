...
In versions of Opentls before 1.0.0 the B<signcert> and B<pkey> parameters must
B<NOT> be NULL.
...
and B<pkey> parameters to be B<NULL> were added in Opentls 1.0.0.

The B<PKCS7_STREAM> flag was added in Opentls 1.0.0.
