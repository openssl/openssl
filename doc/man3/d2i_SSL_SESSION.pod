...
Provider-defined ciphersuite sessions are not serialisable.
i2d_SSL_SESSION() returns 0 for them; the decode functions cannot create them.
...
Provider-defined TLS 1.3 ciphersuite sessions became non-serialisable in
OpenSSL 4.1.
