...
=item B<X509_V_ERR_INVALID_CERTIFICATE_FORMAT: invalid certificate format>

Certificate representation has invalid format (i.e, syntax errors).
...
CA certificate was encountered where only a non-CA certificate is expected.
