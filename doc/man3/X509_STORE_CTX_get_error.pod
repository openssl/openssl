...
=item B<X509_V_ERR_ACCESS_DENIED: access control denied access>

The submitted certificate or PSK is valid, but access control (usually in an
application) denied access for different reasons. This will never be returned
