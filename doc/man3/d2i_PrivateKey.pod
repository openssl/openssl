...
All the functions that work with data in memory update the data pointers I<*pp>
after successful operation as the other d2i and i2d functions; see L<d2i_X509(3)>.
