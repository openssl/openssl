...
An error occurs id I<attr> is NULL.
...
to the I<key> objects attribute list. If I<obj> already exists in the attribute
...
EVP_PKEY_get_attr() returns either a B<X509_ATTRIBUTE> or NULL if there is an
error.
...
A B<EVP_PKEY> objects attribute list is initially NULL. All the above functions
