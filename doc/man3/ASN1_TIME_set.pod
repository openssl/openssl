...
format. It will be of the format MMM DD HH:MM:SS YYYY[.s*] [GMT], for example
...
Users familiar with RFC822 should note that even if specifying the flag
B<ASN1_DTFLGS_RFC822> the year will be formatted as documented above,
i.e., using 4 digits, not the 2 as specified in RFC822.
