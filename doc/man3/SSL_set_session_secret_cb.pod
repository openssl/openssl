...
be between 0 and 65535. If I<ext_data> is NULL, the extension is fully cleared and I<ext_len> is ignored, ensuring no empty extension is inadvertently allocated. If I<ext_data> is NULL and I<ext_len> > 0, it is considered an error and the function returns 0.
