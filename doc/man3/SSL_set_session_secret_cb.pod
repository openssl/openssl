...
If the session ticket extension callback returns 1 then this indicates it has
successfully handled the received extension. A return value of 0 indicates a
failure and will cause an immediate abort of the handshake.
