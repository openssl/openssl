...
X509_STORE_load_store_ex() passes a URI or filename for a directory-like or file-like
structure from which one or more trusted certificates are loaded on demand
in the given B<X509_STORE>. The library context I<libctx> and
