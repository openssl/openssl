...
can declare the specific uses these certificates are trusted for. This "trust"
...
"TLS Server Authentication" and "TLS Client Authentication", but a system
administrator might only trust it for the former.
