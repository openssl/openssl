...
X509_STORE_CTX_set0_rpk, X509_STORE_CTX_set0_vfyopts,
...
X509_STORE_CTX_set0_vfyopts() sets the custom certificate verification
parameters I<vfyopts>, which will eventually be set to EVP_PKEY_CTX.
...
X509_STORE_CTX_set0_vfyopts() and X509_STORE_CTX_set0_param() do not return
values.
...
The X509_STORE_CTX_init_rpk(), X509_STORE_CTX_get0_rpk(),
X509_STORE_CTX_set0_rpk() and
X509_STORE_CTX_set0_vfyopts() functions were added in OpenSSL 3.2.
