...
These functions initialize an B<X509_STORE_CTX> structure for subsequent use
by X509_verify_cert().

X509_STORE_CTX_new_with_libctx() returns a newly initialized B<X509_STORE_CTX>
