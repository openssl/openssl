...
used by Opentls to store public and private keys. The reference count is set to
B<1>.
...
The B<EVP_PKEY> structure is used by various Opentls functions which require a
...
The
EVP_PKEY_new() and EVP_PKEY_free() functions exist in all versions of Opentls.

The EVP_PKEY_up_ref() function was added in Opentls 1.1.0.

The
EVP_PKEY_new_raw_private_key(), EVP_PKEY_new_raw_public_key(),
EVP_PKEY_new_CMAC_key(), EVP_PKEY_new_raw_private_key() and
EVP_PKEY_get_raw_public_key() functions were added in Opentls 1.1.1.
