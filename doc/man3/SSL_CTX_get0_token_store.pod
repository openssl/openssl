...
created on the creation of an B<SSL_CTX> and freed on their release.  The
functions above can be used to fetch and set the token cache between independent
