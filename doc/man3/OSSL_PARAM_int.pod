...
pointed to by I<p>.
The string is stored into I<*val> with a size limit of I<max_len>, not
counting a terminating NUL byte.  If the retrieved UTF8 string was
shorter than I<max_len> bytes, a terminating NUL byte is added into
I<*val>.
