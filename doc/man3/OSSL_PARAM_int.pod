...
The OSSL_PARAM_DEFN macro provides the ability to construct a single OSSL_PARAM
(typically used in the construction of OSSL_PARAM arrays). The I<key>, I<type>,
I<addr> and I<sz> arguments correspond to the I<key>, I<data_type>, I<data> and
I<data_size> fields of the OSSL_PARAM structure as described on the
L<OSSL_PARAM(3)> page.
