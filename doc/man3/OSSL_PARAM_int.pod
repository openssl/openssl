...
=head1 SYNOPSIS
 ...
 #define OSSL_PARAM_double(key, address)
 #define OSSL_PARAM_int(key, address)
 #define OSSL_PARAM_int32(key, address)
 #define OSSL_PARAM_int64(key, address)
 #define OSSL_PARAM_long(key, address)
 #define OSSL_PARAM_size_t(key, address)
 #define OSSL_PARAM_uint(key, address)
 #define OSSL_PARAM_uint32(key, address)
 #define OSSL_PARAM_uint64(key, address)
 #define OSSL_PARAM_ulong(key, address)
 ...
 #define OSSL_PARAM_SIZED_double(key, address, return_size)
 #define OSSL_PARAM_SIZED_int(key, address, return_size)
 #define OSSL_PARAM_SIZED_int32(key, address, return_size)
 #define OSSL_PARAM_SIZED_int64(key, address, return_size)
 #define OSSL_PARAM_SIZED_long(key, address, return_size)
 #define OSSL_PARAM_SIZED_size_t(key, address, return_size)
 #define OSSL_PARAM_SIZED_uint(key, address, return_size)
 #define OSSL_PARAM_SIZED_uint32(key, address, return_size)
 #define OSSL_PARAM_SIZED_uint64(key, address, return_size)
 #define OSSL_PARAM_SIZED_ulong(key, address, return_size)
 ...
 int OSSL_PARAM_set_uint(const OSSL_PARAM *p, const char *key,
                         unsigned int val);
