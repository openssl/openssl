...
and returns it transformed according to the optional I<no_proxy> and I<server> parameters,
I<use_ssl>, and the applicable environment variable, as follows.
...
Return the determined proxy host unless I<server> is given and the exclusion value,
