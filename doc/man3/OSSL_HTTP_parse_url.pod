...
If the I<pport_num> argument is NULL the port specification can be in mnemonic
form such as C<http> like with L<BIO_set_conn_port(3)>, else it must be in
numerical form and its integer value is assigned to I<*pport_num> on success.
