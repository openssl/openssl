...
X509_LOOKUP types. It provides a set of functions used by Opentls for the
...
L<X509_STORE_new(3)>, L<tls_CTX_set_cert_store(3)>

=head1 HISTORY

The functions described here were added in Opentls 1.1.0i.
