...
X509_LOOKUP_meth_get_shutdown, X509_LOOKUP_meth_set_ctrl,
X509_LOOKUP_meth_get_ctrl, X509_LOOKUP_meth_set_get_by_subject,
X509_LOOKUP_meth_get_get_by_subject, X509_LOOKUP_meth_set_get_by_issuer_serial,
X509_LOOKUP_meth_get_get_by_issuer_serial,
X509_LOOKUP_meth_set_get_by_fingerprint,
X509_LOOKUP_meth_get_get_by_fingerprint, X509_LOOKUP_meth_set_get_by_alias,
X509_LOOKUP_meth_get_get_by_alias, X509_LOOKUP_set0_method_data, X509_LOOKUP_get0_method_data,
X509_LOOKUP_get0_store, X509_OBJECT_set1_X509, X509_OBJECT_set1_X509_CRL
...
invoke X509_LOOKUP_set0_method_data().
...
X509_LOOKUP_set0_method_data() as part of the new_item routine.
...
X509_LOOKUP_ctrl(). The control function is given the X509_LOOKUP ctx, along
with the arguments passed by X509_LOOKUP_ctrl. cmd is an arbitrary integer that
defines some operation. argc is a pointer to an array of pointers that
represent arbitrary arguments. argl indicates the number of elements in the
argument array pointed by argc. ret, if set, points to a location where any
return data should be written to.
...
X509_LOOKUP_get0_method_data(). The B<X509_STORE> object that owns the
X509_LOOKUP may be accessed with X509_LOOKUP_get0_store(). Successful lookups
...
the function set by the corresponding getter.
