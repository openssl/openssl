...
The following functions have been removed since OpenSSL 4.0. They should be
removed from any source code.
...
your source files.  Please use provider API instead of ENGINEs.
...
When the B<OPENSSL_ENGINE_STUB> macro is defined, these functions return a
failure.
