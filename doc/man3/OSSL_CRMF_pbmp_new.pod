...
All of these functions moved to the new libcmp library in OpenSSL 4.1.
Deprecated variants remain in libcrypto, declared in F<< <openssl/crmf.h> >>,
until a future major release.  See L<libcmp(7)>.
