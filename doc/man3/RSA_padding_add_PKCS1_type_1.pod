...
RSA_padding_check_PKCS1_type_2_ex() provides an alternative API that
avoids some of the problems with RSA_padding_check_PKCS1_type_2().

=head1 SEE ALSO

L<RSA_public_encrypt(3)>,
L<RSA_private_decrypt(3)>,
L<RSA_padding_check_PKCS1_type_2_ex(3)>,
