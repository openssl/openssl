...
RSA_padding_add_xxx(), otherwise the operation will fail.
(Seeding happens automatically at startup, but it might fail due to
external circumstances, see L<RAND(7)> for more details.)
