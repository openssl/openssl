...
OSSL_DECODER_CTX_get_num_decoders() gets the number of
...
OSSL_DECODER_INSTANCE_get_decoder() can be used to get the
decoder method from a decoder instance I<decoder_inst>.

OSSL_DECODER_INSTANCE_get_decoder_ctx() can be used to get the
decoder method's provider context from a decoder instance
I<decoder_inst>.

OSSL_DECODER_INSTANCE_get_input_type() can be used to get the
decoder method's input type from a decoder instance
I<decoder_inst>.
