...
instatntiate the primary DRBG in the library context I<ctx>. If this function
is called multiple times with the same I<ctx> the last vaule of I<parameters>
will be used.
