...
tag length.  C<taglen> must either be 16 or the value previously set via
B<EVP_CTRL_AEAD_SET_TAG>.  If this is not called prior to encryption, a default
tag length is used.
