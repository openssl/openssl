...
Respectively gets or sets the cipher specific "num" parameter for the associated I<ctx>.
...
EVP_CIPHER_CTX_get_num() returns a non-negative num value or
...
does not support the cal or on any other error.
