...
For GCM encryption it also returns 0 if the IV was supplied externally instead
of being generated by the FIPS provider.  The separate "iv-generated"
parameter reports the IV source directly, but callers can use
"fips-indicator" to determine the overall approval status.  For GCM encryption
and decryption, tag lengths other than 4, 8, or 12 through 16 bytes also cause
this indicator to return 0.
