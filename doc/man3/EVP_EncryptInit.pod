...
EVP_CIPHER_CTX_get_param_types,
EVP_CIPHER_CTX_set_params,
EVP_CIPHER_CTX_set_param_types,
...
EVP_CIPHER_get_params() retrieves the requested list of operation
B<params> from CIPHER context B<ctx>.

EVP_CIPHER_get_param_types(), EVP_CIPHER_CTX_get_param_types(), and
EVP_CIPHER_CTX_set_param_types() get a constant B<OSSL_PARAM> array
...
parameters, i.e. parameters that can be used with EVP_MD_CTX_get_params()
and EVP_MD_CTX_set_params(), respectively.
See L<OSSL_PARAM(3)> for the use of B<OSSL_PARAM> as parameter descriptor.
