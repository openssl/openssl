...
associated with it, including B<ctx> itself. This function should be called after
...
The I<cipher> field will be replaced by the engines I<impl> internal cipher if
it exists.
...
cipher ctx I<ctx>. This is currently only supported by DES and 3DES (which set
