...
EVP_des_cbc, EVP_des_ecb, EVP_des_cfb, EVP_des_cfb1, EVP_des_cfb8, EVP_des_ofb,
...
EVP_des_ede3_cfb1, EVP_des_ede3_cfb8, EVP_des_ede3_wrap, EVP_desx_cbc,
...
EVP_seed_cbc, EVP_seed_ecb, EVP_seed_cfb, EVP_seed_ofb,
...
EVP_camellia_128_cbc, EVP_camellia_192_cbc, EVP_camellia_256_cbc,
EVP_camellia_128_ecb, EVP_camellia_192_ecb, EVP_camellia_256_ecb,
EVP_camellia_128_cfb, EVP_camellia_192_cfb, EVP_camellia_256_cfb,
EVP_camellia_128_cfb1, EVP_camellia_192_cfb1, EVP_camellia_256_cfb1,
EVP_camellia_128_cfb8, EVP_camellia_192_cfb8, EVP_camellia_256_cfb8,
EVP_camellia_128_ofb, EVP_camellia_192_ofb, EVP_camellia_256_ofb,
EVP_camellia_128_ctr, EVP_camellia_192_ctr, EVP_camellia_256_ctr,
...
=item EVP_aes_128_cbc(), EVP_aes_192_cbc(), EVP_aes_256_cbc()

AES CBC mode for 128, 192 and 256 bit keys respectively.

=item EVP_aes_128_ecb(), EVP_aes_192_ecb(), EVP_aes_256_ecb()

AES ECB mode for 128, 192 and 256 bit keys respectively.

=item EVP_aes_128_cfb(), EVP_aes_192_cfb(), EVP_aes_256_cfb()

AES CFB mode for 128, 192 and 256 bit keys respectively.

=item EVP_aes_128_cfb1(), EVP_aes_192_cfb1(), EVP_aes_256_cfb1()

AES CFB mode with 1 bit of shift for 128, 192 and 256 bit keys respectively.

=item EVP_aes_128_cfb8(), EVP_aes_192_cfb8(), EVP_aes_256_cfb8()

AES CFB mode with 8 bits of shift for 128, 192 and 256 bit keys respectively.

=item EVP_aes_128_ofb(), EVP_aes_192_ofb(), EVP_aes_256_ofb()

AES OFB mode for 128, 192 and 256 bit keys respectively.

=item EVP_aes_128_ctr(), EVP_aes_192_ctr(), EVP_aes_256_ctr()

AES CTR mode for 128, 192 and 256 bit keys respectively.

=item EVP_aes_128_wrap(), EVP_aes_192_wrap(), EVP_aes_256_wrap()

AES key wrap according to RFC 3394 section 2.2.1 for 128, 192 and 256 bit keys respectively.

=item EVP_aes_128_wrap_pad(), EVP_aes_192_wrap_pad(), EVP_aes_256_wrap_pad()

AES key wrap according to RFC 5649 section 4.1 for 128, 192 and 256 bit keys respectively.

=item EVP_aes_128_xts(), EVP_aes_256_xts()

AES XTS mode for 128 and 256 bit keys respectively.

=item EVP_des_cbc(), EVP_des_ecb(), EVP_des_cfb(), EVP_des_cfb1(), EVP_des_cfb8(), EVP_des_ofb()

DES in CBC, ECB, CFB 128-bit shift, CFB 1-bit shift, CFB 8-bit shift and OFB
modes respectively.
...
=item EVP_des_ede3_cbc(), EVP_des_ede3(), EVP_des_ede3_cfb(), EVP_des_ede3_cfb1(), EVP_des_ede3_cfb8(), EVP_des_ede3_ofb()

Three key triple DES in CBC, ECB, CFB 128-bit shift, CFB 1-bit shift, CFB 8-bit shift and OFB modes respectively.
...
=item EVP_seed_cbc(), EVP_seed_ecb(), EVP_seed_cfb(), EVP_seed_ofb()

SEED encryption algorithm in CBC, ECB, CFB and OFB modes respectively. This
uses a key length of 128 bits and acts on blocks of 128-bits.
...
=item EVP_aes_128_cbc_hmac_sha1(), EVP_aes_256_cbc_hmac_sha1()

Authenticated encryption with AES in CBC mode and SHA-1 as HMAC.
As with EVP_aes_128_cbc() and EVP_aes_256_cbc(), the keys are 128 and 256 bits
respectively and produces a 128-bit authentication tag.

=item EVP_aes_128_cbc_hmac_sha256(), EVP_aes_256_cbc_hmac_sha256()

Authenticated encryption with AES in CBC mode and SHA256 (SHA-2, 256-bits) as
HMAC. As with EVP_aes_128_cbc() and EVP_aes_256_cbc(), the keys are 128 and
256 bits respectively and produces a 256-bit authentication tag.

=item EVP_aria_128_cbc(), EVP_aria_192_cbc(), EVP_aria_256_cbc()

ARIA CBC mode for 128, 192 and 256 bit keys respectively.

=item EVP_aria_128_ecb(), EVP_aria_192_ecb(), EVP_aria_256_ecb()

ARIA ECB mode for 128, 192 and 256 bit keys respectively.

=item EVP_aria_128_cfb(), EVP_aria_192_cfb(), EVP_aria_256_cfb()

ARIA CFB mode with 128 bits of shift for 128, 192 and 256 bit keys respectively.

=item EVP_aria_128_cfb1(), EVP_aria_192_cfb1(), EVP_aria_256_cfb1()

ARIA CFB mode with 1 bit of shift for 128, 192 and 256 bit keys respectively.

=item EVP_aria_128_cfb8(), EVP_aria_192_cfb8(), EVP_aria_256_cfb8()

ARIA CFB mode with 8 bits of shift for 128, 192 and 256 bit keys respectively.

=item EVP_aria_128_ofb(), EVP_aria_192_ofb(), EVP_aria_256_ofb()

ARIA OFB mode for 128, 192 and 256 bit keys respectively.

=item EVP_aria_128_ctr(), EVP_aria_192_ctr(), EVP_aria_256_ctr()

ARIA CTR mode for 128, 192 and 256 bit keys respectively.

=item EVP_aria_128_gcm(), EVP_aria_192_gcm(), EVP_aria_256_gcm()

ARIA Galois Counter Mode (GCM) for 128, 192 and 256 bit keys respectively.
These ciphers require additional control operations to function correctly: see
the L</GCM and OCB Modes> section below for details.

=item EVP_aria_128_ccm(), EVP_aria_192_ccm(), EVP_aria_256_ccm()

ARIA Counter with CBC-MAC Mode (CCM) for 128, 192 and 256 bit keys respectively.
These ciphers require additional control operations to function correctly: see
CCM mode section below for details.

=item EVP_camellia_128_cbc(), EVP_camellia_192_cbc(), EVP_camellia_256_cbc()

Camellia CBC mode for 128, 192 and 256 bit keys respectively.

=item EVP_camellia_128_ecb(), EVP_camellia_192_ecb(), EVP_camellia_256_ecb()

Camellia ECB mode for 128, 192 and 256 bit keys respectively.

=item EVP_camellia_128_cfb(), EVP_camellia_192_cfb(), EVP_camellia_256_cfb()

Camellia CFB mode with 128 bits of shift for 128, 192 and 256 bit keys respectively.

=item EVP_camellia_128_cfb1(), EVP_camellia_192_cfb1(), EVP_camellia_256_cfb1()

Camellia CFB mode with 1 bit of shift for 128, 192 and 256 bit keys respectively.

=item EVP_camellia_128_cfb8(), EVP_camellia_192_cfb8(), EVP_camellia_256_cfb8()

Camellia CFB mode with 8 bits of shift for 128, 192 and 256 bit keys respectively.

=item EVP_camellia_128_ofb(), EVP_camellia_192_ofb(), EVP_camellia_256_ofb()

Camellia OFB mode for 128, 192 and 256 bit keys respectively.

=item EVP_camellia_128_ctr(), EVP_camellia_192_ctr(), EVP_camellia_256_ctr()

Camellia CTR mode for 128, 192 and 256 bit keys respectively.
