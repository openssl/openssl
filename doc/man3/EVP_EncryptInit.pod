...
EVP_aes_{128,192,256}_cbc, EVP_aes_{128,192,256}_cfb,
EVP_aes_{128,192,256}_cfb1, EVP_aes_{128,192,256}_cfb8,
EVP_aes_{128,192,256}_ctr, EVP_aes_{128,192,256}_ecb,
EVP_aes_{128,192,256}_ofb,
EVP_aes_{128,256}_cbc_hmac_sha1, EVP_aes_{128,256}_cbc_hmac_sha256,
EVP_aes_{128,192,256}_ccm, EVP_aes_{128,192,256}_gcm,
EVP_aes_{128,192,256}_ocb,
EVP_aes_{128,192,256}_wrap, EVP_aes_{128,192,256}_wrap_pad,
EVP_aes_{128,256}_xts,
EVP_aria_{128,192,256}_cbc, EVP_aria_{128,192,256}_cfb,
EVP_aria_{128,192,256}_cfb1, EVP_aria_{128,192,256}_cfb8,
EVP_aria_{128,192,256}_ctr, EVP_aria_{128,192,256}_ecb,
EVP_aria_{128,192,256}_ofb,
EVP_aria_{128,192,256}_ccm, EVP_aria_{128,192,256}_gcm,
EVP_bf_cbc, EVP_bf_cfb, EVP_bf_ecb, EVP_bf_ofb,
EVP_camellia_{128,192,256}_cbc, EVP_camellia_{128,192,256}_cfb,
EVP_camellia_{128,192,256}_cfb1, EVP_camellia_{128,192,256}_cfb8,
EVP_camellia_{128,192,256}_ctr, EVP_camellia_{128,192,256}_ecb,
EVP_camellia_{128,192,256}_ofb,
EVP_cast5_cbc, EVP_cast5_cfb, EVP_cast5_ecb, EVP_cast5_ofb,
EVP_chacha20, EVP_chacha20_poly1305,
EVP_des_cbc, EVP_des_cfb, EVP_des_cfb1, EVP_des_cfb8, EVP_des_ecb,
EVP_des_ede, EVP_des_ede_cfb, EVP_des_ede_ofb, EVP_des_ofb,
EVP_des_ede3, EVP_des_ede3_cbc, EVP_des_ede3_cfb, EVP_des_ede3_cfb1,
EVP_des_ede3_cfb8, EVP_des_ede3_ofb, EVP_des_ede3_wrap, EVP_des_ede_cbc,
EVP_desx_cbc,
EVP_idea_cbc, EVP_idea_cfb, EVP_idea_ecb, EVP_idea_ofb,
EVP_rc2_cbc, EVP_rc2_cfb, EVP_rc2_ecb, EVP_rc2_ofb, EVP_rc2_{40,64}_cbc,
EVP_rc4, EVP_rc4_40, EVP_rc4_hmac_md5,
EVP_rc5_32_12_16_cbc, EVP_rc5_32_12_16_cfb, EVP_rc5_32_12_16_ecb,
EVP_rc5_32_12_16_ofb,
EVP_seed_cbc, EVP_seed_cfb, EVP_seed_ecb, EVP_seed_ofb
- EVP cipher routines
...
=item EVP_aes_{128,192,256}_cbc(), EVP_aes_{128,192,256}_cfb(),
  EVP_aes_{128,192,256}_cfb1(), EVP_aes_{128,192,256}_cfb8(),
  EVP_aes_{128,192,256}_ctr(), EVP_aes_{128,192,256}_ecb(),
  EVP_aes_{128,192,256}_ofb()
...
=item EVP_aes_{128,192,256}_ccm(), EVP_aes_{128,192,256}_gcm(),
  EVP_aes_{128,192,256}_ocb()
...
operations to function correctly, see the
L</Interface For Authenticated Encryption with Associated Data>
...
=item EVP_aria_{128,192,256}_cbc(), EVP_aria_{128,192,256}_cfb(),
  EVP_aria_{128,192,256}_cfb1(), EVP_aria_{128,192,256}_cfb8(),
  EVP_aria_{128,192,256}_ctr(), EVP_aria_{128,192,256}_ecb(),
  EVP_aria_{128,192,256}_ofb()
...
=item EVP_aria_{128,192,256}_ccm(), EVP_aria_{128,192,256}_gcm()
...
=item EVP_bf_cbc(), EVP_bf_cfb(), EVP_bf_ecb(), EVP_bf_ofb()

Blowfish encryption algorithm in CBC, CFB, ECB and OFB modes respectively. This
is a variable key length cipher.

=item EVP_camellia_{128,192,256}_cbc(), EVP_camellia_{128,192,256}_cfb(),
  EVP_camellia_{128,192,256}_cfb1(), EVP_camellia_{128,192,256}_cfb8(),
  EVP_camellia_{128,192,256}_ctr(), EVP_camellia_{128,192,256}_ecb(),
  EVP_camellia_{128,192,256}_ofb()
...
=item EVP_des_ede(), EVP_des_ede_cbc(), EVP_des_ede_ofb(), EVP_des_ede_cfb()

Two key triple DES in ECB, CBC, CFB and OFB modes respectively.

=item EVP_des_ede3(), EVP_des_ede3_cbc(), EVP_des_ede3_cfb(),
...
=item EVP_idea_cbc(), EVP_idea_cfb(), EVP_idea_ecb(), EVP_idea_ofb()

IDEA encryption algorithm in CBC, CFB, ECB and OFB modes respectively.

=item EVP_rc2_cbc(), EVP_rc2_cfb(), EVP_rc2_ecb(), EVP_rc2_ofb()
...
=item EVP_seed_cbc(), EVP_seed_cfb(), EVP_seed_ecb(), EVP_seed_ofb()

SEED encryption algorithm in CBC, CFB, ECB and OFB modes respectively. This
uses a key length of 128 bits and acts on blocks of 128-bits.

=item EVP_rc5_32_12_16_cbc(), EVP_rc5_32_12_16_cfb(), EVP_rc5_32_12_16_ecb(),
  EVP_rc5_32_12_16_ofb()
...
BUG: currently the number of rounds in RC5 can only be set to 8, 12 or 16.
This is a limitation of the current RC5 code rather than the EVP interface.

=back

=head1 Interface For Authenticated Encryption with Associated Data

The EVP interface for Authenticated Encryption with Associated Data (AEAD)
modes are subtly altered and several additional ctrl operations are supported
...
Sets the expected tag to B<taglen> bytes from B<tag>. This call is only valid
