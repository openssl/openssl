...
will perform a fetch and return an error if a pipeline supported implementation
is not found.
...
output buffers, see the description of EVP_CipherUpdate(). The I<enc> and I<key>
behave the same as they do for EVP_CipherInit().
