...
EVP_rc2_ecb, EVP_rc2_cfb, EVP_rc2_ofb, EVP_rc2_{40,64}_cbc,
...
EVP_aes_{128,192,256}_cbc, EVP_aes_{128,192,256}_ecb,
EVP_aes_{128,192,256}_cfb, EVP_aes_{128,192,256}_cfb1, EVP_aes_{128,192,256}_cfb8,
EVP_aes_{128,192,256}_ofb, EVP_aes_{128,192,256}_ctr,
EVP_aes_{128,192,256}_wrap, EVP_aes_{128,192,256}_wrap_pad, EVP_aes_{128,256}_xts,
EVP_aes_{128,192,256}_gcm, EVP_aes_{128,192,256}_ocb, EVP_aes_{128,192,256}_ccm,
EVP_aes_{128,256}_cbc_hmac_sha1, EVP_aes_{128,256}_cbc_hmac_sha256,
EVP_aria_{128,192,256}_cbc, EVP_aria_{128,192,256}_ecb, EVP_aria_{128,192,256}_cfb,
EVP_aria_{128,192,256}_cfb1, EVP_aria_{128,192,256}_cfb8, EVP_aria_{128,192,256}_ofb,
EVP_aria_{128,192,256}_ctr, EVP_aria_{128,192,256}_gcm, EVP_aria_{128,192,256}_ccm,
EVP_camellia_{128,192,256}_cbc, EVP_camellia_{128,192,256}_ecb, EVP_camellia_{128,192,256}_cfb,
EVP_camellia_{128,192,256}_cfb1, EVP_camellia_{128,192,256}_cfb8,
EVP_camellia_{128,192,256}_ofb, EVP_camellia_{128,192,256}_ctr,
...
=item EVP_aes_{128,192,256}_cbc(), EVP_aes_{128,192,256}_ecb(),
  EVP_aes_{128,192,256}_cfb(), EVP_aes_{128,192,256}_cfb1(),
  EVP_aes_{128,192,256}_cfb8(), EVP_aes_{128,192,256}_ofb(),
  EVP_aes_{128,192,256}_ctr()

AES for 128, 192 and 256 bit keys in the following modes: CBC, ECB, CFB with
128-bit shift, CFB with 1-bit shift, CFB with 8-bit shift, OFB and CTR.

=item EVP_aes_{128,192,256}_wrap(), EVP_aes_{128,192,256}_wrap_pad()

AES key wrap with 128, 192 and 256 bit keys, as according to RFC 3394 section
2.2.1 and RFC 5649 section 4.1 respectively.

=item EVP_aes_{128,256}_xts()

AES XTS mode for 128 and 256 bit keys respectively.

=item EVP_des_cbc(), EVP_des_ecb(), EVP_des_cfb(), EVP_des_cfb1(),
  EVP_des_cfb8(), EVP_des_ofb()
...
=item EVP_des_ede3_cbc(), EVP_des_ede3(), EVP_des_ede3_cfb(),
  EVP_des_ede3_cfb1(), EVP_des_ede3_cfb8(), EVP_des_ede3_ofb()

Three key triple DES in CBC, ECB, CFB with 128-bit shift, CFB with 1-bit shift,
...
=item EVP_aes_{128,192,256}_gcm(), EVP_aes_{128,192,256}_ocb(), EVP_aes_{128,192,256}_ccm()

AES for 128, 192 and 256 bit keys in Galois Counter Mode (GCM), Offset Cookbook
Mode (OCB) and CBC-MAC Mode (CCM) respectively. These ciphers require
additional control operations to function correctly, see the
L</GCM and OCB Modes> section below for details.

=item EVP_aes_{128,256}_cbc_hmac_sha1()

Authenticated encryption with AES in CBC mode using SHA-1 as HMAC, with keys of
128 and 256 bits length respectively. The authentication tag is 128 bits long.

=item EVP_aes_{128,256}_cbc_hmac_sha256()
...
=item EVP_aria_{128,192,256}_cbc(), EVP_aria_{128,192,256}_ecb(),
  EVP_aria_{128,192,256}_cfb(), EVP_aria_{128,192,256}_cfb1(),
  EVP_aria_{128,192,256}_cfb8(), EVP_aria_{128,192,256}_ofb(),
  EVP_aria_{128,192,256}_ctr()

ARIA for 128, 192 and 256 bit keys in the following modes: CBC, ECB, CFB with
128-bit shift, CFB with 1-bit shift, CFB with 8-bit shift, OFB and CTR.

=item EVP_aria_{128,192,256}_gcm(), EVP_aria_{128,192,256}_ccm()

ARIA for 128, 192 and 256 bit keys in Galois Counter Mode (GCM) and CBC-MAC
Mode (CCM). These ciphers require additional control operations to function
correctly, see the L</GCM and OCB Modes> section below for details.

=item EVP_camellia_{128,192,256}_cbc(), EVP_camellia_{128,192,256}_ecb(),
  EVP_camellia_{128,192,256}_cfb(), EVP_camellia_{128,192,256}_cfb1(),
  EVP_camellia_{128,192,256}_cfb8(), EVP_camellia_{128,192,256}_ofb(),
  EVP_camellia_{128,192,256}_ctr()

Camellia for 128, 192 and 256 bit keys in the following modes: CBC, ECB, CFB with
128-bit shift, CFB with 1-bit shift, CFB with 8-bit shift, OFB and CTR.
