...
These items get theird values from B<MAJOR>, B<MINOR>, B<PATCH>, and
...
$config{prerelease} and $config{build_metadata}.  For C<MAJOR=3>, C<MINOR=0>,
C<PATCH=0>, B<PRE_RELEASE_TAG=dev>, B<BUILD_METADATA=>, the string will be
C<3.0.0-dev>.
