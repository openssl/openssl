...
=item The existing documentation for the function in the last release
describes how to replace the function. If you feel this documentation
is inadequate or incomplete, consider updating it if a maintenance
release will happen.
...
list in L<ossl-ex-api(7)> with an appropriate entry. Keep it short and
simple. Each entry in the list for a version can include a quick link
