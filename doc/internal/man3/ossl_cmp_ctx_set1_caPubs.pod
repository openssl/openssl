...
ossl_cmp_ctx_get0_senderNonce() returns the senderNonce stored
in the context.

ossl_cmp_ctx_set1_recipNonce() sets the given recipient nonce in the context.

ossl_cmp_ctx_get0_recipNonce() returns the recipient nonce in the context.
...
ossl_cmp_ctx_get0_senderNonce() and
ossl_cmp_ctx_get0_recipNonce()
