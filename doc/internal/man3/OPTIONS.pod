...
The opt_begin() fuction, which is called automatically by opt_init(),
...
The opt_flag() fuction returns the most recent option name
...
The opt_num_rest() fuction returns what is left.
