...
ossl_evp_generic_fetch, ossl_evp_generic_fetch_by_number
...
=head1 SYNOPSIS
 ...
 void *ossl_evp_generic_fetch_by_number(
        ...
        void *method_data, int (*up_ref_method)(void *),
        void (*free_method)(void *));

=head1 DESCRIPTION

ossl_evp_generic_fetch() calls ossl_method_construct() with the given
I<libctx>, I<operation_id>, I<name>, and I<properties> and uses
it to create an EVP method with the help of the functions
I<new_method>, I<up_ref_method>, and I<free_method>.

ossl_evp_generic_fetch_by_number() does the same thing as
ossl_evp_generic_fetch(), but takes a numeric I<name_id> instead of a name.
...
ossl_evp_generic_fetch() returns a method on success, or NULL on error.
...
And here's the implementation of the FOO method fetcher:
    ...
    {
        EVP_FOO *foo =
            ossl_evp_generic_fetch(ctx, OSSL_OP_FOO, name, properties,
