...
it to create an EVP method with the help of the functions in I<fetch_ops>.
...
The I<fetch_ops> is a pointer to a struct of function pointers:

 struct evp_fetch_operation_st {
     void *(*new_method)(int name_id, const OSSL_ALGORITHM *algodef,
                         OSSL_PROVIDER *prov);
     int (*up_ref_method)(void *method);
     void (*free_method)(void *method);
 };
