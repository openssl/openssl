...
ossl_cmp_hdr_ggeneralinfo_item_push0,
ossl_cmp_hdr_ggeneralinfo_items_push1,
...
=head1 SYNOPSIS
  ...
  int ossl_cmp_hdr_ggeneralinfo_item_push0(OSSL_CMP_PKIHEADER *hdr,
                                     OSSL_CMP_ITAV *itav);
  int ossl_cmp_hdr_ggeneralinfo_items_push1(OSSL_CMP_PKIHEADER *hdr,
...
ossl_cmp_hdr_ggeneralinfo_item_push0() adds the given InfoTypeAndValue
item to the hdr->generalInfo stack. Consumes the B<itav> pointer.

ossl_cmp_hdr_ggeneralinfo_items_push1() adds a copy of the B<itavs> stack to
