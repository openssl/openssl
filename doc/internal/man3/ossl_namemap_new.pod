...
ossl_namemap_num2name() finds the I<idx>th name corresponding to the given
I<number>.
...
ossl_namemap_num2name() returns a pointer to I<idx>th name corresponding
to the given name I<number>, or NULL if it's undefined in the given
B<OSSL_NAMEMAP>.
