...
This function is capable of printing the attributes of a platform certificate
as defined by the Trusted Computing Group
(L<https://trustedcomputinggroup.org/>) in the specification titled
I<TCG Platform Certificate Profile> (L<https://trustedcomputinggroup.org/resource/tcg-platform-certificate-profile/>).
It is capable of printing the attributes defined in version 1 and the attributes
and all traits defined in version 2.0.
