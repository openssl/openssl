...
=head1 SYNOPSIS
 ...
 /* Load and initialise the Provider */
...
If an initialisation function was given with ossl_provider_new(), that
function will get called.

=item *

If no initialisation function was given with ossl_provider_new(), a
