...
=head1 SYNOPSIS
 ...
 int evp_keymgmt_exportdomparams(const EVP_KEYMGMT *keymgmt,
                              void *provdomparams, Otls_PARAM params[]);
 const Otls_PARAM *evp_keymgmt_importdomparams_types(const EVP_KEYMGMT *keymgmt);
 const Otls_PARAM *evp_keymgmt_exportdomparams_types(const EVP_KEYMGMT *keymgmt);
