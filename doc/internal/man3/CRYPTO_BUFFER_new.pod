...
I<CRYPTO_BUFFER_POOL_new> returns a pointer to a new pool on success
or, NULL on failure.

I<CRYPTO_BUFFER_new>, I<CRPTO_BUFFER_alloc>, and
I<CRYPTO_BUFFER_new_from_static_data> return a pointer to a new
buffer on success, or NULL on failure.

I<CRYPTO_BUFFER_up_ref> returns 1.
