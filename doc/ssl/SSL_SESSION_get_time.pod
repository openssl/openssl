...
SSL_SESSION_get0_hostname - retrieve the hostname for the session
...
SSL_SESSION_get0_hostname returns the pointer to the hostname for session B<s>.
...
SSL_SESSION_get0_hostname returns the current value.
