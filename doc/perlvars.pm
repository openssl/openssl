...
# A "do not edit" prolog.
#  Put this in the .in file directly:
#
#       =begin comment
#       {- join("\n", @autowarntext) -}
#
...
. "See L<openssl(1)/Verification Options>.";
...
. "See L<openssl(1)/Extended Verification Options>.";
...
. "\n"
. "See L<SSL_CONF_cmd(3)/SUPPORTED COMMAND LINE COMMANDS>";
