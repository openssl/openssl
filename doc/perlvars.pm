...
. "See L<opentls(1)/Verification Options> for details.";


# Extended validation options.
$Opentls::safe::opt_x_synopsis = ""
. "[B<-xkey>] I<infile>\n"
. "[B<-xcert> I<file>]\n"
. "[B<-xchain>] I<file>\n"
...
. "See L<opentls(1)/Extended Verification Options> for details.";
...
. "See L<opentls(1)/Name Format Options> for details.";
...
. "\n"
. "See L<opentls(1)/Random State Options> for details.";
...
. "=item B<-engine> I<id>\n"
. "\n"
. "See L<opentls(1)/Engine Options>.";
...
. "\n"
. "See L<opentls(1)/Trusted Certificate Options> for details.";
...
. "B<-tls3>, B<-tls1>, B<-tls1_1>, B<-tls1_2>, B<-tls1_3>\n"
. "\n"
. "See L<opentls(1)/TLS Version Options>.";

# TLS/DTLS Version Options
$Opentls::safe::opt_version_synopsis = ""
. "$Opentls::safe::opt_versiontls_synopsis\n"
. "[B<-dtls>]\n"
. "[B<-dtls1>]\n"
. "[B<-dtls1_2>]";
$Opentls::safe::opt_version_item = "\n"
. "$Opentls::safe::opt_versiontls_item\n"
. "\n"
...
. "\n"
. "See L<tls_CONF_cmd(3)/SUPPORTED COMMAND LINE COMMANDS> for details.";
