...
X509_NAME_get_index_by_NID, X509_NAME_get_index_by_OBJ, X509_NAME_get0_entry,
X509_NAME_get0m_entry, X509_NAME_entry_count, X509_NAME_get_text_by_NID, 
...
X509_NAME_get0_entry() retrieves the B<X509_NAME_ENTRY> from B<name>
...
X509_NAME_get0_entry() on any matching indices and then the
...
Process all commonName entries:
 ...
 for (;;)
        ...
        if (lastpos == -1)
                break;
        e = X509_NAME_get0_entry(nm, lastpos);
        /* Do something with e */
        }
...
X509_NAME_get0_entry() returns an B<X509_NAME> pointer to the
