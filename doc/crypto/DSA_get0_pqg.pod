...
should not be freed directly.  You can pass NULL for those parameters you are
not interested in.
...
private key values. This memory should not be freed directly.  You can pass
NULL for those parameters you are not interested in.
