...
X509_NAME_ENTRY_get0_object, X509_NAME_ENTRY_get0_data,
X509_NAME_ENTRY_get0m_object, X509_NAME_ENTRY_get0m_data,
...
=head1 SYNOPSIS
 ...
 ASN1_STRING * X509_NAME_ENTRY_get0_data(X509_NAME_ENTRY *ne);
...
X509_NAME_ENTRY_get0_object() retrieves the field name of B<ne> in
and B<ASN1_OBJECT> structure.

X509_NAME_ENTRY_get0m_object() retrieves the field name of B<ne> in
and B<ASN1_OBJECT> structure.

X509_NAME_ENTRY_get0_data() retrieves the field value of B<ne> in
...
X509_NAME_ENTRY_get0_object() and X509_NAME_ENTRY_get0_data() can be
used to examine an B<X509_NAME_ENTRY> function as returned by
X509_NAME_get0_entry() for example.
