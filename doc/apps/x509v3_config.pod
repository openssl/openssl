...
The email and DNS options include a special 'copy' value. This will
automatically include any email addresses and/or common names contained in the
certificate subject name in the extension. The special 'move' value can be
used in the same way to move any email addresses and/or common names from the
certificate subject name to the extension.
